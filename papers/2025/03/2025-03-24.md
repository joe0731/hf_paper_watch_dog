...
> source: [Hugging Face Daily Papers](https://huggingface.co/papers/date/2025-03-24)

Total papers: 22

---

## 1. [When Less is Enough: Adaptive Token Reduction for Efficient Image
  Representation](https://huggingface.co/papers/2503.16660)

**ArXiv ID**: [2503.16660](https://arxiv.org/abs/2503.16660)

**Authors**: Eduard Allakhverdov, Elizaveta Goncharova, Andrey Kuznetsov

**Published**: 2025-03-20 | **Submitted**: 2025-03-24 by Elizaveta Goncharova
...
## 2. [MAPS: A Multi-Agent Framework Based on Big Seven Personality and
  Socratic Guidance for Multimodal Scientific Problem Solving](https://huggingface.co/papers/2503.16905)

**ArXiv ID**: [2503.16905](https://arxiv.org/abs/2503.16905)

**Authors**: Jian Zhang, Zhiyuan Wang, Zhangqi Wang, Xinyu Zhang, Fangzhi Xu, Qika Lin, Rui Mao, Erik Cambria, Jun Liu

**Published**: 2025-03-21 | **Submitted**: 2025-03-24 by Jian Zhang

**Upvotes**: 54

**Links**: [GitHub](https://github.com/exoskeletonzj/MARS)
...
## 3. [A Comprehensive Survey on Long Context Language Modeling](https://huggingface.co/papers/2503.17407)

**ArXiv ID**: [2503.17407](https://arxiv.org/abs/2503.17407)
...
**Published**: 2025-03-20 | **Submitted**: 2025-03-24 by Dawei Zhu

**Upvotes**: 49

**Links**: [GitHub](https://github.com/LCLM-Horizon/A-Comprehensive-Survey-For-Long-Context-Language-Modeling) | [Project Page](https://github.com/LCLM-Horizon/A-Comprehensive-Survey-For-Long-Context-Language-Modeling)
...
## 4. [MARS: A Multi-Agent Framework Incorporating Socratic Guidance for
  Automated Prompt Optimization](https://huggingface.co/papers/2503.16874)

**ArXiv ID**: [2503.16874](https://arxiv.org/abs/2503.16874)
...
## 5. [RoboFactory: Exploring Embodied Agent Collaboration with Compositional
  Constraints](https://huggingface.co/papers/2503.16408)

**ArXiv ID**: [2503.16408](https://arxiv.org/abs/2503.16408)

**Authors**: Yiran Qin, Li Kang, Xiufeng Song, Zhenfei Yin, Xiaohong Liu, Xihui Liu, Ruimao Zhang, Lei Bai

**Published**: 2025-03-20 | **Submitted**: 2025-03-24 by yiranqin

**Upvotes**: 42

**Links**: [Project Page](https://iranqin.github.io/robofactory/)
...
## 6. [Modifying Large Language Model Post-Training for Diverse Creative
  Writing](https://huggingface.co/papers/2503.17126)

**ArXiv ID**: [2503.17126](https://arxiv.org/abs/2503.17126)

**Authors**: John Joon Young Chung, Vishakh Padmakumar, Melissa Roemmele, Yuqian Sun, Max Kreminski

**Published**: 2025-03-21 | **Submitted**: 2025-03-24 by AK

**Upvotes**: 36

**Links**: [GitHub](https://github.com/mj-storytelling/DiversityTuning)
...
## 7. [Bridging Continuous and Discrete Tokens for Autoregressive Visual
  Generation](https://huggingface.co/papers/2503.16430)

**ArXiv ID**: [2503.16430](https://arxiv.org/abs/2503.16430)

**Authors**: Yuqing Wang, Zhijie Lin, Yao Teng, Yuanzhi Zhu, Shuhuai Ren, Jiashi Feng, Xihui Liu

**Published**: 2025-03-20 | **Submitted**: 2025-03-24 by Yuqing Wang

**Upvotes**: 34

**Links**: [GitHub](https://github.com/YuqingWang1029/TokenBridge) | [Project Page](https://yuqingwang1029.github.io/TokenBridge/)
...
## 8. [TaoAvatar: Real-Time Lifelike Full-Body Talking Avatars for Augmented
  Reality via 3D Gaussian Splatting](https://huggingface.co/papers/2503.17032)

**ArXiv ID**: [2503.17032](https://arxiv.org/abs/2503.17032)
...
**Links**: [Project Page](https://pixelai-team.github.io/TaoAvatar/)
...
## 9. [OpenVLThinker: An Early Exploration to Complex Vision-Language Reasoning
  via Iterative Self-Improvement](https://huggingface.co/papers/2503.17352)

**ArXiv ID**: [2503.17352](https://arxiv.org/abs/2503.17352)

**Authors**: Yihe Deng, Hritik Bansal, Fan Yin, Nanyun Peng, Wei Wang, Kai-Wei Chang

**Published**: 2025-03-21 | **Submitted**: 2025-03-24 by Yihe Deng

**Upvotes**: 24

**Links**: [GitHub](https://github.com/yihedeng9/OpenVLThinker) | [Project Page](https://yihe-deng.notion.site/openvlthinker)
...
## 10. [Enabling Versatile Controls for Video Diffusion Models](https://huggingface.co/papers/2503.16983)

**ArXiv ID**: [2503.16983](https://arxiv.org/abs/2503.16983)
...
**Links**: [GitHub](https://github.com/PaddlePaddle/PaddleMIX) | [Project Page](https://pp-vctrl.github.io)
...
## 11. [MathFlow: Enhancing the Perceptual Flow of MLLMs for Visual Mathematical
  Problems](https://huggingface.co/papers/2503.16549)

**ArXiv ID**: [2503.16549](https://arxiv.org/abs/2503.16549)

**Authors**: Felix Chen, Hangjie Yuan, Yunqiu Xu, Tao Feng, Jun Cen, Pengwei Liu, Zeying Huang, Yi Yang

**Published**: 2025-03-19 | **Submitted**: 2025-03-24 by Hangjie Yuan

**Upvotes**: 15

**Links**: [GitHub](https://github.com/MathFlow-zju/MathFlow)
...
## 12. [Single Image Iterative Subject-driven Generation and Editing](https://huggingface.co/papers/2503.16025)

**ArXiv ID**: [2503.16025](https://arxiv.org/abs/2503.16025)

**Authors**: Yair Shpitzer, Gal Chechik, Idan Schwartz

**Published**: 2025-03-20 | **Submitted**: 2025-03-24 by Yair Shpitzer

**Upvotes**: 14

**Links**: [GitHub](https://github.com/yairshp/SISO) | [Project Page](https://siso-paper.github.io/)
...
## 13. [ETVA: Evaluation of Text-to-Video Alignment via Fine-grained Question
  Generation and Answering](https://huggingface.co/papers/2503.16867)

**ArXiv ID**: [2503.16867](https://arxiv.org/abs/2503.16867)

**Authors**: Kaisi Guan, Zhengfeng Lai, Yuchong Sun, Peng Zhang, Wei Liu, Kieran Liu, Meng Cao, Ruihua Song

**Published**: 2025-03-21 | **Submitted**: 2025-03-24 by Guan

**Upvotes**: 12

**Links**: [Project Page](https://eftv-eval.github.io/etva-eval/)
...
## 14. [FastCuRL: Curriculum Reinforcement Learning with Progressive Context
  Extension for Efficient Training R1-like Reasoning Models](https://huggingface.co/papers/2503.17287)

**ArXiv ID**: [2503.17287](https://arxiv.org/abs/2503.17287)
...
**Links**: [GitHub](https://github.com/nick7nlp/FastCuRL)
...
## 15. [Can Large Vision Language Models Read Maps Like a Human?](https://huggingface.co/papers/2503.14607)

**ArXiv ID**: [2503.14607](https://arxiv.org/abs/2503.14607)

**Authors**: Shuo Xing, Zezhou Sun, Shuangyu Xie, Kaiyuan Chen, Yanjia Huang, Yuping Wang, Jiachen Li, Dezhen Song, Zhengzhong Tu

**Published**: 2025-03-18 | **Submitted**: 2025-03-24 by Shuo Xing

**Upvotes**: 10

**Links**: [GitHub](https://github.com/taco-group/MapBench)
...
## 16. [From Head to Tail: Towards Balanced Representation in Large
  Vision-Language Models through Adaptive Data Calibration](https://huggingface.co/papers/2503.12821)

**ArXiv ID**: [2503.12821](https://arxiv.org/abs/2503.12821)

**Authors**: Mingyang Song, Xiaoye Qu, Jiawei Zhou, Yu Cheng

**Published**: 2025-03-17 | **Submitted**: 2025-03-24 by Mingyang Song
...
## 17. [Implicit Bias-Like Patterns in Reasoning Models](https://huggingface.co/papers/2503.11572)

**ArXiv ID**: [2503.11572](https://arxiv.org/abs/2503.11572)

**Authors**: Messi H. J. Lee, Calvin K. Lai

**Published**: 2025-03-14 | **Submitted**: 2025-03-24 by Messi H.J. Lee
...
## 18. [PVChat: Personalized Video Chat with One-Shot Learning](https://huggingface.co/papers/2503.17069)

**ArXiv ID**: [2503.17069](https://arxiv.org/abs/2503.17069)

**Authors**: Yufei Shi, Weilong Yan, Gang Xu, Yumeng Li, Yuchen Li, Zhenxi Li, Fei Richard Yu, Ming Li, Si Yong Yeo

**Published**: 2025-03-21 | **Submitted**: 2025-03-24 by SHI YUFEI
...
## 19. [When Preferences Diverge: Aligning Diffusion Models with Minority-Aware
  Adaptive DPO](https://huggingface.co/papers/2503.16921)

**ArXiv ID**: [2503.16921](https://arxiv.org/abs/2503.16921)

**Authors**: Lingfan Zhang, Chen Liu, Chengming Xu, Kai Hu, Donghao Luo, Chengjie Wang, Yanwei Fu, Yuan Yao

**Published**: 2025-03-21 | **Submitted**: 2025-03-24 by Chengming Xu
...
## 20. [GAEA: A Geolocation Aware Conversational Model](https://huggingface.co/papers/2503.16423)

**ArXiv ID**: [2503.16423](https://arxiv.org/abs/2503.16423)

**Authors**: Ron Campos, Ashmal Vayani, Parth Parag Kulkarni, Rohit Gupta, Aritra Dutta, Mubarak Shah

**Published**: 2025-03-20 | **Submitted**: 2025-03-24 by Aritra Dutta

**Upvotes**: 6

**Links**: [GitHub](https://github.com/UCF-CRCV/GAEA) | [Project Page](https://ucf-crcv.github.io/GAEA/)
...
## 21. [Generalized Few-shot 3D Point Cloud Segmentation with Vision-Language
  Model](https://huggingface.co/papers/2503.16282)

**ArXiv ID**: [2503.16282](https://arxiv.org/abs/2503.16282)

**Authors**: Zhaochong An, Guolei Sun, Yun Liu, Runjia Li, Junlin Han, Ender Konukoglu, Serge Belongie

**Published**: 2025-03-20 | **Submitted**: 2025-03-24 by Zhaochong An

**Upvotes**: 6

**Links**: [GitHub](https://github.com/ZhaochongAn/GFS-VL)
...
## 22. [FFaceNeRF: Few-shot Face Editing in Neural Radiance Fields](https://huggingface.co/papers/2503.17095)

**ArXiv ID**: [2503.17095](https://arxiv.org/abs/2503.17095)

**Authors**: Kwan Yun, Chaelin Kim, Hangyeul Shin, Junyong Noh

**Published**: 2025-03-21 | **Submitted**: 2025-03-24 by kwan yun

**Upvotes**: 5

**Links**: [GitHub](https://github.com/kwanyun/FFaceNeRF) | [Project Page](https://kwanyun.github.io/FFaceNeRF_page/)
