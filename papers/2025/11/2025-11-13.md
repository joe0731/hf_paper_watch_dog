...
> source: [Hugging Face Daily Papers](https://huggingface.co/papers/date/2025-11-13)

Total papers: 13

---

## 1. [Lumine: An Open Recipe for Building Generalist Agents in 3D Open Worlds](https://huggingface.co/papers/2511.08892)

**ArXiv ID**: [2511.08892](https://arxiv.org/abs/2511.08892)
...
**Published**: 2025-11-12 | **Submitted**: 2025-11-13 by taesiri

**Upvotes**: 213

**Links**: [Project Page](https://www.lumine-ai.org/)
...
## 2. [TiDAR: Think in Diffusion, Talk in Autoregression](https://huggingface.co/papers/2511.08923)

**ArXiv ID**: [2511.08923](https://arxiv.org/abs/2511.08923)
...
**Links**: [Project Page](https://tidarlm.github.io)
...
## 3. [MADD: Multi-Agent Drug Discovery Orchestra](https://huggingface.co/papers/2511.08217)

**ArXiv ID**: [2511.08217](https://arxiv.org/abs/2511.08217)

**Organization**: ITMO NSS lab
...
**Published**: 2025-11-11 | **Submitted**: 2025-11-13 by Frank

**Upvotes**: 56

**Links**: [GitHub](https://github.com/sb-ai-lab/MADD)
...
## 4. [Time-to-Move: Training-Free Motion Controlled Video Generation via Dual-Clock Denoising](https://huggingface.co/papers/2511.08633)

**ArXiv ID**: [2511.08633](https://arxiv.org/abs/2511.08633)

**Organization**: Technion Israel institute of technology

**Authors**: Assaf Singer, Noam Rotstein, Amir Mann, Ron Kimmel, Or Litany

**Published**: 2025-11-09 | **Submitted**: 2025-11-13 by taesiri

**Upvotes**: 55

**Links**: [GitHub](https://github.com/time-to-move/TTM) | [Project Page](https://time-to-move.github.io/)
...
## 5. [Motif 2 12.7B technical report](https://huggingface.co/papers/2511.07464)

**ArXiv ID**: [2511.07464](https://arxiv.org/abs/2511.07464)
...
**Published**: 2025-11-07 | **Submitted**: 2025-11-13 by Elie Bakouch
...
## 6. [WMPO: World Model-based Policy Optimization for Vision-Language-Action Models](https://huggingface.co/papers/2511.09515)

**ArXiv ID**: [2511.09515](https://arxiv.org/abs/2511.09515)
...
**Links**: [GitHub](https://github.com/WM-PO/WMPO) | [Project Page](https://wm-po.github.io/)
...
## 7. [LoopTool: Closing the Data-Training Loop for Robust LLM Tool Calls](https://huggingface.co/papers/2511.09148)

**ArXiv ID**: [2511.09148](https://arxiv.org/abs/2511.09148)

**Organization**: Shanghai Jiao Tong University

**Authors**: Kangning Zhang, Wenxiang Jiao, Kounianhua Du, Yuan Lu, Weiwen Liu, Weinan Zhang, Lei Zhang, Yong Yu

**Published**: 2025-11-12 | **Submitted**: 2025-11-13 by 张康宁

**Upvotes**: 18

**Links**: [GitHub](https://github.com/Rednote-ExperienceAI-Lab/LoopTool)
...
## 8. [WebVIA: A Web-based Vision-Language Agentic Framework for Interactive and Verifiable UI-to-Code Generation](https://huggingface.co/papers/2511.06251)

**ArXiv ID**: [2511.06251](https://arxiv.org/abs/2511.06251)

**Organization**: Tsinghua University

**Authors**: Mingde Xu, Zhen Yang, Wenyi Hong, Lihang Pan, Xinyue Fan, Yan Wang, Xiaotao Gu, Bin Xu, Jie Tang

**Published**: 2025-11-09 | **Submitted**: 2025-11-13 by ZhenYang21

**Upvotes**: 14

**Links**: [GitHub](https://github.com/zheny2751-dotcom/WebVIA) | [Project Page](https://zheny2751-dotcom.github.io/webvia.github.io/)
...
## 9. [MathSE: Improving Multimodal Mathematical Reasoning via Self-Evolving Iterative Reflection and Reward-Guided Fine-Tuning](https://huggingface.co/papers/2511.06805)

**ArXiv ID**: [2511.06805](https://arxiv.org/abs/2511.06805)

**Organization**: Tsinghua University

**Authors**: Jinhao Chen, Zhen Yang, Jianxin Shi, Tianyu Wo, Jie Tang

**Published**: 2025-11-10 | **Submitted**: 2025-11-13 by ZhenYang21

**Upvotes**: 13

**Links**: [GitHub](https://github.com/zheny2751-dotcom/MathSE) | [Project Page](https://zheny2751-dotcom.github.io/MathSE.github.io/)
...
## 10. [Adapting Web Agents with Synthetic Supervision](https://huggingface.co/papers/2511.06101)

**ArXiv ID**: [2511.06101](https://arxiv.org/abs/2511.06101)
...
**Published**: 2025-11-08 | **Submitted**: 2025-11-13 by Chi

**Upvotes**: 7

**Links**: [GitHub](https://github.com/aiming-lab/SynthAgent) | [Project Page](https://github.com/aiming-lab/SynthAgent)
...
## 11. [Toward the Frontiers of Reliable Diffusion Sampling via Adversarial Sinkhorn Attention Guidance](https://huggingface.co/papers/2511.07499)

**ArXiv ID**: [2511.07499](https://arxiv.org/abs/2511.07499)

**Authors**: Kwanyoung Kim

**Published**: 2025-11-10 | **Submitted**: 2025-11-13 by Kwanyoung
...
## 12. [Agentic Refactoring: An Empirical Study of AI Coding Agents](https://huggingface.co/papers/2511.04824)

**ArXiv ID**: [2511.04824](https://arxiv.org/abs/2511.04824)

**Authors**: Kosei Horikawa, Hao Li, Yutaro Kashiwa, Bram Adams, Hajimu Iida, Ahmed E. Hassan

**Published**: 2025-11-06 | **Submitted**: 2025-11-13 by Leo
...
## 13. [Stemming Hallucination in Language Models Using a Licensing Oracle](https://huggingface.co/papers/2511.06073)

**ArXiv ID**: [2511.06073](https://arxiv.org/abs/2511.06073)

**Authors**: Simeon Emanuilov, Richard Ackermann

**Published**: 2025-11-08 | **Submitted**: 2025-11-13 by Simeon Emanuilov
