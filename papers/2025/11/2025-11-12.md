...
> source: [Hugging Face Daily Papers](https://huggingface.co/papers/date/2025-11-12)

Total papers: 15

---

## 1. [Tiny Model, Big Logic: Diversity-Driven Optimization Elicits Large-Model
  Reasoning Ability in VibeThinker-1.5B](https://huggingface.co/papers/2511.06221)

**ArXiv ID**: [2511.06221](https://arxiv.org/abs/2511.06221)
...
**Published**: 2025-11-09 | **Submitted**: 2025-11-12 by DenseHub
...
## 2. [Grounding Computer Use Agents on Human Demonstrations](https://huggingface.co/papers/2511.07332)

**ArXiv ID**: [2511.07332](https://arxiv.org/abs/2511.07332)
...
**Published**: 2025-11-10 | **Submitted**: 2025-11-12 by Aarash Feizi

**Upvotes**: 106

**Links**: [GitHub](https://github.com/ServiceNow/GroundCUA) | [Project Page](https://groundcua.github.io/)
...
## 3. [Adaptive Multi-Agent Response Refinement in Conversational Systems](https://huggingface.co/papers/2511.08319)

**ArXiv ID**: [2511.08319](https://arxiv.org/abs/2511.08319)

**Organization**: Amazon

**Authors**: Soyeong Jeong, Aparna Elangovan, Emine Yilmaz, Oleg Rokhlenko

**Published**: 2025-11-11 | **Submitted**: 2025-11-12 by Soyeong
...
## 4. [KLASS: KL-Guided Fast Inference in Masked Diffusion Models](https://huggingface.co/papers/2511.05664)

**ArXiv ID**: [2511.05664](https://arxiv.org/abs/2511.05664)

**Organization**: KAIST AI

**Authors**: Seo Hyun Kim, Sunwoo Hong, Hojung Jung, Youngrok Park, Se-Young Yun

**Published**: 2025-11-07 | **Submitted**: 2025-11-12 by Seo Hyun Kim

**Upvotes**: 37

**Links**: [GitHub](https://github.com/shkim0116/KLASS)
...
## 5. [The Path Not Taken: RLVR Provably Learns Off the Principals](https://huggingface.co/papers/2511.08567)

**ArXiv ID**: [2511.08567](https://arxiv.org/abs/2511.08567)
...
**Published**: 2025-11-11 | **Submitted**: 2025-11-12 by Hanqing Zhu
...
## 6. [Beyond English: Toward Inclusive and Scalable Multilingual Machine Translation with LLMs](https://huggingface.co/papers/2511.07003)

**ArXiv ID**: [2511.07003](https://arxiv.org/abs/2511.07003)
...
**Published**: 2025-11-10 | **Submitted**: 2025-11-12 by luoyingfeng

**Upvotes**: 34

**Links**: [GitHub](https://github.com/NiuTrans/LMT) | [Project Page](https://github.com/NiuTrans/LMT)
...
## 7. [Wasm: A Pipeline for Constructing Structured Arabic Interleaved
  Multimodal Corpora](https://huggingface.co/papers/2511.07080)

**ArXiv ID**: [2511.07080](https://arxiv.org/abs/2511.07080)

**Authors**: Khalil Hennara, Ahmad Bastati, Muhammad Hreden, Mohamed Motasim Hamed, Zeina Aldallal, Sara Chrouf, Safwan AlModhayan

**Published**: 2025-11-10 | **Submitted**: 2025-11-12 by Khalil Hennara
...
## 8. [VideoSSR: Video Self-Supervised Reinforcement Learning](https://huggingface.co/papers/2511.06281)

**ArXiv ID**: [2511.06281](https://arxiv.org/abs/2511.06281)

**Organization**: shanghai ailab 

**Authors**: Zefeng He, Xiaoye Qu, Yafu Li, Siyuan Huang, Daizong Liu, Yu Cheng

**Published**: 2025-11-09 | **Submitted**: 2025-11-12 by Xiaoye Qu

**Upvotes**: 25

**Links**: [GitHub](https://github.com/lcqysl/VideoSSR) | [Project Page](https://github.com/lcqysl/VideoSSR)
...
## 9. [Intelligence per Watt: Measuring Intelligence Efficiency of Local AI](https://huggingface.co/papers/2511.07885)

**ArXiv ID**: [2511.07885](https://arxiv.org/abs/2511.07885)
...
**Published**: 2025-11-11 | **Submitted**: 2025-11-12 by Narayan

**Upvotes**: 10

**Links**: [GitHub](https://github.com/HazyResearch/intelligence-per-watt)
...
## 10. [Beyond Fact Retrieval: Episodic Memory for RAG with Generative Semantic Workspaces](https://huggingface.co/papers/2511.07587)

**ArXiv ID**: [2511.07587](https://arxiv.org/abs/2511.07587)

**Authors**: Shreyas Rajesh, Pavan Holur, Chenda Duan, David Chong, Vwani Roychowdhury

**Published**: 2025-11-10 | **Submitted**: 2025-11-12 by Shreyas Rajesh

**Upvotes**: 10

**Links**: [GitHub](https://github.com/roychowdhuryresearch/gsw-memory)
...
## 11. [DynaAct: Large Language Model Reasoning with Dynamic Action Spaces](https://huggingface.co/papers/2511.08043)

**ArXiv ID**: [2511.08043](https://arxiv.org/abs/2511.08043)

**Authors**: Xueliang Zhao, Wei Wu, Jian Guan, Qintong Li, Lingpeng Kong

**Published**: 2025-11-11 | **Submitted**: 2025-11-12 by Xueliang Zhao

**Upvotes**: 6

**Links**: [GitHub](https://github.com/zhaoxlpku/DynaAct)
...
## 12. [Optimizing Diversity and Quality through Base-Aligned Model Collaboration](https://huggingface.co/papers/2511.05650)

**ArXiv ID**: [2511.05650](https://arxiv.org/abs/2511.05650)

**Authors**: Yichen Wang, Chenghao Yang, Tenghao Huang, Muhao Chen, Jonathan May, Mina Lee

**Published**: 2025-11-07 | **Submitted**: 2025-11-12 by Chenghao Yang

**Upvotes**: 6

**Links**: [GitHub](https://github.com/YichenZW/base-align-collab)
...
## 13. [Walking the Tightrope of LLMs for Software Development: A Practitioners' Perspective](https://huggingface.co/papers/2511.06428)

**ArXiv ID**: [2511.06428](https://arxiv.org/abs/2511.06428)

**Authors**: Samuel Ferino, Rashina Hoda, John Grundy, Christoph Treude

**Published**: 2025-11-09 | **Submitted**: 2025-11-12 by Samuel Ferino
...
## 14. [BiCA: Effective Biomedical Dense Retrieval with Citation-Aware Hard Negatives](https://huggingface.co/papers/2511.08029)

**ArXiv ID**: [2511.08029](https://arxiv.org/abs/2511.08029)

**Organization**: Biosystems Engineering and Control Group

**Authors**: Aarush Sinha, Pavan Kumar S, Roshan Balaji, Nirav Pravinbhai Bhatt

**Published**: 2025-11-11 | **Submitted**: 2025-11-12 by Aarush

**Upvotes**: 4

**Links**: [GitHub](https://github.com/NiravBhattLab/BiCA)
...
## 15. [TimeSearch-R: Adaptive Temporal Search for Long-Form Video Understanding via Self-Verification Reinforcement Learning](https://huggingface.co/papers/2511.05489)

**ArXiv ID**: [2511.05489](https://arxiv.org/abs/2511.05489)

**Organization**: ByteDance

**Authors**: Junwen Pan, Qizhe Zhang, Rui Zhang, Ming Lu, Xin Wan, Yuan Zhang, Chang Liu, Qi She

**Published**: 2025-11-07 | **Submitted**: 2025-11-12 by Qizhe Zhang

**Upvotes**: 3

**Links**: [GitHub](https://github.com/Time-Search/TimeSearch-R)
