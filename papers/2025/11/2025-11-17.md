# Daily Papers - 2025-11-17

> source: [Hugging Face Daily Papers](https://huggingface.co/papers/date/2025-11-17)

Total papers: 23

---

## 1. [DoPE: Denoising Rotary Position Embedding](https://huggingface.co/papers/2511.09146)

**ArXiv ID**: [2511.09146](https://arxiv.org/abs/2511.09146)

**Authors**: Jing Xiong, Liyang Fan, Hui Shen, Zunhai Su, Min Yang, Lingpeng Kong, Ngai Wong

**Published**: 2025-11-12 | **Submitted**: 2025-11-17 by Jing Xiong

**Upvotes**: 97

**Links**: [Project Page](https://The-physical-picture-of-LLMs.github.io)
...
## 2. [WEAVE: Unleashing and Benchmarking the In-context Interleaved Comprehension and Generation](https://huggingface.co/papers/2511.11434)

**ArXiv ID**: [2511.11434](https://arxiv.org/abs/2511.11434)
...
**Published**: 2025-11-14 | **Submitted**: 2025-11-17 by wu weijia

**Upvotes**: 46

**Links**: [GitHub](https://github.com/weichow23/weave) | [Project Page](https://weichow23.github.io/weave/)
...
## 3. [Virtual Width Networks](https://huggingface.co/papers/2511.11238)

**ArXiv ID**: [2511.11238](https://arxiv.org/abs/2511.11238)
...
**Published**: 2025-11-14 | **Submitted**: 2025-11-17 by taesiri
...
## 4. [UI2Code^N: A Visual Language Model for Test-Time Scalable Interactive UI-to-Code Generation](https://huggingface.co/papers/2511.08195)

**ArXiv ID**: [2511.08195](https://arxiv.org/abs/2511.08195)

**Authors**: Zhen Yang, Wenyi Hong, Mingde Xu, Xinyue Fan, Weihan Wang, Jiele Cheng, Xiaotao Gu, Jie Tang

**Published**: 2025-11-11 | **Submitted**: 2025-11-17 by Wenyi Hong

**Upvotes**: 34

**Links**: [GitHub](https://github.com/zai-org/UI2Code_N) | [Project Page](https://zheny2751-dotcom.github.io/ui2code-n.github.io/)
...
## 5. [GGBench: A Geometric Generative Reasoning Benchmark for Unified Multimodal Models](https://huggingface.co/papers/2511.11134)

**ArXiv ID**: [2511.11134](https://arxiv.org/abs/2511.11134)
...
**Links**: [GitHub](https://github.com/opendatalab-raiser/GGBench) | [Project Page](https://opendatalab-raiser.github.io/GGBench)
...
## 6. [LiteAttention: A Temporal Sparse Attention for Diffusion Transformers](https://huggingface.co/papers/2511.11062)

**ArXiv ID**: [2511.11062](https://arxiv.org/abs/2511.11062)

**Organization**: MoonMath.ai

**Authors**: Dor Shmilovich, Tony Wu, Aviad Dahan, Yuval Domb

**Published**: 2025-11-14 | **Submitted**: 2025-11-17 by Aviad Dahan

**Upvotes**: 32

**Links**: [GitHub](https://github.com/moonmath-ai/LiteAttention) | [Project Page](https://moonmath-ai.github.io/LiteAttention/)
...
## 7. [Simulating the Visual World with Artificial Intelligence: A Roadmap](https://huggingface.co/papers/2511.08585)

**ArXiv ID**: [2511.08585](https://arxiv.org/abs/2511.08585)

**Authors**: Jingtong Yue, Ziqi Huang, Zhaoxi Chen, Xintao Wang, Pengfei Wan, Ziwei Liu

**Published**: 2025-11-11 | **Submitted**: 2025-11-17 by Ziqi Huang

**Upvotes**: 30

**Links**: [GitHub](https://github.com/ziqihuangg/Awesome-From-Video-Generation-to-World-Model) | [Project Page](https://world-model-roadmap.github.io)
...
## 8. [AIonopedia: an LLM agent orchestrating multimodal learning for ionic liquid discovery](https://huggingface.co/papers/2511.11257)

**ArXiv ID**: [2511.11257](https://arxiv.org/abs/2511.11257)
...
**Published**: 2025-11-14 | **Submitted**: 2025-11-17 by Yuqi Yin
...
## 9. [MarsRL: Advancing Multi-Agent Reasoning System via Reinforcement Learning with Agentic Pipeline Parallelism](https://huggingface.co/papers/2511.11373)

**ArXiv ID**: [2511.11373](https://arxiv.org/abs/2511.11373)

**Organization**: Tencent

**Authors**: Shulin Liu, Dong Du, Tao Yang, Yang Li, Boyu Qiu

**Published**: 2025-11-14 | **Submitted**: 2025-11-17 by liu

**Upvotes**: 14

**Links**: [GitHub](https://github.com/liushulinle/MarsRL)
...
## 10. [SpatialThinker: Reinforcing 3D Reasoning in Multimodal LLMs via Spatial Rewards](https://huggingface.co/papers/2511.07403)

**ArXiv ID**: [2511.07403](https://arxiv.org/abs/2511.07403)

**Organization**: Perceptual Intelligence and Extended Reality Lab

**Authors**: Hunar Batra, Haoqin Tu, Hardy Chen, Yuanze Lin, Cihang Xie, Ronald Clark

**Published**: 2025-11-10 | **Submitted**: 2025-11-17 by Hunar Batra

**Upvotes**: 14

**Links**: [GitHub](https://github.com/hunarbatra/SpatialThinker) | [Project Page](https://hunarbatra.com/SpatialThinker/)
...
## 11. [RF-DETR: Neural Architecture Search for Real-Time Detection Transformers](https://huggingface.co/papers/2511.09554)

**ArXiv ID**: [2511.09554](https://arxiv.org/abs/2511.09554)

**Organization**: Roboflow

**Authors**: Isaac Robinson, Peter Robicheaux, Matvei Popov, Deva Ramanan, Neehar Peri

**Published**: 2025-11-12 | **Submitted**: 2025-11-17 by Merve Noyan

**Upvotes**: 9

**Links**: [GitHub](https://github.com/roboflow/rf-detr) | [Project Page](https://rfdetr.roboflow.com/1.3.0/)
...
## 12. [HI-TransPA: Hearing Impairments Translation Personal Assistant](https://huggingface.co/papers/2511.09915)

**ArXiv ID**: [2511.09915](https://arxiv.org/abs/2511.09915)

**Organization**: SmartFlowAI
...
**Published**: 2025-11-13 | **Submitted**: 2025-11-17 by ZhimingMa
...
## 13. [DiscoX: Benchmarking Discourse-Level Translation task in Expert Domains](https://huggingface.co/papers/2511.10984)

**ArXiv ID**: [2511.10984](https://arxiv.org/abs/2511.10984)
...
**Links**: [GitHub](https://github.com/ByteDance-Seed/DiscoX) | [Project Page](https://randomtutu.github.io/DiscoX/)
...
## 14. [Don't Waste It: Guiding Generative Recommenders with Structured Human Priors via Multi-head Decoding](https://huggingface.co/papers/2511.10492)

**ArXiv ID**: [2511.10492](https://arxiv.org/abs/2511.10492)
...
**Published**: 2025-11-13 | **Submitted**: 2025-11-17 by Yunkai Zhang

**Upvotes**: 6

**Links**: [GitHub](https://github.com/zhykoties/Multi-Head-Recommendation-with-Human-Priors)
...
## 15. [Experience-Guided Adaptation of Inference-Time Reasoning Strategies](https://huggingface.co/papers/2511.11519)

**ArXiv ID**: [2511.11519](https://arxiv.org/abs/2511.11519)

**Organization**: Amazon Web Services

**Authors**: Adam Stein, Matthew Trager, Benjamin Bowman, Michael Kleinman, Aditya Chattopadhyay, Wei Xia, Stefano Soatto

**Published**: 2025-11-14 | **Submitted**: 2025-11-17 by Adam Stein
...
## 16. [EmoVid: A Multimodal Emotion Video Dataset for Emotion-Centric Video Understanding and Generation](https://huggingface.co/papers/2511.11002)

**ArXiv ID**: [2511.11002](https://arxiv.org/abs/2511.11002)
...
**Links**: [Project Page](https://zane-zyqiu.github.io/EmoVid)
...
## 17. [From Proof to Program: Characterizing Tool-Induced Reasoning Hallucinations in Large Language Models](https://huggingface.co/papers/2511.10899)

**ArXiv ID**: [2511.10899](https://arxiv.org/abs/2511.10899)

**Organization**: Megagon Labs

**Authors**: Farima Fatahi Bayat, Pouya Pezeshkpour, Estevam Hruschka

**Published**: 2025-11-14 | **Submitted**: 2025-11-17 by pouya pezeshkpour

**Upvotes**: 4

**Links**: [GitHub](https://github.com/megagonlabs/TIM)
...
## 18. [miniF2F-Lean Revisited: Reviewing Limitations and Charting a Path Forward](https://huggingface.co/papers/2511.03108)

**ArXiv ID**: [2511.03108](https://arxiv.org/abs/2511.03108)

**Authors**: Azim Ospanov, Farzan Farnia, Roozbeh Yousefzadeh

**Published**: 2025-11-05 | **Submitted**: 2025-11-17 by Roozbeh Yousefzadeh

**Upvotes**: 4

**Links**: [GitHub](https://github.com/roozbeh-yz/miniF2F_v2)
...
## 19. [Large Language Models for Scientific Idea Generation: A Creativity-Centered Survey](https://huggingface.co/papers/2511.07448)

**ArXiv ID**: [2511.07448](https://arxiv.org/abs/2511.07448)
...
**Published**: 2025-11-05 | **Submitted**: 2025-11-17 by Arash Mari Oriyad
...
## 20. [Building the Web for Agents: A Declarative Framework for Agent-Web Interaction](https://huggingface.co/papers/2511.11287)

**ArXiv ID**: [2511.11287](https://arxiv.org/abs/2511.11287)

**Authors**: Sven Schultze, Meike Verena Kietzmann, Nils-Lucas Schönfeld, Ruth Stock-Homburg

**Published**: 2025-11-14 | **Submitted**: 2025-11-17 by Chaoyun Zhang

**Upvotes**: 2

**Links**: [GitHub](https://github.com/svenschultze/VOIX) | [Project Page](https://svenschultze.github.io/VOIX/)
...
## 21. [CATS-V2V: A Real-World Vehicle-to-Vehicle Cooperative Perception Dataset with Complex Adverse Traffic Scenarios](https://huggingface.co/papers/2511.11168)

**ArXiv ID**: [2511.11168](https://arxiv.org/abs/2511.11168)
...
## 22. [Workload Schedulers -- Genesis, Algorithms and Differences](https://huggingface.co/papers/2511.10258)

**ArXiv ID**: [2511.10258](https://arxiv.org/abs/2511.10258)

**Authors**: Leszek Sliwko, Vladimir Getov

**Published**: 2025-11-13 | **Submitted**: 2025-11-17 by Leszek Sliwko
...
## 23. [A Meta-Heuristic Load Balancer for Cloud Computing Systems](https://huggingface.co/papers/2511.11721)

**ArXiv ID**: [2511.11721](https://arxiv.org/abs/2511.11721)

**Authors**: Vladimir Getov
