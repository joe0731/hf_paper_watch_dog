...
## 2. [Deep Think with Confidence](https://huggingface.co/papers/2508.15260)

**ArXiv ID**: [2508.15260](https://arxiv.org/abs/2508.15260)

**Authors**: Yichao Fu, Xuewei Wang, Yuandong Tian, Jiawei Zhao

**Published**: 2025-08-21 | **Submitted**: 2025-08-22 by Jiawei Zhao

**Upvotes**: 90

**Links**: [GitHub](https://github.com/facebookresearch/deepconf) | [Project Page](https://jiaweizzhao.github.io/deepconf/)
...
## 3. [Mobile-Agent-v3: Foundamental Agents for GUI Automation](https://huggingface.co/papers/2508.15144)

**ArXiv ID**: [2508.15144](https://arxiv.org/abs/2508.15144)
...
**Published**: 2025-08-21 | **Submitted**: 2025-08-22 by xuhaiyang

**Upvotes**: 65

**Links**: [GitHub](https://github.com/X-PLUG/MobileAgent) | [Project Page](https://github.com/X-PLUG/MobileAgent)
...
## 4. [LiveMCP-101: Stress Testing and Diagnosing MCP-enabled Agents on
  Challenging Queries](https://huggingface.co/papers/2508.15760)

**ArXiv ID**: [2508.15760](https://arxiv.org/abs/2508.15760)
...
**Published**: 2025-08-21 | **Submitted**: 2025-08-22 by Ming Yin
...
## 5. [Waver: Wave Your Way to Lifelike Video Generation](https://huggingface.co/papers/2508.15761)

**ArXiv ID**: [2508.15761](https://arxiv.org/abs/2508.15761)

**Authors**: Yifu Zhang, Hao Yang, Yuqi Zhang, Yifei Hu, Fengda Zhu, Chuang Lin, Xiaofeng Mei, Yi Jiang, Zehuan Yuan, Bingyue Peng

**Published**: 2025-08-21 | **Submitted**: 2025-08-22 by taesiri

**Upvotes**: 36

**Links**: [GitHub](https://github.com/FoundationVision/Waver)
...
## 6. [aiXiv: A Next-Generation Open Access Ecosystem for Scientific Discovery
  Generated by AI Scientists](https://huggingface.co/papers/2508.15126)

**ArXiv ID**: [2508.15126](https://arxiv.org/abs/2508.15126)
...
**Published**: 2025-08-20 | **Submitted**: 2025-08-22 by Pengsong Zhang

**Upvotes**: 20

**Links**: [Project Page](https://aixiv.science/)
...
## 7. [SceneGen: Single-Image 3D Scene Generation in One Feedforward Pass](https://huggingface.co/papers/2508.15769)

**ArXiv ID**: [2508.15769](https://arxiv.org/abs/2508.15769)

**Authors**: Yanxu Meng, Haoning Wu, Ya Zhang, Weidi Xie

**Published**: 2025-08-21 | **Submitted**: 2025-08-22 by Haoning Wu

**Upvotes**: 19

**Links**: [GitHub](https://github.com/Mengmouxu/SceneGen) | [Project Page](https://mengmouxu.github.io/SceneGen/)
...
## 8. [A Survey on Large Language Model Benchmarks](https://huggingface.co/papers/2508.15361)

**ArXiv ID**: [2508.15361](https://arxiv.org/abs/2508.15361)
...
## 9. [ATLAS: Decoupling Skeletal and Shape Parameters for Expressive
  Parametric Human Modeling](https://huggingface.co/papers/2508.15767)

**ArXiv ID**: [2508.15767](https://arxiv.org/abs/2508.15767)
...
**Links**: [Project Page](https://jindapark.github.io/projects/atlas/)
...
## 10. [INTIMA: A Benchmark for Human-AI Companionship Behavior](https://huggingface.co/papers/2508.09998)

**ArXiv ID**: [2508.09998](https://arxiv.org/abs/2508.09998)

**Authors**: Lucie-Aimée Kaffee, Giada Pistilli, Yacine Jernite

**Published**: 2025-08-04 | **Submitted**: 2025-08-22 by Adina Yakefu
...
## 11. [Visual Autoregressive Modeling for Instruction-Guided Image Editing](https://huggingface.co/papers/2508.15772)

**ArXiv ID**: [2508.15772](https://arxiv.org/abs/2508.15772)

**Authors**: Qingyang Mao, Qi Cai, Yehao Li, Yingwei Pan, Mingyue Cheng, Ting Yao, Qi Liu, Tao Mei

**Published**: 2025-08-21 | **Submitted**: 2025-08-22 by Qi Cai

**Upvotes**: 9

**Links**: [GitHub](https://github.com/HiDream-ai/VAREdit) | [Project Page](https://huggingface.co/HiDream-ai/VAREdit)
...
## 12. [Snap-Snap: Taking Two Images to Reconstruct 3D Human Gaussians in
  Milliseconds](https://huggingface.co/papers/2508.14892)

**ArXiv ID**: [2508.14892](https://arxiv.org/abs/2508.14892)

**Authors**: Jia Lu, Taoran Yi, Jiemin Fang, Chen Yang, Chuiyun Wu, Wei Shen, Wenyu Liu, Qi Tian, Xinggang Wang

**Published**: 2025-08-20 | **Submitted**: 2025-08-22 by taoranyi

**Upvotes**: 9

**Links**: [GitHub](https://github.com/hustvl/Snap-Snap) | [Project Page](https://hustvl.github.io/Snap-Snap/)
...
## 13. ["Does the cafe entrance look accessible? Where is the door?" Towards
  Geospatial AI Agents for Visual Inquiries](https://huggingface.co/papers/2508.15752)

**ArXiv ID**: [2508.15752](https://arxiv.org/abs/2508.15752)
...
## 14. [LLaSO: A Foundational Framework for Reproducible Research in Large
  Language and Speech Model](https://huggingface.co/papers/2508.15418)

**ArXiv ID**: [2508.15418](https://arxiv.org/abs/2508.15418)

**Authors**: Yirong Sun, Yizhong Geng, Peidong Wei, Yanjun Chen, Jinghan Yang, Rongfei Chen, Wei Zhang, Xiaoyu Shen

**Published**: 2025-08-21 | **Submitted**: 2025-08-22 by Yirong Sun

**Upvotes**: 8

**Links**: [GitHub](https://github.com/EIT-NLP/LLaSO)
...
## 15. [Fin-PRM: A Domain-Specialized Process Reward Model for Financial
  Reasoning in Large Language Models](https://huggingface.co/papers/2508.15202)

**ArXiv ID**: [2508.15202](https://arxiv.org/abs/2508.15202)

**Organization**: Qwen DianJin

**Authors**: Yuanchen Zhou, Shuo Jiang, Jie Zhu, Junhui Li, Lifan Guo, Feng Chen, Chi Zhang

**Published**: 2025-08-21 | **Submitted**: 2025-08-22 by Jie Zhu
...
## 16. [When and What: Diffusion-Grounded VideoLLM with Entity Aware
  Segmentation for Long Video Understanding](https://huggingface.co/papers/2508.15641)

**ArXiv ID**: [2508.15641](https://arxiv.org/abs/2508.15641)
