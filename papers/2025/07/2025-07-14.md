# Daily Papers - 2025-07-14

> source: [Hugging Face Daily Papers](https://huggingface.co/papers/date/2025-07-14)

Total papers: 17

---

## 1. [Test-Time Scaling with Reflective Generative Model](https://huggingface.co/papers/2507.01951)

**ArXiv ID**: [2507.01951](https://arxiv.org/abs/2507.01951)
...
**Published**: 2025-07-02 | **Submitted**: 2025-07-14 by Yuxin Wang

**Upvotes**: 107

**Links**: [GitHub](https://github.com/MetaStone-AI/MetaStone-S1)
...
## 2. [NeuralOS: Towards Simulating Operating Systems via Neural Generative
  Models](https://huggingface.co/papers/2507.08800)

**ArXiv ID**: [2507.08800](https://arxiv.org/abs/2507.08800)

**Organization**: Yuntian Group

**Authors**: Luke Rivard, Sun Sun, Hongyu Guo, Wenhu Chen, Yuntian Deng

**Published**: 2025-07-11 | **Submitted**: 2025-07-14 by Yuntian Deng

**Upvotes**: 81

**Links**: [GitHub](https://github.com/yuntian-group/neural-os) | [Project Page](https://neural-os.com/)
...
## 3. [Open Vision Reasoner: Transferring Linguistic Cognitive Behavior for
  Visual Reasoning](https://huggingface.co/papers/2507.05255)
...
**Published**: 2025-07-07 | **Submitted**: 2025-07-14 by Yana Wei

**Upvotes**: 75

**Links**: [GitHub](https://github.com/Open-Reasoner-Zero/Open-Vision-Reasoner) | [Project Page](https://weiyana.github.io/Open-Vision-Reasoner/)
...
## 5. [Vision Foundation Models as Effective Visual Tokenizers for
  Autoregressive Image Generation](https://huggingface.co/papers/2507.08441)

**ArXiv ID**: [2507.08441](https://arxiv.org/abs/2507.08441)

**Authors**: Anlin Zheng, Xin Wen, Xuanyang Zhang, Chuofan Ma, Tiancai Wang, Gang Yu, Xiangyu Zhang, Xiaojuan Qi

**Published**: 2025-07-11 | **Submitted**: 2025-07-14 by Xin Wen
...
## 6. [CLiFT: Compressive Light-Field Tokens for Compute-Efficient and Adaptive
  Neural Rendering](https://huggingface.co/papers/2507.08776)

**ArXiv ID**: [2507.08776](https://arxiv.org/abs/2507.08776)

**Authors**: Zhengqing Wang, Yuefan Wu, Jiacheng Chen, Fuyang Zhang, Yasutaka Furukawa

**Published**: 2025-07-11 | **Submitted**: 2025-07-14 by Zhengqing Wang

**Upvotes**: 55

**Links**: [GitHub](https://github.com/eric-zqwang/CLiFT) | [Project Page](https://clift-nvs.github.io/)
...
## 7. [KV Cache Steering for Inducing Reasoning in Small Language Models](https://huggingface.co/papers/2507.08799)

**ArXiv ID**: [2507.08799](https://arxiv.org/abs/2507.08799)

**Authors**: Max Belitsky, Dawid J. Kopiczko, Michael Dorkenwald, M. Jehanzeb Mirza, Cees G. M. Snoek, Yuki M. Asano

**Published**: 2025-07-11 | **Submitted**: 2025-07-14 by Yuki Asano

**Upvotes**: 40

**Links**: [GitHub](https://github.com/MaxBelitsky/cache-steering)
...
## 8. [Lumos-1: On Autoregressive Video Generation from a Unified Model
  Perspective](https://huggingface.co/papers/2507.08801)
...
**Published**: 2025-07-11 | **Submitted**: 2025-07-14 by Hangjie Yuan

**Upvotes**: 32

**Links**: [GitHub](https://github.com/alibaba-damo-academy/Lumos)
...
## 9. [One Token to Fool LLM-as-a-Judge](https://huggingface.co/papers/2507.08794)

**ArXiv ID**: [2507.08794](https://arxiv.org/abs/2507.08794)

**Authors**: Yulai Zhao, Haolin Liu, Dian Yu, S. Y. Kung, Haitao Mi, Dong Yu

**Published**: 2025-07-11 | **Submitted**: 2025-07-14 by Dian Yu
...
## 10. [Neural-Driven Image Editing](https://huggingface.co/papers/2507.05397)

**ArXiv ID**: [2507.05397](https://arxiv.org/abs/2507.05397)
...
**Published**: 2025-07-07 | **Submitted**: 2025-07-14 by kaipeng

**Upvotes**: 27

**Links**: [GitHub](https://github.com/LanceZPF/loongx) | [Project Page](https://loongx1.github.io/)
...
## 11. [From One to More: Contextual Part Latents for 3D Generation](https://huggingface.co/papers/2507.08772)

**ArXiv ID**: [2507.08772](https://arxiv.org/abs/2507.08772)
...
**Published**: 2025-07-11 | **Submitted**: 2025-07-14 by Shaocong Dong

**Upvotes**: 26

**Links**: [GitHub](https://github.com/hkdsc/copart) | [Project Page](https://hkdsc.github.io/project/copart/)
...
## 12. [Audio Flamingo 3: Advancing Audio Intelligence with Fully Open Large
  Audio Language Models](https://huggingface.co/papers/2507.08128)

**ArXiv ID**: [2507.08128](https://arxiv.org/abs/2507.08128)
...
**Published**: 2025-07-10 | **Submitted**: 2025-07-14 by Ghosh
...
## 13. [BlockFFN: Towards End-Side Acceleration-Friendly Mixture-of-Experts with
  Chunk-Level Activation Sparsity](https://huggingface.co/papers/2507.08771)

**ArXiv ID**: [2507.08771](https://arxiv.org/abs/2507.08771)

**Authors**: Chenyang Song, Weilin Zhao, Xu Han, Chaojun Xiao, Yingfa Chen, Yuxuan Li, Zhiyuan Liu, Maosong Sun

**Published**: 2025-07-11 | **Submitted**: 2025-07-14 by Chenyang Song

**Upvotes**: 10

**Links**: [GitHub](https://github.com/thunlp/BlockFFN)
...
## 14. [What Has a Foundation Model Found? Using Inductive Bias to Probe for
  World Models](https://huggingface.co/papers/2507.06952)

**ArXiv ID**: [2507.06952](https://arxiv.org/abs/2507.06952)

**Authors**: Keyon Vafa, Peter G. Chang, Ashesh Rambachan, Sendhil Mullainathan

**Published**: 2025-07-09 | **Submitted**: 2025-07-14 by Fangyuan Yu
...
## 15. [Robust Multimodal Large Language Models Against Modality Conflict](https://huggingface.co/papers/2507.07151)

**ArXiv ID**: [2507.07151](https://arxiv.org/abs/2507.07151)

**Authors**: Zongmeng Zhang, Wengang Zhou, Jie Zhao, Houqiang Li

**Published**: 2025-07-09 | **Submitted**: 2025-07-14 by Zongmeng Zhang

**Upvotes**: 6

**Links**: [GitHub](https://github.com/zmzhang2000/MMMC) | [Project Page](https://github.com/zmzhang2000/MMMC)
...
## 16. [Doodle Your Keypoints: Sketch-Based Few-Shot Keypoint Detection](https://huggingface.co/papers/2507.07994)

**ArXiv ID**: [2507.07994](https://arxiv.org/abs/2507.07994)

**Authors**: Subhajit Maity, Ayan Kumar Bhunia, Subhadeep Koley, Pinaki Nath Chowdhury, Aneeshan Sain, Yi-Zhe Song

**Published**: 2025-07-10 | **Submitted**: 2025-07-14 by Subhajit Maity

**Upvotes**: 3

**Links**: [GitHub](https://github.com/MaitySubhajit/DYKp) | [Project Page](https://subhajitmaity.me/DYKp)
...
## 17. [DOTResize: Reducing LLM Width via Discrete Optimal Transport-based
  Neuron Merging](https://huggingface.co/papers/2507.04517)

**ArXiv ID**: [2507.04517](https://arxiv.org/abs/2507.04517)

**Authors**: Neha Verma, Kenton Murray, Kevin Duh

**Published**: 2025-07-06 | **Submitted**: 2025-07-14 by Neha Verma
