# Daily Papers - 2025-07-25

> source: [Hugging Face Daily Papers](https://huggingface.co/papers/date/2025-07-25)

Total papers: 21

---

## 1. [Group Sequence Policy Optimization](https://huggingface.co/papers/2507.18071)

**ArXiv ID**: [2507.18071](https://arxiv.org/abs/2507.18071)
...
**Published**: 2025-07-24 | **Submitted**: 2025-07-25 by Chujie Zheng
...
## 2. [nablaNABLA: Neighborhood Adaptive Block-Level Attention](https://huggingface.co/papers/2507.13546)

**ArXiv ID**: [2507.13546](https://arxiv.org/abs/2507.13546)
...
**Published**: 2025-07-17 | **Submitted**: 2025-07-25 by Vladimir Korviakov

**Upvotes**: 125

**Links**: [GitHub](https://github.com/gen-ai-team/Wan2.1-NABLA)
...
## 3. [MUR: Momentum Uncertainty guided Reasoning for Large Language Models](https://huggingface.co/papers/2507.14958)

**ArXiv ID**: [2507.14958](https://arxiv.org/abs/2507.14958)
...
**Published**: 2025-07-20 | **Submitted**: 2025-07-25 by Fangzhi Xu

**Upvotes**: 47

**Links**: [GitHub](https://github.com/yayayacc/MUR) | [Project Page](https://github.com/yayayacc/MUR)
...
## 4. [Captain Cinema: Towards Short Movie Generation](https://huggingface.co/papers/2507.18634)

**ArXiv ID**: [2507.18634](https://arxiv.org/abs/2507.18634)
...
**Published**: 2025-07-24 | **Submitted**: 2025-07-25 by YSH

**Upvotes**: 42

**Links**: [Project Page](https://thecinema.ai/)
...
## 5. [GLiNER2: An Efficient Multi-Task Information Extraction System with
  Schema-Driven Interface](https://huggingface.co/papers/2507.18546)

**ArXiv ID**: [2507.18546](https://arxiv.org/abs/2507.18546)

**Authors**: Urchade Zaratiana, Gil Pasternak, Oliver Boyd, George Hurn-Maloney, Ash Lewis

**Published**: 2025-07-24 | **Submitted**: 2025-07-25 by Stefan Schweter

**Upvotes**: 36

**Links**: [GitHub](https://github.com/fastino-ai/GLiNER2)
...
## 6. [LAPO: Internalizing Reasoning Efficiency via Length-Adaptive Policy
  Optimization](https://huggingface.co/papers/2507.15758)

**ArXiv ID**: [2507.15758](https://arxiv.org/abs/2507.15758)
...
**Published**: 2025-07-21 | **Submitted**: 2025-07-25 by Yongliang Shen

**Upvotes**: 35

**Links**: [GitHub](https://github.com/ZJU-REAL/LAPO)
...
## 7. [EarthCrafter: Scalable 3D Earth Generation via Dual-Sparse Latent
  Diffusion](https://huggingface.co/papers/2507.16535)

**ArXiv ID**: [2507.16535](https://arxiv.org/abs/2507.16535)

**Authors**: Shang Liu, Chenjie Cao, Chaohui Yu, Wen Qian, Jing Wang, Fan Wang

**Published**: 2025-07-22 | **Submitted**: 2025-07-25 by Liu

**Upvotes**: 23

**Links**: [GitHub](https://github.com/whiteinblue/EarthCrafter) | [Project Page](https://whiteinblue.github.io/earthcrafter/)
...
## 8. [TTS-VAR: A Test-Time Scaling Framework for Visual Auto-Regressive
  Generation](https://huggingface.co/papers/2507.18537)

**ArXiv ID**: [2507.18537](https://arxiv.org/abs/2507.18537)

**Authors**: Zhekai Chen, Ruihang Chu, Yukang Chen, Shiwei Zhang, Yujie Wei, Yingya Zhang, Xihui Liu

**Published**: 2025-07-24 | **Submitted**: 2025-07-25 by zhekai chen

**Upvotes**: 18

**Links**: [GitHub](https://github.com/ali-vilab/TTS-VAR)
...
## 9. [Hierarchical Budget Policy Optimization for Adaptive Reasoning](https://huggingface.co/papers/2507.15844)

**ArXiv ID**: [2507.15844](https://arxiv.org/abs/2507.15844)
...
**Links**: [GitHub](https://github.com/zju-real/hbpo)
...
## 10. [DriftMoE: A Mixture of Experts Approach to Handle Concept Drifts](https://huggingface.co/papers/2507.18464)

**ArXiv ID**: [2507.18464](https://arxiv.org/abs/2507.18464)

**Authors**: Miguel Aspis, Sebastián A. Cajas Ordónez, Andrés L. Suárez-Cetrulo, Ricardo Simón Carbajo

**Published**: 2025-07-24 | **Submitted**: 2025-07-25 by Sebastián Andres Cajas Ordóñez

**Upvotes**: 12

**Links**: [GitHub](https://github.com/miguel-ceadar/drift-moe)
...
## 11. [Technical Report of TeleChat2, TeleChat2.5 and T1](https://huggingface.co/papers/2507.18013)

**ArXiv ID**: [2507.18013](https://arxiv.org/abs/2507.18013)
...
**Published**: 2025-07-24 | **Submitted**: 2025-07-25 by Zihan Wang

**Upvotes**: 11

**Links**: [GitHub](https://github.com/Tele-AI/TeleChat2)
...
## 12. [Agentar-Fin-R1: Enhancing Financial Intelligence through Domain
  Expertise, Training Efficiency, and Advanced Reasoning](https://huggingface.co/papers/2507.16802)

**ArXiv ID**: [2507.16802](https://arxiv.org/abs/2507.16802)
...
**Published**: 2025-07-22 | **Submitted**: 2025-07-25 by Adina Yakefu

**Upvotes**: 9

**Links**: [GitHub](https://github.com/antgroup/Finova)
...
## 13. [TeEFusion: Blending Text Embeddings to Distill Classifier-Free Guidance](https://huggingface.co/papers/2507.18192)

**ArXiv ID**: [2507.18192](https://arxiv.org/abs/2507.18192)

**Authors**: Minghao Fu, Guo-Hua Wang, Xiaohao Chen, Qing-Guo Chen, Zhao Xu, Weihua Luo, Kaifu Zhang

**Published**: 2025-07-24 | **Submitted**: 2025-07-25 by Guo-Hua Wang

**Upvotes**: 8

**Links**: [GitHub](https://github.com/AIDC-AI/TeEFusion)
...
## 14. [A New Pair of GloVes](https://huggingface.co/papers/2507.18103)

**ArXiv ID**: [2507.18103](https://arxiv.org/abs/2507.18103)
...
## 15. [Discovering and using Spelke segments](https://huggingface.co/papers/2507.16038)

**ArXiv ID**: [2507.16038](https://arxiv.org/abs/2507.16038)
...
**Published**: 2025-07-21 | **Submitted**: 2025-07-25 by Rahul Venkatesh

**Upvotes**: 8

**Links**: [GitHub](https://github.com/neuroailab/SpelkeNet) | [Project Page](https://neuroailab.github.io/spelke_net/)
...
## 16. [DMOSpeech 2: Reinforcement Learning for Duration Prediction in
  Metric-Optimized Speech Synthesis](https://huggingface.co/papers/2507.14988)

**ArXiv ID**: [2507.14988](https://arxiv.org/abs/2507.14988)

**Authors**: Yinghao Aaron Li, Xilin Jiang, Fei Tao, Cheng Niu, Kaifeng Xu, Juntong Song, Nima Mesgarani

**Published**: 2025-07-20 | **Submitted**: 2025-07-25 by Xilin Jiang

**Upvotes**: 8

**Links**: [GitHub](https://github.com/yl4579/DMOSpeech2) | [Project Page](https://dmospeech2.github.io/)
...
## 17. [SegDT: A Diffusion Transformer-Based Segmentation Model for Medical
  Imaging](https://huggingface.co/papers/2507.15595)

**ArXiv ID**: [2507.15595](https://arxiv.org/abs/2507.15595)

**Authors**: Salah Eddine Bekhouche, Gaby Maroun, Fadi Dornaika, Abdenour Hadid

**Published**: 2025-07-21 | **Submitted**: 2025-07-25 by Salah Eddine Bekhouche

**Upvotes**: 6

**Links**: [GitHub](https://github.com/Bekhouche/SegDT)
...
## 18. [Iwin Transformer: Hierarchical Vision Transformer using Interleaved
  Windows](https://huggingface.co/papers/2507.18405)

**ArXiv ID**: [2507.18405](https://arxiv.org/abs/2507.18405)

**Authors**: Simin Huo, Ning Li

**Published**: 2025-07-24 | **Submitted**: 2025-07-25 by sameen

**Upvotes**: 5

**Links**: [GitHub](https://github.com/cominder/Iwin-Transformer)
...
## 19. [HLFormer: Enhancing Partially Relevant Video Retrieval with Hyperbolic
  Learning](https://huggingface.co/papers/2507.17402)

**ArXiv ID**: [2507.17402](https://arxiv.org/abs/2507.17402)

**Authors**: Li Jun, Wang Jinpeng, Tan Chaolei, Lian Niu, Chen Long, Zhang Min, Wang Yaowei, Xia Shu-Tao, Chen Bin

**Published**: 2025-07-23 | **Submitted**: 2025-07-25 by Jun Li

**Upvotes**: 5

**Links**: [GitHub](https://github.com/lijun2005/ICCV25-HLFormer) | [Project Page](https://github.com/lijun2005/ICCV25-HLFormer)
...
## 20. [Deep Learning-Based Age Estimation and Gender Deep Learning-Based Age
  Estimation and Gender Classification for Targeted Advertisement](https://huggingface.co/papers/2507.18565)

**ArXiv ID**: [2507.18565](https://arxiv.org/abs/2507.18565)

**Authors**: Muhammad Imran Zaman, Nisar Ahmed

**Published**: 2025-07-24 | **Submitted**: 2025-07-25 by Muhammad Imran Zaman
...
## 21. [True Multimodal In-Context Learning Needs Attention to the Visual
  Context](https://huggingface.co/papers/2507.15807)

**ArXiv ID**: [2507.15807](https://arxiv.org/abs/2507.15807)

**Authors**: Shuo Chen, Jianzhe Liu, Zhen Han, Yan Xia, Daniel Cremers, Philip Torr, Volker Tresp, Jindong Gu

**Published**: 2025-07-21 | **Submitted**: 2025-07-25 by Shuo Chen

**Upvotes**: 2

**Links**: [GitHub](https://github.com/chenxshuo/true-micl) | [Project Page](https://chenxshuo.github.io/true-micl-colm)
