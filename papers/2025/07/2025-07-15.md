# Daily Papers - 2025-07-15

> source: [Hugging Face Daily Papers](https://huggingface.co/papers/date/2025-07-15)

Total papers: 15

---

## 1. [Reasoning or Memorization? Unreliable Results of Reinforcement Learning
  Due to Data Contamination](https://huggingface.co/papers/2507.10532)

**ArXiv ID**: [2507.10532](https://arxiv.org/abs/2507.10532)
...
**Published**: 2025-07-14 | **Submitted**: 2025-07-15 by Songyang Zhang

**Upvotes**: 90

**Links**: [GitHub](https://github.com/wumingqi/LLM-Math-Evaluation)
...
## 2. [Mixture-of-Recursions: Learning Dynamic Recursive Depths for Adaptive
  Token-Level Computation](https://huggingface.co/papers/2507.10524)
...
**Published**: 2025-07-14 | **Submitted**: 2025-07-15 by Sangmin Bae

**Upvotes**: 72

**Links**: [GitHub](https://github.com/raymin0223/mixture_of_recursions)
...
## 3. [SpeakerVid-5M: A Large-Scale High-Quality Dataset for Audio-Visual
  Dyadic Interactive Human Generation](https://huggingface.co/papers/2507.09862)

**ArXiv ID**: [2507.09862](https://arxiv.org/abs/2507.09862)

**Authors**: Youliang Zhang, Zhaoyang Li, Duomin Wang, Jiahe Zhang, Deyu Zhou, Zixin Yin, Xili Dai, Gang Yu, Xiu Li

**Published**: 2025-07-14 | **Submitted**: 2025-07-15 by wang

**Upvotes**: 51

**Links**: [GitHub](https://github.com/Dorniwang/SpeakerVid-5M-Code) | [Project Page](https://dorniwang.github.io/SpeakerVid-5M/)
...
## 4. [EmbRACE-3K: Embodied Reasoning and Action in Complex Environments](https://huggingface.co/papers/2507.10548)
...
**Published**: 2025-07-14 | **Submitted**: 2025-07-15 by Wei Huang

**Upvotes**: 37

**Links**: [Project Page](https://mxllc.github.io/EmbRACE-3K/)
...
## 5. [REST: Stress Testing Large Reasoning Models by Asking Multiple Problems
  at Once](https://huggingface.co/papers/2507.10541)

**ArXiv ID**: [2507.10541](https://arxiv.org/abs/2507.10541)

**Authors**: Zhuoshi Pan, Qizhi Pei, Yu Li, Qiyao Sun, Zinan Tang, H. Vicky Zhao, Conghui He, Lijun Wu

**Published**: 2025-07-14 | **Submitted**: 2025-07-15 by Zinan Tang

**Upvotes**: 30

**Links**: [GitHub](https://github.com/opendatalab/REST) | [Project Page](https://opendatalab.github.io/REST/)
...
## 6. [MoVieS: Motion-Aware 4D Dynamic View Synthesis in One Second](https://huggingface.co/papers/2507.10065)

**ArXiv ID**: [2507.10065](https://arxiv.org/abs/2507.10065)

**Authors**: Chenguo Lin, Yuchen Lin, Panwang Pan, Yifan Yu, Honglei Yan, Katerina Fragkiadaki, Yadong Mu

**Published**: 2025-07-14 | **Submitted**: 2025-07-15 by Chenguo Lin

**Upvotes**: 25

**Links**: [GitHub](https://github.com/chenguolin/MoVieS) | [Project Page](https://chenguolin.github.io/projects/MoVieS)
...
## 7. [LayerCake: Token-Aware Contrastive Decoding within Large Language Model
  Layers](https://huggingface.co/papers/2507.04404)

**ArXiv ID**: [2507.04404](https://arxiv.org/abs/2507.04404)
...
**Published**: 2025-07-06 | **Submitted**: 2025-07-15 by Yongliang Wu

**Upvotes**: 22

**Links**: [GitHub](https://github.com/Styxiian/LayerCake)
...
## 8. [CompassJudger-2: Towards Generalist Judge Model via Verifiable Rewards](https://huggingface.co/papers/2507.09104)

**ArXiv ID**: [2507.09104](https://arxiv.org/abs/2507.09104)

**Authors**: Taolin Zhang, Maosong Cao, Alexander Lam, Songyang Zhang, Kai Chen

**Published**: 2025-07-12 | **Submitted**: 2025-07-15 by Songyang Zhang
...
## 9. [From KMMLU-Redux to KMMLU-Pro: A Professional Korean Benchmark Suite for
  LLM Evaluation](https://huggingface.co/papers/2507.08924)

**ArXiv ID**: [2507.08924](https://arxiv.org/abs/2507.08924)

**Authors**: Seokhee Hong, Sunkyoung Kim, Guijin Son, Soyeon Kim, Yeonjung Hong, Jinsik Lee

**Published**: 2025-07-11 | **Submitted**: 2025-07-15 by GUIJIN SON
...
## 10. [Subject-Consistent and Pose-Diverse Text-to-Image Generation](https://huggingface.co/papers/2507.08396)

**ArXiv ID**: [2507.08396](https://arxiv.org/abs/2507.08396)

**Authors**: Zhanxin Gao, Beier Zhu, Liang Yao, Jian Yang, Ying Tai

**Published**: 2025-07-11 | **Submitted**: 2025-07-15 by Ying Tai

**Upvotes**: 16

**Links**: [GitHub](https://github.com/NJU-PCALab/CoDi) | [Project Page](https://zhanxin-gao.github.io/CoDi/)
...
## 11. [DreamPoster: A Unified Framework for Image-Conditioned Generative Poster
  Design](https://huggingface.co/papers/2507.04218)

**ArXiv ID**: [2507.04218](https://arxiv.org/abs/2507.04218)

**Authors**: Xiwei Hu, Haokun Chen, Zhongqi Qi, Hui Zhang, Dexiang Hong, Jie Shao, Xinglong Wu

**Published**: 2025-07-06 | **Submitted**: 2025-07-15 by Melodie Hu

**Upvotes**: 13

**Links**: [Project Page](https://dreamposter.github.io/)
...
## 12. [A Practical Two-Stage Recipe for Mathematical LLMs: Maximizing Accuracy
  with SFT and Efficiency with Reinforcement Learning](https://huggingface.co/papers/2507.08267)

**ArXiv ID**: [2507.08267](https://arxiv.org/abs/2507.08267)

**Authors**: Hiroshi Yoshihara, Taiki Yamaguchi, Yuichi Inoue

**Published**: 2025-07-11 | **Submitted**: 2025-07-15 by Inoue Yuichi

**Upvotes**: 11

**Links**: [GitHub](https://github.com/analokmaus/kaggle-aimo2-fast-math-r1)
...
## 13. [Favicon Trojans: Executable Steganography Via Ico Alpha Channel
  Exploitation](https://huggingface.co/papers/2507.09074)

**ArXiv ID**: [2507.09074](https://arxiv.org/abs/2507.09074)

**Authors**: David Noever, Forrest McKee

**Published**: 2025-07-11 | **Submitted**: 2025-07-15 by David Noever
...
## 14. [Sound and Complete Neuro-symbolic Reasoning with LLM-Grounded
  Interpretations](https://huggingface.co/papers/2507.09751)

**ArXiv ID**: [2507.09751](https://arxiv.org/abs/2507.09751)

**Authors**: Bradley P. Allen, Prateek Chhikara, Thomas Macaulay Ferguson, Filip Ilievski, Paul Groth

**Published**: 2025-07-13 | **Submitted**: 2025-07-15 by Bradley Allen
...
## 15. [Hashed Watermark as a Filter: Defeating Forging and Overwriting Attacks
  in Weight-based Neural Network Watermarking](https://huggingface.co/papers/2507.11137)

**ArXiv ID**: [2507.11137](https://arxiv.org/abs/2507.11137)

**Authors**: Yuan Yao, Jin Song, Jian Jin

**Published**: 2025-07-15 | **Submitted**: 2025-07-15 by Yuan Yao

**Upvotes**: 1

**Links**: [GitHub](https://github.com/AIResearch-Group/NeuralMark)
