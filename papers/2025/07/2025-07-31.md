# Daily Papers - 2025-07-31

> source: [Hugging Face Daily Papers](https://huggingface.co/papers/date/2025-07-31)

Total papers: 12

---

## 1. [ScreenCoder: Advancing Visual-to-Code Generation for Front-End
  Automation via Modular Multimodal Agents](https://huggingface.co/papers/2507.22827)

**ArXiv ID**: [2507.22827](https://arxiv.org/abs/2507.22827)

**Authors**: Yilei Jiang, Yaozhi Zheng, Yuxuan Wan, Jiaming Han, Qunzhong Wang, Michael R. Lyu, Xiangyu Yue

**Published**: 2025-07-30 | **Submitted**: 2025-07-31 by Jiaming Han

**Upvotes**: 100

**Links**: [GitHub](https://github.com/leigest519/ScreenCoder) | [Project Page](https://huggingface.co/spaces/Jimmyzheng-10/ScreenCoder)
...
## 2. [Falcon-H1: A Family of Hybrid-Head Language Models Redefining Efficiency
  and Performance](https://huggingface.co/papers/2507.22448)

**ArXiv ID**: [2507.22448](https://arxiv.org/abs/2507.22448)
...
**Published**: 2025-07-30 | **Submitted**: 2025-07-31 by Jingwei Zuo

**Upvotes**: 70

**Links**: [GitHub](https://github.com/tiiuae/Falcon-H1) | [Project Page](https://tiiuae.github.io/Falcon-H1/)
...
## 3. [BANG: Dividing 3D Assets via Generative Exploded Dynamics](https://huggingface.co/papers/2507.21493)

**ArXiv ID**: [2507.21493](https://arxiv.org/abs/2507.21493)

**Authors**: Longwen Zhang, Qixuan Zhang, Haoran Jiang, Yinuo Bai, Wei Yang, Lan Xu, Jingyi Yu

**Published**: 2025-07-29 | **Submitted**: 2025-07-31 by ZLW

**Upvotes**: 65

**Links**: [Project Page](https://sites.google.com/view/bang7355608)
...
## 4. [VL-Cogito: Progressive Curriculum Reinforcement Learning for Advanced
  Multimodal Reasoning](https://huggingface.co/papers/2507.22607)

**ArXiv ID**: [2507.22607](https://arxiv.org/abs/2507.22607)
...
**Published**: 2025-07-30 | **Submitted**: 2025-07-31 by Hou Pong (Ken) Chan

**Upvotes**: 47

**Links**: [GitHub](https://github.com/alibaba-damo-academy/VL-Cogito)
...
## 5. [MetaCLIP 2: A Worldwide Scaling Recipe](https://huggingface.co/papers/2507.22062)

**ArXiv ID**: [2507.22062](https://arxiv.org/abs/2507.22062)
...
**Published**: 2025-07-29 | **Submitted**: 2025-07-31 by Niels Rogge

**Upvotes**: 37

**Links**: [GitHub](https://github.com/facebookresearch/MetaCLIP)
...
## 6. [Step-3 is Large yet Affordable: Model-system Co-design for
  Cost-effective Decoding](https://huggingface.co/papers/2507.19427)

**ArXiv ID**: [2507.19427](https://arxiv.org/abs/2507.19427)
...
**Published**: 2025-07-25 | **Submitted**: 2025-07-31 by Elie Bakouch

**Upvotes**: 21

**Links**: [GitHub](https://github.com/stepfun-ai/Step3) | [Project Page](https://stepfun.ai/research/en/step3)
...
## 7. [MixGRPO: Unlocking Flow-based GRPO Efficiency with Mixed ODE-SDE](https://huggingface.co/papers/2507.21802)

**ArXiv ID**: [2507.21802](https://arxiv.org/abs/2507.21802)

**Authors**: Junzhe Li, Yutao Cui, Tao Huang, Yinping Ma, Chun Fan, Miles Yang, Zhao Zhong

**Published**: 2025-07-29 | **Submitted**: 2025-07-31 by lijunzhe

**Upvotes**: 19

**Links**: [GitHub](https://github.com/Tencent-Hunyuan/MixGRPO) | [Project Page](https://tulvgengenr.github.io/MixGRPO-Project-Page/)
...
## 8. [Adapting Vehicle Detectors for Aerial Imagery to Unseen Domains with
  Weak Supervision](https://huggingface.co/papers/2507.20976)

**ArXiv ID**: [2507.20976](https://arxiv.org/abs/2507.20976)
...
**Published**: 2025-07-28 | **Submitted**: 2025-07-31 by Xiao Fang

**Upvotes**: 11

**Links**: [GitHub](https://github.com/humansensinglab/AGenDA) | [Project Page](https://humansensinglab.github.io/AGenDA)
...
## 9. [Towards Omnimodal Expressions and Reasoning in Referring Audio-Visual
  Segmentation](https://huggingface.co/papers/2507.22886)

**ArXiv ID**: [2507.22886](https://arxiv.org/abs/2507.22886)

**Authors**: Kaining Ying, Henghui Ding, Guanquan Jie, Yu-Gang Jiang

**Published**: 2025-07-30 | **Submitted**: 2025-07-31 by Henghui Ding

**Upvotes**: 10

**Links**: [GitHub](https://github.com/FudanCVL/OmniAVS) | [Project Page](https://henghuiding.com/OmniAVS/)
...
## 10. [Repair-R1: Better Test Before Repair](https://huggingface.co/papers/2507.22853)

**ArXiv ID**: [2507.22853](https://arxiv.org/abs/2507.22853)

**Authors**: Haichuan Hu, Xiaochen Xie, Quanjun Zhang

**Published**: 2025-07-30 | **Submitted**: 2025-07-31 by tomsawyer

**Upvotes**: 10

**Links**: [GitHub](https://github.com/Tomsawyerhu/APR-RL)
...
## 11. [Efficient Differentially Private Fine-Tuning of LLMs via Reinforcement
  Learning](https://huggingface.co/papers/2507.22565)

**ArXiv ID**: [2507.22565](https://arxiv.org/abs/2507.22565)

**Authors**: Afshin Khadangi, Amir Sartipi, Igor Tchappi, Ramin Bahmani, Gilbert Fridgen

**Published**: 2025-07-30 | **Submitted**: 2025-07-31 by Afshin Khadangi

**Upvotes**: 9

**Links**: [GitHub](https://github.com/akhadangi/RLDP) | [Project Page](https://wandb.ai/afshin-khadangi-university-of-luxembourg/RLDP/reports/Efficient-Differentially-Private-Fine-Tuning-of-LLMs-via-Reinforcement-Learning--VmlldzoxMzc4NTEwMA?accessToken=qhs4n7sh3o93yql2wprb2vylpmer07r2bjvzft7gty5mhhplt3numljxppfd8z66)
...
## 12. [DreamScene: 3D Gaussian-based End-to-end Text-to-3D Scene Generation](https://huggingface.co/papers/2507.13985)

**ArXiv ID**: [2507.13985](https://arxiv.org/abs/2507.13985)

**Authors**: Haoran Li, Yuli Tian, Kun Lan, Yong Liao, Lin Wang, Pan Hui, Peng Yuan Zhou

**Published**: 2025-07-18 | **Submitted**: 2025-07-31 by Haoran Li

**Upvotes**: 7

**Links**: [GitHub](https://github.com/DreamScene-Project/DreamScene) | [Project Page](https://jahnsonblack.github.io/DreamScene-Full/)
