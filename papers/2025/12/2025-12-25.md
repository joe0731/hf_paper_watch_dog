...
> source: [Hugging Face Daily Papers](https://huggingface.co/papers/date/2025-12-25)

Total papers: 17

---

## 1. [TurboDiffusion: Accelerating Video Diffusion Models by 100-200 Times](https://huggingface.co/papers/2512.16093)

**ArXiv ID**: [2512.16093](https://arxiv.org/abs/2512.16093)

**Organization**: University of California, Berkeley

**Authors**: Jintao Zhang, Kaiwen Zheng, Kai Jiang, Haoxu Wang, Ion Stoica, Joseph E. Gonzalez, Jianfei Chen, Jun Zhu

**Published**: 2025-12-18 | **Submitted**: 2025-12-25 by Jintao Zhang

**Upvotes**: 95

**Links**: [GitHub](https://github.com/thu-ml/TurboDiffusion) | [Project Page](https://github.com/thu-ml/TurboDiffusion)
...
## 2. [Learning to Reason in 4D: Dynamic Spatial Understanding for Vision Language Models](https://huggingface.co/papers/2512.20557)

**ArXiv ID**: [2512.20557](https://arxiv.org/abs/2512.20557)

**Organization**: The University of Hong Kong

**Authors**: Shengchao Zhou, Yuxin Chen, Yuying Ge, Wei Huang, Jiehong Lin, Ying Shan, Xiaojuan Qi

**Published**: 2025-12-23 | **Submitted**: 2025-12-25 by Wei Huang

**Upvotes**: 50

**Links**: [GitHub](https://github.com/TencentARC/DSR_Suite)
...
## 3. [NVIDIA Nemotron 3: Efficient and Open Intelligence](https://huggingface.co/papers/2512.20856)

**ArXiv ID**: [2512.20856](https://arxiv.org/abs/2512.20856)
...
**Published**: 2025-12-24 | **Submitted**: 2025-12-25 by taesiri
...
## 4. [Nemotron 3 Nano: Open, Efficient Mixture-of-Experts Hybrid Mamba-Transformer Model for Agentic Reasoning](https://huggingface.co/papers/2512.20848)

**ArXiv ID**: [2512.20848](https://arxiv.org/abs/2512.20848)
...
**Published**: 2025-12-23 | **Submitted**: 2025-12-25 by taesiri

**Upvotes**: 40

**Links**: [GitHub](https://github.com/NVIDIA-NeMo/Nemotron)
...
## 5. [DreaMontage: Arbitrary Frame-Guided One-Shot Video Generation](https://huggingface.co/papers/2512.21252)
...
**Published**: 2025-12-24 | **Submitted**: 2025-12-25 by Jiawei Liu

**Upvotes**: 35

**Links**: [Project Page](https://dreamontage.github.io/DreaMontage/)
...
## 6. [Beyond Memorization: A Multi-Modal Ordinal Regression Benchmark to Expose Popularity Bias in Vision-Language Models](https://huggingface.co/papers/2512.21337)

**ArXiv ID**: [2512.21337](https://arxiv.org/abs/2512.21337)

**Authors**: Li-Zhong Szu-Tu, Ting-Lin Wu, Chia-Jui Chang, He Syu, Yu-Lun Liu

**Published**: 2025-12-24 | **Submitted**: 2025-12-25 by Yu-Lun Liu

**Upvotes**: 31

**Links**: [GitHub](https://github.com/Sytwu/BeyondMemo) | [Project Page](https://sytwu.github.io/BeyondMemo/)
...
## 7. [T2AV-Compass: Towards Unified Evaluation for Text-to-Audio-Video Generation](https://huggingface.co/papers/2512.21094)

**ArXiv ID**: [2512.21094](https://arxiv.org/abs/2512.21094)
...
**Published**: 2025-12-24 | **Submitted**: 2025-12-25 by Jiaheng Liu

**Upvotes**: 25

**Links**: [GitHub](https://github.com/NJU-LINK/T2AV-Compass) | [Project Page](https://nju-link.github.io/T2AV-Compass/)
...
## 8. [HiStream: Efficient High-Resolution Video Generation via Redundancy-Eliminated Streaming](https://huggingface.co/papers/2512.21338)
...
**Published**: 2025-12-24 | **Submitted**: 2025-12-25 by Haonan Qiu

**Upvotes**: 23

**Links**: [Project Page](https://arthur-qiu.github.io/projects/HiStream)
...
## 9. [TokSuite: Measuring the Impact of Tokenizer Choice on Language Model Behavior](https://huggingface.co/papers/2512.20757)

**ArXiv ID**: [2512.20757](https://arxiv.org/abs/2512.20757)

**Organization**: TokSuite

**Authors**: Gül Sena Altıntaş, Malikeh Ehghaghi, Brian Lester, Fengyuan Liu, Wanru Zhao, Marco Ciccone, Colin Raffel

**Published**: 2025-12-23 | **Submitted**: 2025-12-25 by Malikeh Ehghaghi

**Upvotes**: 18

**Links**: [GitHub](https://github.com/r-three/Tokenizers)
...
## 10. [DramaBench: A Six-Dimensional Evaluation Framework for Drama Script Continuation](https://huggingface.co/papers/2512.19012)

**ArXiv ID**: [2512.19012](https://arxiv.org/abs/2512.19012)

**Authors**: Shijian Ma, Yunqi Huang, Yan Lin

**Published**: 2025-12-22 | **Submitted**: 2025-12-25 by MaShijian

**Upvotes**: 17

**Links**: [GitHub](https://github.com/IIIIQIIII/DramaBench) | [Project Page](https://dramabench.pages.dev/)
...
## 11. [From Word to World: Can Large Language Models be Implicit Text-based World Models?](https://huggingface.co/papers/2512.18832)

**ArXiv ID**: [2512.18832](https://arxiv.org/abs/2512.18832)
...
**Published**: 2025-12-21 | **Submitted**: 2025-12-25 by Hongru Wang

**Upvotes**: 15

**Links**: [GitHub](https://github.com/X1AOX1A/Word2World)
...
## 12. [Learning from Next-Frame Prediction: Autoregressive Video Modeling Encodes Effective Representations](https://huggingface.co/papers/2512.21004)

**ArXiv ID**: [2512.21004](https://arxiv.org/abs/2512.21004)

**Organization**: Peking University

**Authors**: Jinghan Li, Yang Jin, Hao Jiang, Yadong Mu, Yang Song, Kun Xu

**Published**: 2025-12-24 | **Submitted**: 2025-12-25 by Zhicheng Sun

**Upvotes**: 13

**Links**: [GitHub](https://github.com/Singularity0104/NExT-Vid)
...
## 13. [SWE-EVO: Benchmarking Coding Agents in Long-Horizon Software Evolution Scenarios](https://huggingface.co/papers/2512.18470)

**ArXiv ID**: [2512.18470](https://arxiv.org/abs/2512.18470)

**Authors**: Minh V. T. Thai, Tue Le, Dung Nguyen Manh, Huy Phan Nhat, Nghi D. Q. Bui

**Published**: 2025-12-20 | **Submitted**: 2025-12-25 by Nghi Bui

**Upvotes**: 12

**Links**: [GitHub](https://github.com/bdqnghi/SWE-EVO)
...
## 14. [Streaming Video Instruction Tuning](https://huggingface.co/papers/2512.21334)

**ArXiv ID**: [2512.21334](https://arxiv.org/abs/2512.21334)
...
**Links**: [GitHub](https://github.com/maifoundations/Streamo)
...
## 15. [Multi-hop Reasoning via Early Knowledge Alignment](https://huggingface.co/papers/2512.20144)

**ArXiv ID**: [2512.20144](https://arxiv.org/abs/2512.20144)

**Authors**: Yuxin Wang, Shicheng Fang, Bo Wang, Qi Luo, Xuanjing Huang, Yining Zheng, Xipeng Qiu

**Published**: 2025-12-23 | **Submitted**: 2025-12-25 by Siyin Wang (SII)

**Upvotes**: 7

**Links**: [GitHub](https://github.com/yxzwang/EarlyKnowledgeAlignment) | [Project Page](https://prashant-knows-it.github.io/eka-rag-demo/)
...
## 16. [LLM Swiss Round: Aggregating Multi-Benchmark Performance via Competitive Swiss-System Dynamics](https://huggingface.co/papers/2512.21010)

**ArXiv ID**: [2512.21010](https://arxiv.org/abs/2512.21010)
...
## 17. [PhononBench:A Large-Scale Phonon-Based Benchmark for Dynamical Stability in Crystal Generation](https://huggingface.co/papers/2512.21227)

**ArXiv ID**: [2512.21227](https://arxiv.org/abs/2512.21227)

**Organization**: Renmin University of China

**Authors**: Xiao-Qi Han, Ze-Feng Gao, Peng-Jie Guo, Zhong-Yi Lu

**Published**: 2025-12-24 | **Submitted**: 2025-12-25 by xiao-qi han

**Upvotes**: 2

**Links**: [GitHub](https://github.com/xqh19970407/PhononBench)
