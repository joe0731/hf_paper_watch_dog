# Daily Papers - 2025-12-31

> source: [Hugging Face Daily Papers](https://huggingface.co/papers/date/2025-12-31)
...
**ArXiv ID**: [2512.21185](https://arxiv.org/abs/2512.21185)
...
**Published**: 2025-12-24 | **Submitted**: 2025-12-31 by Dongyu Yan

**Upvotes**: 31

**Links**: [GitHub](https://github.com/PKU-YuanGroup/UltraShape-1.0) | [Project Page](https://pku-yuangroup.github.io/UltraShape-1.0/)
...
## 2. [Evaluating Parameter Efficient Methods for RLVR](https://huggingface.co/papers/2512.23165)

**ArXiv ID**: [2512.23165](https://arxiv.org/abs/2512.23165)

**Organization**: Zhejiang University

**Authors**: Qingyu Yin, Yulun Wu, Zhennan Shen, Sunbowen Li, Zhilin Wang, Yanshu Li, Chak Tou Leong, Jiale Kang, Jinjin Gu

**Published**: 2025-12-29 | **Submitted**: 2025-12-31 by Qingyu_Yin

**Upvotes**: 28

**Links**: [GitHub](https://github.com/MikaStars39/PeRL)
...
**Published**: 2025-12-29 | **Submitted**: 2025-12-31 by taesiri

**Upvotes**: 24

**Links**: [GitHub](https://github.com/test-time-training/e2e)
...
## 4. [DreamOmni3: Scribble-based Editing and Generation](https://huggingface.co/papers/2512.22525)

**ArXiv ID**: [2512.22525](https://arxiv.org/abs/2512.22525)
...
**Published**: 2025-12-27 | **Submitted**: 2025-12-31 by binxia

**Upvotes**: 15

**Links**: [GitHub](https://github.com/dvlab-research/DreamOmni3)
...
**ArXiv ID**: [2512.22469](https://arxiv.org/abs/2512.22469)

**Authors**: Wei Liu, Chao Peng, Pengfei Gao, Aofan Liu, Wei Zhang, Haiyan Zhao, Zhi Jin

**Published**: 2025-12-27 | **Submitted**: 2025-12-31 by Chao Peng
...
## 6. [GateBreaker: Gate-Guided Attacks on Mixture-of-Expert LLMs](https://huggingface.co/papers/2512.21008)

**ArXiv ID**: [2512.21008](https://arxiv.org/abs/2512.21008)
...
**Published**: 2025-12-24 | **Submitted**: 2025-12-31 by Lichao Wu
...
## 7. [CosineGate: Semantic Dynamic Routing via Cosine Incompatibility in Residual Networks](https://huggingface.co/papers/2512.22206)

**ArXiv ID**: [2512.22206](https://arxiv.org/abs/2512.22206)

**Authors**: Yogeswar Reddy Thota

**Published**: 2025-12-21 | **Submitted**: 2025-12-31 by Yogeswar Reddy Thota

**Upvotes**: 2

**Links**: [GitHub](https://github.com/thotayogeswarreddy/CosineGate)
