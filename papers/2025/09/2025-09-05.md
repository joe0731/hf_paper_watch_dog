...
> source: [Hugging Face Daily Papers](https://huggingface.co/papers/date/2025-09-05)

Total papers: 14

---

## 1. [Drivel-ology: Challenging LLMs with Interpreting Nonsense with Depth](https://huggingface.co/papers/2509.03867)

**ArXiv ID**: [2509.03867](https://arxiv.org/abs/2509.03867)

**Authors**: Yang Wang, Chia-Yi Hsiao, Zi Yan Chang, Chi-Li Chen, Tyler Loakman, Chenghua Lin

**Published**: 2025-09-04 | **Submitted**: 2025-09-05 by Yang Wang

**Upvotes**: 211

**Links**: [GitHub](https://github.com/ExtraOrdinaryLab/drivelology) | [Project Page](https://huggingface.co/datasets/extraordinarylab/drivel-hub)
...
## 2. [From Editor to Dense Geometry Estimator](https://huggingface.co/papers/2509.04338)

**ArXiv ID**: [2509.04338](https://arxiv.org/abs/2509.04338)

**Authors**: JiYuan Wang, Chunyu Lin, Lei Sun, Rongying Liu, Lang Nie, Mingxing Li, Kang Liao, Xiangxiang Chu, Yao Zhao

**Published**: 2025-09-04 | **Submitted**: 2025-09-05 by xiaochonglinghu

**Upvotes**: 96

**Links**: [GitHub](https://github.com/AMAP-ML/FE2E) | [Project Page](https://amap-ml.github.io/FE2E/)
...
## 3. [Towards a Unified View of Large Language Model Post-Training](https://huggingface.co/papers/2509.04419)

**ArXiv ID**: [2509.04419](https://arxiv.org/abs/2509.04419)

**Authors**: Xingtai Lv, Youbang Sun, Hongyi Liu, Yuntian Wei, Zhekai Chen, Lixuan He, Xuekai Zhu, Kaiyan Zhang, Bingning Wang, Ning Ding, Bowen Zhou

**Published**: 2025-09-04 | **Submitted**: 2025-09-05 by Xingtai Lv

**Upvotes**: 76

**Links**: [GitHub](https://github.com/TsinghuaC3I/Unify-Post-Training)
...
## 4. [Inverse IFEval: Can LLMs Unlearn Stubborn Training Conventions to Follow
  Real Instructions?](https://huggingface.co/papers/2509.04292)

**ArXiv ID**: [2509.04292](https://arxiv.org/abs/2509.04292)
...
**Published**: 2025-09-04 | **Submitted**: 2025-09-05 by taesiri

**Upvotes**: 58

**Links**: [Project Page](https://huggingface.co/datasets/m-a-p/Inverse_IFEval)
...
## 5. [DeepResearch Arena: The First Exam of LLMs' Research Abilities via
  Seminar-Grounded Tasks](https://huggingface.co/papers/2509.01396)

**ArXiv ID**: [2509.01396](https://arxiv.org/abs/2509.01396)
...
**Published**: 2025-09-01 | **Submitted**: 2025-09-05 by 
...
## 6. [Transition Models: Rethinking the Generative Learning Objective](https://huggingface.co/papers/2509.04394)

**ArXiv ID**: [2509.04394](https://arxiv.org/abs/2509.04394)

**Authors**: Zidong Wang, Yiyuan Zhang, Xiaoyu Yue, Xiangyu Yue, Yangguang Li, Wanli Ouyang, Lei Bai

**Published**: 2025-09-04 | **Submitted**: 2025-09-05 by Yiyuan Zhang

**Upvotes**: 29

**Links**: [GitHub](https://github.com/WZDTHU/TiM)
...
## 7. [NER Retriever: Zero-Shot Named Entity Retrieval with Type-Aware
  Embeddings](https://huggingface.co/papers/2509.04011)

**ArXiv ID**: [2509.04011](https://arxiv.org/abs/2509.04011)

**Authors**: Or Shachar, Uri Katz, Yoav Goldberg, Oren Glickman

**Published**: 2025-09-04 | **Submitted**: 2025-09-05 by Uri Katz

**Upvotes**: 29

**Links**: [GitHub](https://github.com/ShacharOr100/ner_retriever)
...
## 8. [Loong: Synthesize Long Chain-of-Thoughts at Scale through Verifiers](https://huggingface.co/papers/2509.03059)

**ArXiv ID**: [2509.03059](https://arxiv.org/abs/2509.03059)
...
**Published**: 2025-09-03 | **Submitted**: 2025-09-05 by Xingyue Huang

**Upvotes**: 25

**Links**: [GitHub](https://github.com/camel-ai/loong) | [Project Page](https://github.com/camel-ai/loong)
...
## 9. [Video-MTR: Reinforced Multi-Turn Reasoning for Long Video Understanding](https://huggingface.co/papers/2508.20478)

**ArXiv ID**: [2508.20478](https://arxiv.org/abs/2508.20478)

**Authors**: Yuan Xie, Tianshui Chen, Zheng Ge, Lionel Ni

**Published**: 2025-08-28 | **Submitted**: 2025-09-05 by Tianshui Chen
...
## 10. [Few-step Flow for 3D Generation via Marginal-Data Transport Distillation](https://huggingface.co/papers/2509.04406)

**ArXiv ID**: [2509.04406](https://arxiv.org/abs/2509.04406)

**Authors**: Zanwei Zhou, Taoran Yi, Jiemin Fang, Chen Yang, Lingxi Xie, Xinggang Wang, Wei Shen, Qi Tian

**Published**: 2025-09-04 | **Submitted**: 2025-09-05 by taoranyi

**Upvotes**: 12

**Links**: [GitHub](https://github.com/Zanue/MDT-dist) | [Project Page](https://zanue.github.io/mdt-dist)
...
## 11. [Durian: Dual Reference-guided Portrait Animation with Attribute Transfer](https://huggingface.co/papers/2509.04434)

**ArXiv ID**: [2509.04434](https://arxiv.org/abs/2509.04434)

**Authors**: Hyunsoo Cha, Byungjun Kim, Hanbyul Joo

**Published**: 2025-09-04 | **Submitted**: 2025-09-05 by Hyunsoo Cha

**Upvotes**: 11

**Links**: [GitHub](https://github.com/snuvclab/durian) | [Project Page](https://hyunsoocha.github.io/durian/)
...
## 12. [Drawing2CAD: Sequence-to-Sequence Learning for CAD Generation from
  Vector Drawings](https://huggingface.co/papers/2508.18733)

**ArXiv ID**: [2508.18733](https://arxiv.org/abs/2508.18733)

**Authors**: Feiwei Qin, Shichao Lu, Junhao Hou, Changmiao Wang, Meie Fang, Ligang Liu

**Published**: 2025-08-26 | **Submitted**: 2025-09-05 by Junhao Hou

**Upvotes**: 10

**Links**: [GitHub](https://github.com/lllssc/Drawing2CAD)
...
## 13. [Delta Activations: A Representation for Finetuned Large Language Models](https://huggingface.co/papers/2509.04442)

**ArXiv ID**: [2509.04442](https://arxiv.org/abs/2509.04442)

**Authors**: Zhiqiu Xu, Amish Sethi, Mayur Naik, Ser-Nam Lim

**Published**: 2025-09-04 | **Submitted**: 2025-09-05 by Oscar Xu

**Upvotes**: 7

**Links**: [GitHub](https://github.com/OscarXZQ/delta_activations) | [Project Page](https://oscarxzq.github.io/delta_activation/)
...
## 14. [False Sense of Security: Why Probing-based Malicious Input Detection
  Fails to Generalize](https://huggingface.co/papers/2509.03888)

**ArXiv ID**: [2509.03888](https://arxiv.org/abs/2509.03888)

**Authors**: Cheng Wang, Zeming Wei, Qin Liu, Muhao Chen

**Published**: 2025-09-04 | **Submitted**: 2025-09-05 by Zeming Wei

**Upvotes**: 4

**Links**: [GitHub](https://github.com/WangCheng0116/Why-Probe-Fails)
