# Daily Papers - 2026-03-05

> source: [Hugging Face Daily Papers](https://huggingface.co/papers/date/2026-03-05)

Total papers: 21

---

## 1. [Heterogeneous Agent Collaborative Reinforcement Learning](https://huggingface.co/papers/2603.02604)

**ArXiv ID**: [2603.02604](https://arxiv.org/abs/2603.02604)
...
**Published**: 2026-03-03 | **Submitted**: 2026-03-05 by hzx

**Upvotes**: 179

**Links**: [Project Page](https://zzx-peter.github.io/hacrl/)
...
## 2. [Helios: Real Real-Time Long Video Generation Model](https://huggingface.co/papers/2603.04379)
...
**Published**: 2026-03-04 | **Submitted**: 2026-03-05 by taesiri

**Upvotes**: 163

**Links**: [GitHub](https://github.com/PKU-YuanGroup/Helios) | [Project Page](https://pku-yuangroup.github.io/Helios-Page/)
...
**ArXiv ID**: [2603.03790](https://arxiv.org/abs/2603.03790)
...
**Published**: 2026-03-04 | **Submitted**: 2026-03-05 by Wang

**Upvotes**: 114

**Links**: [Project Page](https://t2s-bench.github.io/T2S-Bench-Page/)
...
**ArXiv ID**: [2603.03447](https://arxiv.org/abs/2603.03447)

**Organization**: Microsoft Research

**Authors**: Weicai Yan, Yuhong Dai, Qi Ran, Haodong Li, Wang Lin, Hao Liao, Xing Xie, Tao Jin, Jianxun Lian

**Published**: 2026-03-03 | **Submitted**: 2026-03-05 by taesiri

**Upvotes**: 32

**Links**: [GitHub](https://github.com/microsoft/AnthropomorphicIntelligence)
...
**ArXiv ID**: [2603.03379](https://arxiv.org/abs/2603.03379)

**Authors**: Jiejun Tan, Zhicheng Dou, Liancheng Zhang, Yuyang Hu, Yiruo Cheng, Ji-Rong Wen

**Published**: 2026-03-03 | **Submitted**: 2026-03-05 by Jiejun Tan

**Upvotes**: 28

**Links**: [GitHub](https://github.com/plageon/MemSifter)
...
**Published**: 2026-03-04 | **Submitted**: 2026-03-05 by tianqi liu

**Upvotes**: 21

**Links**: [GitHub](https://github.com/Inso-13/ArtHOI) | [Project Page](https://arthoi.github.io/)
...
## 7. [Memex(RL): Scaling Long-Horizon LLM Agents via Indexed Experience Memory](https://huggingface.co/papers/2603.04257)

**ArXiv ID**: [2603.04257](https://arxiv.org/abs/2603.04257)

**Authors**: Zhenting Wang, Huancheng Chen, Jiayun Wang, Wei Wei

**Published**: 2026-03-04 | **Submitted**: 2026-03-05 by Zhenting Wang
...
## 8. [Phi-4-reasoning-vision-15B Technical Report](https://huggingface.co/papers/2603.03975)
...
**Links**: [GitHub](https://github.com/microsoft/Phi-4-reasoning-vision-15B) | [Project Page](https://www.microsoft.com/en-us/research/blog/phi-4-reasoning-vision-and-the-lessons-of-training-a-multimodal-reasoning-model/)
...
## 9. [V_1: Unifying Generation and Self-Verification for Parallel Reasoners](https://huggingface.co/papers/2603.04304)

**ArXiv ID**: [2603.04304](https://arxiv.org/abs/2603.04304)
...
**Published**: 2026-03-04 | **Submitted**: 2026-03-05 by Harman Singh

**Upvotes**: 14

**Links**: [GitHub](https://github.com/HarmanDotpy/pairwise-self-verification) | [Project Page](https://harmandotpy.github.io/v1-verification/)
...
## 10. [CubeComposer: Spatio-Temporal Autoregressive 4K 360° Video Generation from Perspective Video](https://huggingface.co/papers/2603.04291)
...
**Published**: 2026-03-04 | **Submitted**: 2026-03-05 by Lingen Li

**Upvotes**: 13

**Links**: [GitHub](https://github.com/TencentARC/CubeComposer) | [Project Page](https://lg-li.github.io/project/cubecomposer)
...
## 11. [Specificity-aware reinforcement learning for fine-grained open-world classification](https://huggingface.co/papers/2603.03197)

**ArXiv ID**: [2603.03197](https://arxiv.org/abs/2603.03197)
...
**Published**: 2026-03-03 | **Submitted**: 2026-03-05 by Samuele Angheben

**Upvotes**: 13

**Links**: [GitHub](https://github.com/s-angheben/SpeciaRL)
...
## 12. [AgilePruner: An Empirical Study of Attention and Diversity for Adaptive Visual Token Pruning in Large Vision-Language Models](https://huggingface.co/papers/2603.01236)

**ArXiv ID**: [2603.01236](https://arxiv.org/abs/2603.01236)

**Authors**: Changwoo Baek, Jouwon Song, Sohyeon Kim, Kyeongbo Kong

**Published**: 2026-03-01 | **Submitted**: 2026-03-05 by baekchangwoo

**Upvotes**: 11

**Links**: [GitHub](https://github.com/cvsp-lab/AgilePruner) | [Project Page](https://paper.pnu-cvsp.com/AgilePruner/)
...
## 13. [InfinityStory: Unlimited Video Generation with World Consistency and Character-Aware Shot Transitions](https://huggingface.co/papers/2603.03646)
...
**Published**: 2026-03-04 | **Submitted**: 2026-03-05 by Franck Dernoncourt
...
## 14. [RIVER: A Real-Time Interaction Benchmark for Video LLMs](https://huggingface.co/papers/2603.03985)
...
**Published**: 2026-03-04 | **Submitted**: 2026-03-05 by Yansong Shi

**Upvotes**: 5

**Links**: [GitHub](https://github.com/OpenGVLab/RIVER)
...
## 15. [SWE-CI: Evaluating Agent Capabilities in Maintaining Codebases via Continuous Integration](https://huggingface.co/papers/2603.03823)

**ArXiv ID**: [2603.03823](https://arxiv.org/abs/2603.03823)
...
## 16. [MIBURI: Towards Expressive Interactive Gesture Synthesis](https://huggingface.co/papers/2603.03282)

**ArXiv ID**: [2603.03282](https://arxiv.org/abs/2603.03282)

**Authors**: M. Hamza Mughal, Rishabh Dabral, Vera Demberg, Christian Theobalt

**Published**: 2026-03-03 | **Submitted**: 2026-03-05 by M. Hamza Mughal

**Upvotes**: 4

**Links**: [GitHub](https://github.com/m-hamza-mughal/miburi) | [Project Page](https://vcai.mpi-inf.mpg.de/projects/MIBURI/)
...
## 17. [MUSE: A Run-Centric Platform for Multimodal Unified Safety Evaluation of Large Language Models](https://huggingface.co/papers/2603.02482)

**ArXiv ID**: [2603.02482](https://arxiv.org/abs/2603.02482)

**Authors**: Zhongxi Wang, Yueqian Lin, Jingyang Zhang, Hai Helen Li, Yiran Chen

**Published**: 2026-03-03 | **Submitted**: 2026-03-05 by Yueqian Lin
...
## 18. [EmbodiedSplat: Online Feed-Forward Semantic 3DGS for Open-Vocabulary 3D Scene Understanding](https://huggingface.co/papers/2603.04254)

**ArXiv ID**: [2603.04254](https://arxiv.org/abs/2603.04254)

**Authors**: Seungjun Lee, Zihan Wang, Yunsong Wang, Gim Hee Lee

**Published**: 2026-03-04 | **Submitted**: 2026-03-05 by Seungjun Lee

**Upvotes**: 1

**Links**: [GitHub](https://github.com/0nandon/EmbodiedSplat) | [Project Page](https://0nandon.github.io/EmbodiedSplat/)
...
## 19. [BeamPERL: Parameter-Efficient RL with Verifiable Rewards Specializes Compact LLMs for Structured Beam Mechanics Reasoning](https://huggingface.co/papers/2603.04124)

**ArXiv ID**: [2603.04124](https://arxiv.org/abs/2603.04124)

**Organization**: LAMM: MIT Laboratory for Atomistic and Molecular Mechanics

**Authors**: Tarjei Paule Hage, Markus J. Buehler

**Published**: 2026-03-04 | **Submitted**: 2026-03-05 by Markus Buehler

**Upvotes**: 1

**Links**: [GitHub](https://github.com/lamm-mit/BeamPERL) | [Project Page](https://huggingface.co/collections/lamm-mit/beamperl)
...
## 20. [HDINO: A Concise and Efficient Open-Vocabulary Detector](https://huggingface.co/papers/2603.02924)

**ArXiv ID**: [2603.02924](https://arxiv.org/abs/2603.02924)

**Authors**: Hao Zhang, Yiqun Wang, Qinran Lin, Runze Fan, Yong Li

**Published**: 2026-03-03 | **Submitted**: 2026-03-05 by haozhang

**Upvotes**: 1

**Links**: [GitHub](https://github.com/HaoZ416/HDINO)
...
## 21. [GroupEnsemble: Efficient Uncertainty Estimation for DETR-based Object Detection](https://huggingface.co/papers/2603.01847)

**ArXiv ID**: [2603.01847](https://arxiv.org/abs/2603.01847)
...
**Published**: 2026-03-02 | **Submitted**: 2026-03-05 by Yutong Yang
