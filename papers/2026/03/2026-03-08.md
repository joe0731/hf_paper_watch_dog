# Daily Papers - 2026-03-08

> source: [Hugging Face Daily Papers](https://huggingface.co/papers/date/2026-03-08)

Total papers: 6

---

## 1. [Reasoning Models Struggle to Control their Chains of Thought](https://huggingface.co/papers/2603.05706)
...
## 2. [RoboMME: Benchmarking and Understanding Memory for Robotic Generalist Policies](https://huggingface.co/papers/2603.04639)
...
## 3. [Dynamic Chunking Diffusion Transformer](https://huggingface.co/papers/2603.06351)
...
## 4. [Physical Simulator In-the-Loop Video Generation](https://huggingface.co/papers/2603.06408)
...
## 5. [FlashPrefill: Instantaneous Pattern Discovery and Thresholding for Ultra-Fast Long-Context Prefilling](https://huggingface.co/papers/2603.06199)
...
## 6. [PixARMesh: Autoregressive Mesh-Native Single-View Scene Reconstruction](https://huggingface.co/papers/2603.05888)
