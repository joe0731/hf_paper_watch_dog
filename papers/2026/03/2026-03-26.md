...
> source: [Hugging Face Daily Papers](https://huggingface.co/papers/date/2026-03-26)

Total papers: 16

---

## 1. [EVA: Efficient Reinforcement Learning for End-to-End Video Agent](https://huggingface.co/papers/2603.22918)

**ArXiv ID**: [2603.22918](https://arxiv.org/abs/2603.22918)

**Authors**: Yaolun Zhang, Ruohui Wang, Jiahao Wang, Yepeng Tang, Xuanyu Zheng, Haonan Duan, Hao Lu, Hanming Deng, Lewei Lu

**Published**: 2026-03-24 | **Submitted**: 2026-03-26 by Yaolun Zhang

**Upvotes**: 26

**Links**: [GitHub](https://github.com/wangruohui/EfficientVideoAgent) | [Project Page](https://huggingface.co/WRHC/EfficientVideoAgent/)
...
## 2. [T-MAP: Red-Teaming LLM Agents with Trajectory-aware Evolutionary Search](https://huggingface.co/papers/2603.22341)

**ArXiv ID**: [2603.22341](https://arxiv.org/abs/2603.22341)

**Organization**: KAIST AI

**Authors**: Hyomin Lee, Sangwoo Park, Yumin Choi, Sohyun An, Seanie Lee, Sung Ju Hwang

**Published**: 2026-03-21 | **Submitted**: 2026-03-26 by Seanie Lee

**Upvotes**: 23

**Links**: [GitHub](https://github.com/pwnhyo/T-MAP)
...
## 3. [Why Does Self-Distillation (Sometimes) Degrade the Reasoning Capability of LLMs?](https://huggingface.co/papers/2603.24472)

**ArXiv ID**: [2603.24472](https://arxiv.org/abs/2603.24472)

**Organization**: Microsoft Research

**Authors**: Jeonghye Kim, Xufang Luo, Minbeom Kim, Sangmook Lee, Dohyung Kim, Jiwon Jeon, Dongsheng Li, Yuqing Yang

**Published**: 2026-03-25 | **Submitted**: 2026-03-26 by JeonghyeKim

**Upvotes**: 17

**Links**: [GitHub](https://github.com/beanie00/self-distillation-analysis) | [Project Page](https://beanie00.notion.site/why-does-self-distillation-degrade-reasoning)
...
**Published**: 2026-03-25 | **Submitted**: 2026-03-26 by taesiri
...
## 5. [GameplayQA: A Benchmarking Framework for Decision-Dense POV-Synced Multi-Video Understanding of 3D Virtual Agents](https://huggingface.co/papers/2603.24329)

**ArXiv ID**: [2603.24329](https://arxiv.org/abs/2603.24329)
...
**Links**: [Project Page](https://hats-ict.github.io/gameplayqa/)
...
## 6. [When Models Judge Themselves: Unsupervised Self-Evolution for Multimodal Reasoning](https://huggingface.co/papers/2603.21289)

**ArXiv ID**: [2603.21289](https://arxiv.org/abs/2603.21289)
...
**Published**: 2026-03-22 | **Submitted**: 2026-03-26 by Wu Zhengxian

**Upvotes**: 10

**Links**: [GitHub](https://github.com/OPPO-Mente-Lab/LLM-Self-Judge) | [Project Page](https://dingwu1021.github.io/SelfJudge/)
...
## 7. [4DGS360: 360° Gaussian Reconstruction of Dynamic Objects from a Single Video](https://huggingface.co/papers/2603.21618)

**ArXiv ID**: [2603.21618](https://arxiv.org/abs/2603.21618)

**Organization**: Seoul National University

**Authors**: Jae Won Jang, Yeonjin Chang, Wonsik Shin, Juhwan Cho, Nojun Kwak

**Published**: 2026-03-23 | **Submitted**: 2026-03-26 by jang

**Upvotes**: 8

**Links**: [Project Page](https://jaewon040.github.io/4dgs360/)
...
## 8. [CarePilot: A Multi-Agent Framework for Long-Horizon Computer Task Automation in Healthcare](https://huggingface.co/papers/2603.24157)

**ArXiv ID**: [2603.24157](https://arxiv.org/abs/2603.24157)
...
**Published**: 2026-03-25 | **Submitted**: 2026-03-26 by Akash Ghosh

**Upvotes**: 5

**Links**: [GitHub](https://github.com/AkashGhosh/CarePilot) | [Project Page](https://akashghosh.github.io/Care-Pilot/)
...
## 9. [Toward Physically Consistent Driving Video World Models under Challenging Trajectories](https://huggingface.co/papers/2603.24506)
...
## 10. [OmniWeaving: Towards Unified Video Generation with Free-form Composition and Reasoning](https://huggingface.co/papers/2603.24458)
...
**Links**: [Project Page](https://omniweaving.github.io/)
...
## 11. [CUA-Suite: Massive Human-annotated Video Demonstrations for Computer-Use Agents](https://huggingface.co/papers/2603.24440)
...
## 12. [Can LLM Agents Be CFOs? A Benchmark for Resource Allocation in Dynamic Enterprise Environments](https://huggingface.co/papers/2603.23638)
...
**Published**: 2026-03-24 | **Submitted**: 2026-03-26 by Yan Wang
...
## 13. [StreamingClaw Technical Report](https://huggingface.co/papers/2603.22120)
...
**Published**: 2026-03-23 | **Submitted**: 2026-03-26 by Yu

**Upvotes**: 2

**Links**: [Project Page](https://jackyu6.github.io/StreamingClaw-Page/)
...
## 14. [UniFunc3D: Unified Active Spatial-Temporal Grounding for 3D Functionality Segmentation](https://huggingface.co/papers/2603.23478)

**ArXiv ID**: [2603.23478](https://arxiv.org/abs/2603.23478)

**Authors**: Jiaying Lin, Dan Xu

**Published**: 2026-03-24 | **Submitted**: 2026-03-26 by Jiaying Lin

**Upvotes**: 1

**Links**: [Project Page](https://jiaying.link/unifunc3d/)
...
## 15. [Unleashing Spatial Reasoning in Multimodal Large Language Models via Textual Representation Guided Reasoning](https://huggingface.co/papers/2603.23404)

**ArXiv ID**: [2603.23404](https://arxiv.org/abs/2603.23404)

**Organization**: Tsinghua University

**Authors**: Jiacheng Hua, Yishu Yin, Yuhang Wu, Tai Wang, Yifei Huang, Miao Liu

**Published**: 2026-03-24 | **Submitted**: 2026-03-26 by jiacheng
...
## 16. [PLDR-LLMs Reason At Self-Organized Criticality](https://huggingface.co/papers/2603.23539)

**ArXiv ID**: [2603.23539](https://arxiv.org/abs/2603.23539)

**Organization**: Fromthesky Research Labs

**Authors**: Burc Gokden

**Published**: 2026-03-12 | **Submitted**: 2026-03-26 by Burc Gokden

**Upvotes**: 1

**Links**: [GitHub](https://github.com/burcgokden/PLDR-LLM-Self-Organized-Criticality) | [Project Page](https://huggingface.co/fromthesky)
