...
> source: [Hugging Face Daily Papers](https://huggingface.co/papers/date/2026-03-30)
...
**Published**: 2026-03-26 | **Submitted**: 2026-03-30 by Dingkang Liang
...
**Published**: 2026-03-26 | **Submitted**: 2026-03-30 by yawenluo

**Upvotes**: 100

**Links**: [GitHub](https://github.com/KlingAIResearch/ShotStream) | [Project Page](https://luo0207.github.io/ShotStream/)
...
**Published**: 2026-03-26 | **Submitted**: 2026-03-30 by kaipeng

**Upvotes**: 23

**Links**: [GitHub](https://github.com/ShandaAI/PackForcing)
...
**Published**: 2026-03-26 | **Submitted**: 2026-03-30 by Jingwei Ni
...
## 5. [Know3D: Prompting 3D Generation with Knowledge from Vision-Language Models](https://huggingface.co/papers/2603.22782)

**ArXiv ID**: [2603.22782](https://arxiv.org/abs/2603.22782)

**Organization**: Peking University

**Authors**: Wenyue Chen, Wenjue Chen, Peng Li, Qinghe Wang, Xu Jia, Heliang Zheng, Rongfei Jia, Yuan Liu, Ronggang Wang

**Published**: 2026-03-24 | **Submitted**: 2026-03-30 by wenyue Chen

**Upvotes**: 5

**Links**: [GitHub](https://github.com/xishuxishu/Know3D) | [Project Page](https://xishuxishu.github.io/Know3D.github.io/)
...
## 6. [Sommelier: Scalable Open Multi-turn Audio Pre-processing for Full-duplex Speech Language Models](https://huggingface.co/papers/2603.25750)

**ArXiv ID**: [2603.25750](https://arxiv.org/abs/2603.25750)

**Organization**: KAIST AI

**Authors**: Kyudan Jung, Jihwan Kim, Soyoon Kim, Jeongoon Kim, Jaegul Choo, Cheonbok Park

**Published**: 2026-03-20 | **Submitted**: 2026-03-30 by Kyudan Jung

**Upvotes**: 5

**Links**: [GitHub](https://github.com/naver-ai/sommelier) | [Project Page](https://kyudan1.github.io/sommelier.github.io//)
...
## 7. [Diffutron: A Masked Diffusion Language Model for Turkish Language](https://huggingface.co/papers/2603.20466)

**ArXiv ID**: [2603.20466](https://arxiv.org/abs/2603.20466)

**Organization**: Diffutron

**Authors**: Şuayp Talha Kocabay, Talha Rüzgar Akkuş

**Published**: 2026-03-20 | **Submitted**: 2026-03-30 by Talha Rüzgar Akkuş
...
## 8. [MedOpenClaw: Auditable Medical Imaging Agents Reasoning over Uncurated Full Studies](https://huggingface.co/papers/2603.24649)

**ArXiv ID**: [2603.24649](https://arxiv.org/abs/2603.24649)
...
**Published**: 2026-03-25 | **Submitted**: 2026-03-30 by liu

**Upvotes**: 0

**Links**: [Project Page](https://jakobshen.github.io/MedOpenClaw)
