...
> source: [Hugging Face Daily Papers](https://huggingface.co/papers/date/2026-09-08)
...
**ArXiv ID**: [2609.04010](https://arxiv.org/abs/2609.04010)

**Organization**: Institute of Foundation Models
...
**Published**: 2026-09-03 | **Submitted**: 2026-09-08 by Subham Sekhar Sahoo

**Upvotes**: 24

**Links**: [GitHub](https://github.com/ifm-ai/uno) | [Project Page](https://s-sahoo.com/uno/)
...
**ArXiv ID**: [2609.03241](https://arxiv.org/abs/2609.03241)

**Organization**: Tencent Hunyuan

**Authors**: Zixun Huang, Kishan Panaganti, Haitao Mi, Leowei Liang

**Published**: 2026-09-03 | **Submitted**: 2026-09-08 by Kishan Panaganti

**Upvotes**: 11

**Links**: [GitHub](https://github.com/alexhuang13/FlowBalance) | [Project Page](https://alexhuang13.github.io/FlowBalance-Blog/)
...
**ArXiv ID**: [2609.03756](https://arxiv.org/abs/2609.03756)

**Organization**: speridlabs

**Authors**: Javier del Pino, Salvador Rodríguez, Alejandro Garabito, Javier Álvarez, Chema Garabito

**Published**: 2026-09-03 | **Submitted**: 2026-09-08 by Chema Garabito

**Upvotes**: 7

**Links**: [GitHub](https://github.com/speridlabs/eneas) | [Project Page](https://speridlabs.com/research/eneas)
...
**ArXiv ID**: [2609.01281](https://arxiv.org/abs/2609.01281)
...
**Published**: 2026-09-01 | **Submitted**: 2026-09-08 by Wang Wei

**Upvotes**: 7

**Links**: [GitHub](https://github.com/DCDmllm/EmbodiedSkills)
...
**ArXiv ID**: [2608.25936](https://arxiv.org/abs/2608.25936)

**Organization**: OVHai LLM

**Authors**: Justin Robert, Raheel Qader

**Published**: 2026-08-26 | **Submitted**: 2026-09-08 by Justin Robert
...
## 6. [Verify Before You Distill: Prompt-Level Teacher Gating for On-Policy Distillation](https://huggingface.co/papers/2609.02998)

**ArXiv ID**: [2609.02998](https://arxiv.org/abs/2609.02998)

**Authors**: Zhiwei Zhang, Zechen Sun, Fei Zhao, Kang Peng, Bin Liang, Huayu Deng, Yao Hu, Kam-Fai Wong, Mu Chuan

**Published**: 2026-09-02 | **Submitted**: 2026-09-08 by Fei Zhao
...
## 7. [What Else Needs Fixing? Exploring Cost-Effective Test-Time Compute for Revision Propagation in Artifacts Generated Through Conversation](https://huggingface.co/papers/2609.03254)

**ArXiv ID**: [2609.03254](https://arxiv.org/abs/2609.03254)

**Authors**: Daisuke Kikuta

**Published**: 2026-09-03 | **Submitted**: 2026-09-08 by Daisuke Kikuta

**Upvotes**: 2

**Links**: [GitHub](https://github.com/ntt-dkiku/llm-revision-propagation)
