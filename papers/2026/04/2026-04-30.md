...
> source: [Hugging Face Daily Papers](https://huggingface.co/papers/date/2026-04-30)

Total papers: 9

---

## 1. [GLM-5V-Turbo: Toward a Native Foundation Model for Multimodal Agents](https://huggingface.co/papers/2604.26752)

**ArXiv ID**: [2604.26752](https://arxiv.org/abs/2604.26752)
...
**Published**: 2026-04-29 | **Submitted**: 2026-04-30 by Wenyi Hong

**Upvotes**: 69

**Links**: [GitHub](https://github.com/zai-org/GLM-V)
...
## 2. [Large Language Models Explore by Latent Distilling](https://huggingface.co/papers/2604.24927)

**ArXiv ID**: [2604.24927](https://arxiv.org/abs/2604.24927)

**Organization**: ShanghaiTech University

**Authors**: Yuanhao Zeng, Ao Lu, Lufei Li, Zheng Zhang, Yexin Li, Kan Ren

**Published**: 2026-04-27 | **Submitted**: 2026-04-30 by Zeng Yuanhao

**Upvotes**: 41

**Links**: [GitHub](https://github.com/LinesHogan/tLLM)
...
## 3. [Turning the TIDE: Cross-Architecture Distillation for Diffusion Large Language Models](https://huggingface.co/papers/2604.26951)

**ArXiv ID**: [2604.26951](https://arxiv.org/abs/2604.26951)

**Organization**: Peking University

**Authors**: Gongbo Zhang, Wen Wang, Ye Tian, Li Yuan

**Published**: 2026-04-29 | **Submitted**: 2026-04-30 by N2048M

**Upvotes**: 33

**Links**: [GitHub](https://github.com/PKU-YuanGroup/TIDE) | [Project Page](https://pku-yuangroup.github.io/TIDE-Page/)
...
## 4. [ClawGym: A Scalable Framework for Building Effective Claw Agents](https://huggingface.co/papers/2604.26904)
...
**Published**: 2026-04-29 | **Submitted**: 2026-04-30 by taesiri

**Upvotes**: 32

**Links**: [Project Page](https://github.com/ClawGym)
...
## 5. [Diffusion Templates: A Unified Plugin Framework for Controllable Diffusion](https://huggingface.co/papers/2604.24351)

**ArXiv ID**: [2604.24351](https://arxiv.org/abs/2604.24351)

**Authors**: Zhongjie Duan, Hong Zhang, Yingda Chen

**Published**: 2026-04-27 | **Submitted**: 2026-04-30 by Yingda Chen

**Upvotes**: 5

**Links**: [Project Page](https://modelscope.github.io/diffusion-templates-web/)
...
## 6. [Accelerating RL Post-Training Rollouts via System-Integrated Speculative Decoding](https://huggingface.co/papers/2604.26779)

**ArXiv ID**: [2604.26779](https://arxiv.org/abs/2604.26779)
...
## 7. [Unified 4D World Action Modeling from Video Priors with Asynchronous Denoising](https://huggingface.co/papers/2604.26694)

**ArXiv ID**: [2604.26694](https://arxiv.org/abs/2604.26694)
...
**Links**: [Project Page](https://sharinka0715.github.io/X-WAM/)
...
## 8. [A Survey on LLM-based Conversational User Simulation](https://huggingface.co/papers/2604.24977)

**ArXiv ID**: [2604.24977](https://arxiv.org/abs/2604.24977)
...
**Published**: 2026-04-27 | **Submitted**: 2026-04-30 by Franck Dernoncourt
...
## 9. [FASH-iCNN: Making Editorial Fashion Identity Inspectable Through Multimodal CNN Probing](https://huggingface.co/papers/2604.26186)

**ArXiv ID**: [2604.26186](https://arxiv.org/abs/2604.26186)

**Authors**: Morayo Danielle Adeyemi, Ryan A. Rossi, Franck Dernoncourt

**Published**: 2026-04-29 | **Submitted**: 2026-04-30 by Franck Dernoncourt
