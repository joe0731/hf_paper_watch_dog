...
> source: [Hugging Face Daily Papers](https://huggingface.co/papers/date/2026-04-07)
...
**ArXiv ID**: [2604.04707](https://arxiv.org/abs/2604.04707)
...
**Published**: 2026-04-06 | **Submitted**: 2026-04-07 by taesiri

**Upvotes**: 113

**Links**: [GitHub](https://github.com/OpenDCAI/OpenWorldLib) | [Project Page](https://wcny4qa9krto.feishu.cn/wiki/XtPJwf5XQipP7RkeVv0ckyWlnNd)
...
**Published**: 2026-04-06 | **Submitted**: 2026-04-07 by Bin Wang
...
## 3. [TriAttention: Efficient Long Reasoning with Trigonometric KV Compression](https://huggingface.co/papers/2604.04921)

**ArXiv ID**: [2604.04921](https://arxiv.org/abs/2604.04921)

**Organization**: NVIDIA

**Authors**: Weian Mao, Xi Lin, Wei Huang, Yuxin Xie, Tianfu Fu, Bohan Zhuang, Song Han, Yukang Chen

**Published**: 2026-04-06 | **Submitted**: 2026-04-07 by Wei Huang

**Upvotes**: 38

**Links**: [GitHub](https://github.com/WeianMao/triattention) | [Project Page](https://weianmao.github.io/tri-attention-project-page/)
...
## 4. [AURA: Always-On Understanding and Real-Time Assistance via Video Streams](https://huggingface.co/papers/2604.04184)
...
**Published**: 2026-04-05 | **Submitted**: 2026-04-07 by Jinpeng Chen

**Upvotes**: 33

**Links**: [GitHub](https://github.com/aurateam2026/AURA) | [Project Page](https://aurateam2026.github.io)
...
## 5. [SpatialEdit: Benchmarking Fine-Grained Image Spatial Editing](https://huggingface.co/papers/2604.04911)

**ArXiv ID**: [2604.04911](https://arxiv.org/abs/2604.04911)

**Organization**: JD Open Source
...
**Published**: 2026-04-06 | **Submitted**: 2026-04-07 by YC Xiao

**Upvotes**: 24

**Links**: [GitHub](https://github.com/EasonXiao-888/SpatialEdit) | [Project Page](https://github.com/EasonXiao-888/SpatialEdit)
...
## 6. [LightThinker++: From Reasoning Compression to Memory Management](https://huggingface.co/papers/2604.03679)

**ArXiv ID**: [2604.03679](https://arxiv.org/abs/2604.03679)
...
**Published**: 2026-04-04 | **Submitted**: 2026-04-07 by Yuqi
...
## 7. [FileGram: Grounding Agent Personalization in File-System Behavioral Traces](https://huggingface.co/papers/2604.04901)

**ArXiv ID**: [2604.04901](https://arxiv.org/abs/2604.04901)
...
**Links**: [Project Page](https://filegram.choiszt.com/)
...
**ArXiv ID**: [2604.04202](https://arxiv.org/abs/2604.04202)
...
**Published**: 2026-04-05 | **Submitted**: 2026-04-07 by Peng Xia

**Upvotes**: 17

**Links**: [GitHub](https://github.com/aiming-lab/ClawArena)
...
## 9. [Self-Execution Simulation Improves Coding Models](https://huggingface.co/papers/2604.03253)

**ArXiv ID**: [2604.03253](https://arxiv.org/abs/2604.03253)

**Authors**: Gallil Maimon, Ori Yoran, Felix Kreuk, Michael Hassid, Gal Cohen, Pierre Chambon, Yossi Adi

**Published**: 2026-03-11 | **Submitted**: 2026-04-07 by Gallil Maimon
...
## 10. [SkillX: Automatically Constructing Skill Knowledge Bases for Agents](https://huggingface.co/papers/2604.04804)

**ArXiv ID**: [2604.04804](https://arxiv.org/abs/2604.04804)
...
**Published**: 2026-04-06 | **Submitted**: 2026-04-07 by Shumin Deng

**Upvotes**: 13

**Links**: [GitHub](https://github.com/zjunlp/SkillX)
...
## 11. [Vero: An Open RL Recipe for General Visual Reasoning](https://huggingface.co/papers/2604.04917)

**ArXiv ID**: [2604.04917](https://arxiv.org/abs/2604.04917)
...
**Links**: [Project Page](https://vero-reasoning.github.io/)
...
## 12. [Your Agent, Their Asset: A Real-World Safety Analysis of OpenClaw](https://huggingface.co/papers/2604.04759)

**ArXiv ID**: [2604.04759](https://arxiv.org/abs/2604.04759)
...
**Published**: 2026-04-06 | **Submitted**: 2026-04-07 by Haoqin Tu

**Upvotes**: 7

**Links**: [GitHub](https://github.com/UCSC-VLAA/CIK-Bench) | [Project Page](https://ucsc-vlaa.github.io/CIK-Bench/)
...
## 13. [Less Detail, Better Answers: Degradation-Driven Prompting for VQA](https://huggingface.co/papers/2604.04838)

**ArXiv ID**: [2604.04838](https://arxiv.org/abs/2604.04838)

**Organization**: ZIP Lab

**Authors**: Haoxuan Han, Weijie Wang, Zeyu Zhang, Yefei He, Bohan Zhuang

**Published**: 2026-04-06 | **Submitted**: 2026-04-07 by Weijie Wang

**Upvotes**: 5

**Links**: [GitHub](https://github.com/ziplab/DDP) | [Project Page](https://hhx-jpg.github.io/ddp/)
...
## 14. [LIBERO-Para: A Diagnostic Benchmark and Metrics for Paraphrase Robustness in VLA Models](https://huggingface.co/papers/2603.28301)

**ArXiv ID**: [2603.28301](https://arxiv.org/abs/2603.28301)

**Organization**: Human-centered AI Laboratory

**Authors**: Chanyoung Kim, Minwoo Kim, Minseok Kang, Hyunwoo Kim, Dahuin Jung

**Published**: 2026-03-30 | **Submitted**: 2026-04-07 by Chanyoung Kim

**Upvotes**: 4

**Links**: [GitHub](https://github.com/cau-hai-lab/LIBERO-Para) | [Project Page](https://cau-hai-lab.github.io/LIBERO-Para/)
...
## 15. [Memory Intelligence Agent](https://huggingface.co/papers/2604.04503)

**ArXiv ID**: [2604.04503](https://arxiv.org/abs/2604.04503)
...
**Links**: [GitHub](https://github.com/ECNU-SII/MIA)
...
## 16. [AvatarPointillist: AutoRegressive 4D Gaussian Avatarization](https://huggingface.co/papers/2604.04787)

**ArXiv ID**: [2604.04787](https://arxiv.org/abs/2604.04787)
...
**Published**: 2026-04-06 | **Submitted**: 2026-04-07 by Hongyu LIU

**Upvotes**: 1

**Links**: [GitHub](https://github.com/KumapowerLIU/AvatarPointillist) | [Project Page](https://kumapowerliu.github.io/AvatarPointillist/)
...
## 17. [HDP: A Lightweight Cryptographic Protocol for Human Delegation Provenance in Agentic AI Systems](https://huggingface.co/papers/2604.04522)

**ArXiv ID**: [2604.04522](https://arxiv.org/abs/2604.04522)

**Organization**: Helixar AI

**Authors**: Asiri Dalugoda

**Published**: 2026-04-06 | **Submitted**: 2026-04-07 by Siri
...
## 18. [Learning to Learn-at-Test-Time: Language Agents with Learnable Adaptation Policies](https://huggingface.co/papers/2604.00830)
...
**Published**: 2026-04-02 | **Submitted**: 2026-04-07 by Zhanzhi Lou

**Upvotes**: 1

**Links**: [GitHub](https://github.com/zzzlou/meta-ttl)
...
## 19. [Can LLMs Learn to Reason Robustly under Noisy Supervision?](https://huggingface.co/papers/2604.03993)

**ArXiv ID**: [2604.03993](https://arxiv.org/abs/2604.03993)
...
**Published**: 2026-04-05 | **Submitted**: 2026-04-07 by Shenzhi Yang

**Upvotes**: 0

**Links**: [GitHub](https://github.com/ShenzhiYang2000/OLR)
