...
> source: [Hugging Face Daily Papers](https://huggingface.co/papers/date/2026-04-06)

Total papers: 8

---

## 1. [A Simple Baseline for Streaming Video Understanding](https://huggingface.co/papers/2604.02317)
...
**Published**: 2026-04-02 | **Submitted**: 2026-04-06 by Yujiao Shen

**Upvotes**: 37

**Links**: [GitHub](https://github.com/EvolvingLMMs-Lab/SimpleStream) | [Project Page](https://simple-stream.github.io/)
...
## 2. [Token Warping Helps MLLMs Look from Nearby Viewpoints](https://huggingface.co/papers/2604.02870)

**ArXiv ID**: [2604.02870](https://arxiv.org/abs/2604.02870)

**Authors**: Phillip Y. Lee, Chanho Park, Mingue Park, Seungwoo Yoo, Juil Koo, Minhyuk Sung

**Published**: 2026-04-03 | **Submitted**: 2026-04-06 by Yuseung "Phillip" Lee

**Upvotes**: 16

**Links**: [GitHub](https://github.com/KAIST-Visual-AI-Group/Token-Warping-MLLM) | [Project Page](https://token-warping-mllm.github.io/)
...
## 3. [Agentic-MME: What Agentic Capability Really Brings to Multimodal Intelligence?](https://huggingface.co/papers/2604.03016)

**ArXiv ID**: [2604.03016](https://arxiv.org/abs/2604.03016)
...
**Published**: 2026-04-03 | **Submitted**: 2026-04-06 by taesiri

**Upvotes**: 15

**Links**: [Project Page](https://agenticmme.github.io/)
...
## 4. [Self-Distilled RLVR](https://huggingface.co/papers/2604.03128)

**ArXiv ID**: [2604.03128](https://arxiv.org/abs/2604.03128)

**Authors**: Chenxu Yang, Chuanyu Qin, Qingyi Si, Minghui Chen, Naibin Gu, Dingyu Yao, Zheng Lin, Weiping Wang, Jiaqi Wang, Nan Duan

**Published**: 2026-04-03 | **Submitted**: 2026-04-06 by steven young
...
## 5. [Xpertbench: Expert Level Tasks with Rubrics-Based Evaluation](https://huggingface.co/papers/2604.02368)

**ArXiv ID**: [2604.02368](https://arxiv.org/abs/2604.02368)
...
**Published**: 2026-03-27 | **Submitted**: 2026-04-06 by taesiri
...
## 6. [AgentHazard: A Benchmark for Evaluating Harmful Behavior in Computer-Use Agents](https://huggingface.co/papers/2604.02947)

**ArXiv ID**: [2604.02947](https://arxiv.org/abs/2604.02947)
...
**Links**: [Project Page](https://yunhao-feng.github.io/AgentHazard/)
...
## 7. [CoME-VL: Scaling Complementary Multi-Encoder Vision-Language Learning](https://huggingface.co/papers/2604.03231)
...
**Links**: [GitHub](https://github.com/mbzuai-oryx/CoME-VL) | [Project Page](https://mbzuai-oryx.github.io/CoME-VL/)
...
## 8. [InCoder-32B-Thinking: Industrial Code World Model for Thinking](https://huggingface.co/papers/2604.03144)

**ArXiv ID**: [2604.03144](https://arxiv.org/abs/2604.03144)
