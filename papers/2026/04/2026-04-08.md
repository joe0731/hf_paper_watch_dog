...
> source: [Hugging Face Daily Papers](https://huggingface.co/papers/date/2026-04-08)
...
**ArXiv ID**: [2604.05015](https://arxiv.org/abs/2604.05015)

**Organization**: MME-Benchmarks
...
**Published**: 2026-04-06 | **Submitted**: 2026-04-08 by BradyFU

**Upvotes**: 166

**Links**: [GitHub](https://github.com/MME-Benchmarks/Video-MME-v2) | [Project Page](https://video-mme-v2.netlify.app/)
...
**ArXiv ID**: [2604.06132](https://arxiv.org/abs/2604.06132)

**Organization**: Claw-Eval
...
**Published**: 2026-04-07 | **Submitted**: 2026-04-08 by Lei Li

**Upvotes**: 70

**Links**: [GitHub](https://github.com/claw-eval/claw-eval) | [Project Page](https://claw-eval.github.io/)
...
**ArXiv ID**: [2604.04949](https://arxiv.org/abs/2604.04949)

**Organization**: RUC-GSAI-IIRLab

**Authors**: Yuqi Zhou, Sunhao Dai, Changle Qu, Liang Pang, Jun Xu, Ji-Rong Wen

**Published**: 2026-03-30 | **Submitted**: 2026-04-08 by Sunhao Dai

**Upvotes**: 41

**Links**: [GitHub](https://github.com/Yuqi-Zhou/LRAT) | [Project Page](https://yuqi-zhou.github.io/LRAT-homepage/)
...
**ArXiv ID**: [2604.03922](https://arxiv.org/abs/2604.03922)

**Authors**: Hui Sun, Yun-Ji Zhang, Zheng Xie, Ren-Biao Liu, Yali Du, Xin-Ye Li, Ming Li

**Published**: 2026-04-05 | **Submitted**: 2026-04-08 by Hui Sun
...
## 5. [Beyond Accuracy: Unveiling Inefficiency Patterns in Tool-Integrated Reasoning](https://huggingface.co/papers/2604.05404)

**ArXiv ID**: [2604.05404](https://arxiv.org/abs/2604.05404)

**Organization**: University of Science and Technology of China

**Authors**: Qisheng Su, Shiting Huang, Zhen Fang, Ziyan Chen, Zehui Chen, Feng Zhao

**Published**: 2026-04-07 | **Submitted**: 2026-04-08 by SII-sqs

**Upvotes**: 23

**Links**: [GitHub](https://github.com/sqs-ustc/tool-reasoning-framework-PTE)
...
**ArXiv ID**: [2604.01591](https://arxiv.org/abs/2604.01591)

**Organization**: University of Toronto CSSLab

**Authors**: Difan Jiao, Qianfeng Wen, Blair Yang, Zhenwei Tang, Ashton Anderson

**Published**: 2026-04-02 | **Submitted**: 2026-04-08 by Difan Jiao

**Upvotes**: 23

**Links**: [GitHub](https://github.com/CSSLab/ThinkTwice)
...
**Published**: 2026-04-06 | **Submitted**: 2026-04-08 by Hyunsoo Cha

**Upvotes**: 21

**Links**: [GitHub](https://github.com/snuvclab/vanast) | [Project Page](https://hyunsoocha.github.io/vanast/)
...
## 8. [How Well Do Agentic Skills Work in the Wild: Benchmarking LLM Skill Usage in Realistic Settings](https://huggingface.co/papers/2604.04323)

**ArXiv ID**: [2604.04323](https://arxiv.org/abs/2604.04323)

**Organization**: Shiyu's Lab

**Authors**: Yujian Liu, Jiabao Ji, Li An, Tommi Jaakkola, Yang Zhang, Shiyu Chang

**Published**: 2026-04-06 | **Submitted**: 2026-04-08 by Yujian Liu

**Upvotes**: 16

**Links**: [GitHub](https://github.com/UCSB-NLP-Chang/Skill-Usage) | [Project Page](https://github.com/UCSB-NLP-Chang/Skill-Usage)
...
## 9. [Paper Circle: An Open-source Multi-agent Research Discovery and Analysis Framework](https://huggingface.co/papers/2604.06170)

**ArXiv ID**: [2604.06170](https://arxiv.org/abs/2604.06170)
...
**Published**: 2026-04-07 | **Submitted**: 2026-04-08 by Komal Kumar

**Upvotes**: 14

**Links**: [GitHub](https://github.com/MAXNORM8650/papercircle) | [Project Page](https://papercircle.vercel.app/)
...
## 10. [MegaTrain: Full Precision Training of 100B+ Parameter Large Language Models on a Single GPU](https://huggingface.co/papers/2604.05091)

**ArXiv ID**: [2604.05091](https://arxiv.org/abs/2604.05091)

**Authors**: Zhengqing Yuan, Hanchi Sun, Lichao Sun, Yanfang Ye

**Published**: 2026-04-06 | **Submitted**: 2026-04-08 by Zhengqing Yuan

**Upvotes**: 9

**Links**: [GitHub](https://github.com/DLYuanGod/MegaTrain)
...
## 11. [Action Images: End-to-End Policy Learning via Multiview Video Generation](https://huggingface.co/papers/2604.06168)
...
**Published**: 2026-04-07 | **Submitted**: 2026-04-08 by taesiri

**Upvotes**: 7

**Links**: [Project Page](https://actionimages.github.io/)
...
## 12. [Demystifying When Pruning Works via Representation Hierarchies](https://huggingface.co/papers/2603.24652)

**ArXiv ID**: [2603.24652](https://arxiv.org/abs/2603.24652)

**Organization**: LLM-Drop

**Authors**: Shwai He, Guoheng Sun, Haichao Zhang, Yun Fu, Ang Li

**Published**: 2026-04-06 | **Submitted**: 2026-04-08 by Shwai He

**Upvotes**: 7

**Links**: [GitHub](https://github.com/CASE-Lab-UMD/Pruning-on-Representations)
...
## 13. [In-Place Test-Time Training](https://huggingface.co/papers/2604.06169)

**ArXiv ID**: [2604.06169](https://arxiv.org/abs/2604.06169)
...
**Links**: [GitHub](https://github.com/ByteDance-Seed/In-Place-TTT)
...
## 14. [MedGemma 1.5 Technical Report](https://huggingface.co/papers/2604.05081)

**ArXiv ID**: [2604.05081](https://arxiv.org/abs/2604.05081)
...
**Published**: 2026-04-06 | **Submitted**: 2026-04-08 by taesiri
...
## 15. [MMEmb-R1: Reasoning-Enhanced Multimodal Embedding with Pair-Aware Selection and Adaptive Control](https://huggingface.co/papers/2604.06156)
...
**Published**: 2026-04-07 | **Submitted**: 2026-04-08 by wangyuchi
...
## 16. [FactReview: Evidence-Grounded Reviews with Literature Positioning and Execution-Based Claim Verification](https://huggingface.co/papers/2604.04074)

**ArXiv ID**: [2604.04074](https://arxiv.org/abs/2604.04074)

**Organization**: Rensselaer Polytechnic Institute

**Authors**: Hang Xu, Ling Yue, Chaoqian Ouyang, Yuchen Liu, Libin Zheng, Shaowu Pan, Shimin Di, Min-Ling Zhang

**Published**: 2026-04-07 | **Submitted**: 2026-04-08 by Leo Y
...
## 17. [QiMeng-PRepair: Precise Code Repair via Edit-Aware Reward Optimization](https://huggingface.co/papers/2604.05963)

**ArXiv ID**: [2604.05963](https://arxiv.org/abs/2604.05963)
...
**Published**: 2026-04-07 | **Submitted**: 2026-04-08 by Changxin Ke

**Upvotes**: 2

**Links**: [GitHub](https://github.com/kcxain/QiMeng-PRepair)
...
## 18. [Experience Transfer for Multimodal LLM Agents in Minecraft Game](https://huggingface.co/papers/2604.05533)

**ArXiv ID**: [2604.05533](https://arxiv.org/abs/2604.05533)
...
## 19. [Scientific Graphics Program Synthesis via Dual Self-Consistency Reinforcement Learning](https://huggingface.co/papers/2604.06079)
...
## 20. [GBQA: A Game Benchmark for Evaluating LLMs as Quality Assurance Engineers](https://huggingface.co/papers/2604.02648)

**ArXiv ID**: [2604.02648](https://arxiv.org/abs/2604.02648)

**Authors**: Shufan Jiang, Chios Chen, Zhiyang Chen

**Published**: 2026-04-03 | **Submitted**: 2026-04-08 by Shufan Jiang

**Upvotes**: 1

**Links**: [GitHub](https://github.com/camel-ai/GBQA)
