...
> source: [Hugging Face Daily Papers](https://huggingface.co/papers/date/2026-04-29)

Total papers: 19

---

## 1. [Recursive Multi-Agent Systems](https://huggingface.co/papers/2604.25917)
...
**Published**: 2026-04-28 | **Submitted**: 2026-04-29 by Jiaru Zou

**Upvotes**: 56

**Links**: [GitHub](https://github.com/RecursiveMAS/RecursiveMAS) | [Project Page](https://recursivemas.github.io)
...
## 2. [DV-World: Benchmarking Data Visualization Agents in Real-World Scenarios](https://huggingface.co/papers/2604.25914)

**ArXiv ID**: [2604.25914](https://arxiv.org/abs/2604.25914)
...
**Published**: 2026-04-28 | **Submitted**: 2026-04-29 by taesiri

**Upvotes**: 35

**Links**: [GitHub](https://github.com/DA-Open/DV-World) | [Project Page](https://dv-world-project.github.io/)
...
## 3. [Programming with Data: Test-Driven Data Engineering for Self-Improving LLMs from Raw Corpora](https://huggingface.co/papers/2604.24819)

**ArXiv ID**: [2604.24819](https://arxiv.org/abs/2604.24819)
...
**Published**: 2026-04-27 | **Submitted**: 2026-04-29 by Cheng Tan

**Upvotes**: 33

**Links**: [GitHub](https://github.com/OpenRaiser/ProDa) | [Project Page](https://openraiser.github.io/ProDa-webpage)
...
## 4. [Refinement via Regeneration: Enlarging Modification Space Boosts Image Refinement in Unified Multimodal Models](https://huggingface.co/papers/2604.25636)
...
**Published**: 2026-04-28 | **Submitted**: 2026-04-29 by Jiayi Guo

**Upvotes**: 22

**Links**: [GitHub](https://github.com/LeapLabTHU/RvR)
...
## 5. [AutoResearchBench: Benchmarking AI Agents on Complex Scientific Literature Discovery](https://huggingface.co/papers/2604.25256)
...
**Published**: 2026-04-28 | **Submitted**: 2026-04-29 by Kun Luo

**Upvotes**: 22

**Links**: [GitHub](https://github.com/CherYou/AutoResearchBench) | [Project Page](https://cheryou.github.io/autoresearchbench.github.io/)
...
## 6. [Meta-CoT: Enhancing Granularity and Generalization in Image Editing](https://huggingface.co/papers/2604.24625)
...
**Published**: 2026-04-27 | **Submitted**: 2026-04-29 by ElevenZ

**Upvotes**: 22

**Links**: [GitHub](https://github.com/shiyi-zh0408/Meta-CoT) | [Project Page](https://shiyi-zh0408.github.io/projectpages/Meta-CoT/)
...
## 7. [Mutual Forcing: Dual-Mode Self-Evolution for Fast Autoregressive Audio-Video Character Generation](https://huggingface.co/papers/2604.25819)
...
**Published**: 2026-04-28 | **Submitted**: 2026-04-29 by zhou

**Upvotes**: 13

**Links**: [GitHub](https://github.com/HVision-NKU/MutualForcing) | [Project Page](https://mutualforcing.github.io/)
...
## 8. [Step-Audio-R1.5 Technical Report](https://huggingface.co/papers/2604.25719)

**ArXiv ID**: [2604.25719](https://arxiv.org/abs/2604.25719)
...
**Published**: 2026-04-28 | **Submitted**: 2026-04-29 by Yang

**Upvotes**: 9

**Links**: [GitHub](https://github.com/stepfun-ai/Step-Audio-R1)
...
**ArXiv ID**: [2604.24842](https://arxiv.org/abs/2604.24842)
...
**Published**: 2026-04-27 | **Submitted**: 2026-04-29 by taesiri

**Upvotes**: 6

**Links**: [Project Page](https://co-director-agent.github.io/)
...
## 10. [BARRED: Synthetic Training of Custom Policy Guardrails via Asymmetric Debate](https://huggingface.co/papers/2604.25203)

**ArXiv ID**: [2604.25203](https://arxiv.org/abs/2604.25203)

**Organization**: Plurai

**Authors**: Arnon Mazza, Elad Levi

**Published**: 2026-04-28 | **Submitted**: 2026-04-29 by Levi

**Upvotes**: 5

**Links**: [GitHub](https://github.com/plurai-ai/BARRED) | [Project Page](https://plurai.ai/launch)
...
## 11. [Toward Scalable Terminal Task Synthesis via Skill Graphs](https://huggingface.co/papers/2604.25727)

**ArXiv ID**: [2604.25727](https://arxiv.org/abs/2604.25727)
...
## 12. [TCOD: Exploring Temporal Curriculum in On-Policy Distillation for Multi-turn Autonomous Agents](https://huggingface.co/papers/2604.24005)

**ArXiv ID**: [2604.24005](https://arxiv.org/abs/2604.24005)

**Authors**: Jiaqi Wang, Wenhao Zhang, Weijie Shi, Yaliang Li, James Cheng

**Published**: 2026-04-27 | **Submitted**: 2026-04-29 by jiaqi wang

**Upvotes**: 5

**Links**: [GitHub](https://github.com/kokolerk/TCOD)
...
## 13. [MAIC-UI: Making Interactive Courseware with Generative UI](https://huggingface.co/papers/2604.25806)

**ArXiv ID**: [2604.25806](https://arxiv.org/abs/2604.25806)
...
**Published**: 2026-04-28 | **Submitted**: 2026-04-29 by Shangqing Tu

**Upvotes**: 3

**Links**: [GitHub](https://github.com/THU-MAIC/MAIC-UI) | [Project Page](https://open.maic.chat/)
...
## 14. [IAM: Identity-Aware Human Motion and Shape Joint Generation](https://huggingface.co/papers/2604.25164)

**ArXiv ID**: [2604.25164](https://arxiv.org/abs/2604.25164)
...
**Links**: [Project Page](https://vjwq.github.io/IAM/)
...
## 15. [A Systematic Post-Train Framework for Video Generation](https://huggingface.co/papers/2604.25427)
...
## 16. [GoClick: Lightweight Element Grounding Model for Autonomous GUI Interaction](https://huggingface.co/papers/2604.23941)

**ArXiv ID**: [2604.23941](https://arxiv.org/abs/2604.23941)

**Authors**: Hongxin Li, Yuntao Chen, Zhaoxiang Zhang

**Published**: 2026-04-27 | **Submitted**: 2026-04-29 by Hongxin Li

**Upvotes**: 1

**Links**: [GitHub](https://github.com/ZJULiHongxin/GoClick)
...
## 17. [AutoGUI-v2: A Comprehensive Multi-Modal GUI Functionality Understanding Benchmark](https://huggingface.co/papers/2604.24441)

**ArXiv ID**: [2604.24441](https://arxiv.org/abs/2604.24441)
...
**Links**: [GitHub](https://github.com/ZJULiHongxin/AutoGUI-v2)
...
## 18. [Preferences of a Voice-First Nation: Large-Scale Pairwise Evaluation and Preference Analysis for TTS in Indian Languages](https://huggingface.co/papers/2604.21481)

**ArXiv ID**: [2604.21481](https://arxiv.org/abs/2604.21481)
...
**Published**: 2026-04-23 | **Submitted**: 2026-04-29 by Mohammed Safi Ur Rahman Khan
...
## 19. [Seeing Isn't Believing: Uncovering Blind Spots in Evaluator Vision-Language Models](https://huggingface.co/papers/2604.21523)

**ArXiv ID**: [2604.21523](https://arxiv.org/abs/2604.21523)
...
**Links**: [GitHub](https://github.com/AI4Bharat/focus)
