...
> source: [Hugging Face Daily Papers](https://huggingface.co/papers/date/2026-04-24)

Total papers: 16

---

## 1. [WorldMark: A Unified Benchmark Suite for Interactive Video World Models](https://huggingface.co/papers/2604.21686)

**ArXiv ID**: [2604.21686](https://arxiv.org/abs/2604.21686)

**Authors**: Xiaojie Xu, Zhengyuan Lin, Kang He, Yukang Feng, Xiaofeng Mao, Yuanyang Yin, Kaipeng Zhang, Yongtao Ge

**Published**: 2026-04-23 | **Submitted**: 2026-04-24 by taesiri

**Upvotes**: 27

**Links**: [Project Page](https://alaya-studio.github.io/WorldMark/)
...
## 2. [UniT: Toward a Unified Physical Language for Human-to-Humanoid Policy Learning and World Modeling](https://huggingface.co/papers/2604.19734)

**ArXiv ID**: [2604.19734](https://arxiv.org/abs/2604.19734)

**Organization**: xpeng-robotics

**Authors**: Boyu Chen, Yi Chen, Lu Qiu, Jerry Bai, Yuying Ge, Yixiao Ge

**Published**: 2026-04-21 | **Submitted**: 2026-04-24 by Yi Chen

**Upvotes**: 25

**Links**: [GitHub](https://github.com/xpeng-robotics/UniT) | [Project Page](https://xpeng-robotics.github.io/unit/)
...
## 3. [StyleID: A Perception-Aware Dataset and Metric for Stylization-Agnostic Facial Identity Recognition](https://huggingface.co/papers/2604.21689)

**ArXiv ID**: [2604.21689](https://arxiv.org/abs/2604.21689)

**Authors**: Kwan Yun, Changmin Lee, Ayeong Jeong, Youngseo Kim, Seungmi Lee, Junyong Noh

**Published**: 2026-04-23 | **Submitted**: 2026-04-24 by kwan yun

**Upvotes**: 14

**Links**: [GitHub](https://github.com/kwanyun/StyleID) | [Project Page](https://kwanyun.github.io/StyleID_page/)
...
## 4. [Seeing Fast and Slow: Learning the Flow of Time in Videos](https://huggingface.co/papers/2604.21931)

**ArXiv ID**: [2604.21931](https://arxiv.org/abs/2604.21931)
...
**Links**: [Project Page](https://seeing-fast-and-slow.github.io/)
...
## 5. [TingIS: Real-time Risk Event Discovery from Noisy Customer Incidents at Enterprise Scale](https://huggingface.co/papers/2604.21889)

**ArXiv ID**: [2604.21889](https://arxiv.org/abs/2604.21889)

**Organization**: CodeFuse AI

**Authors**: Jun Wang, Ziyin Zhang, Rui Wang, Hang Yu, Peng Di, Rui Wang

**Published**: 2026-04-23 | **Submitted**: 2026-04-24 by Ziyin Zhang
...
## 6. [Hybrid Policy Distillation for LLMs](https://huggingface.co/papers/2604.20244)

**ArXiv ID**: [2604.20244](https://arxiv.org/abs/2604.20244)

**Authors**: Wenhong Zhu, Ruobing Xie, Rui Wang, Pengfei Liu

**Published**: 2026-04-22 | **Submitted**: 2026-04-24 by SII-Wenhong

**Upvotes**: 8

**Links**: [GitHub](https://github.com/zwhong714/Hybrid-Policy-Distillation)
...
## 7. [Co-Evolving LLM Decision and Skill Bank Agents for Long-Horizon Tasks](https://huggingface.co/papers/2604.20987)

**ArXiv ID**: [2604.20987](https://arxiv.org/abs/2604.20987)
...
**Published**: 2026-04-22 | **Submitted**: 2026-04-24 by Xiyang Wu

**Upvotes**: 5

**Links**: [GitHub](https://github.com/wuxiyang1996/cos-play) | [Project Page](https://wuxiyang1996.github.io/COSPLAY_page/)
...
## 8. [UniGenDet: A Unified Generative-Discriminative Framework for Co-Evolutionary Image Generation and Generated Image Detection](https://huggingface.co/papers/2604.21904)

**ArXiv ID**: [2604.21904](https://arxiv.org/abs/2604.21904)

**Organization**: Tsinghua-IVG

**Authors**: Yanran Zhang, Wenzhao Zheng, Yifei Li, Bingyao Yu, Yu Zheng, Lei Chen, Jiwen Lu, Jie Zhou

**Published**: 2026-04-23 | **Submitted**: 2026-04-24 by Yanran Zhang

**Upvotes**: 3

**Links**: [GitHub](https://github.com/Zhangyr2022/UniGenDet) | [Project Page](https://ivg-yanranzhang.github.io/UniGenDet/)
...
## 9. [VLAA-GUI: Knowing When to Stop, Recover, and Search, A Modular Framework for GUI Automation](https://huggingface.co/papers/2604.21375)

**ArXiv ID**: [2604.21375](https://arxiv.org/abs/2604.21375)
...
**Published**: 2026-04-23 | **Submitted**: 2026-04-24 by Cihang Xie

**Upvotes**: 3

**Links**: [GitHub](https://github.com/UCSC-VLAA/VLAA-GUI) | [Project Page](https://ucsc-vlaa.github.io/VLAA-GUI/)
...
## 10. [Context Unrolling in Omni Models](https://huggingface.co/papers/2604.21921)

**ArXiv ID**: [2604.21921](https://arxiv.org/abs/2604.21921)
...
**Links**: [Project Page](https://omni-model.com/)
...
## 11. [WebGen-R1: Incentivizing Large Language Models to Generate Functional and Aesthetic Websites with Reinforcement Learning](https://huggingface.co/papers/2604.20398)

**ArXiv ID**: [2604.20398](https://arxiv.org/abs/2604.20398)

**Authors**: Juyong Jiang, Chenglin Cai, Chansung Park, Jiasi Shen, Sunghun Kim, Jianguo Li, Yue Wang

**Published**: 2026-04-22 | **Submitted**: 2026-04-24 by John
...
## 12. [EditCrafter: Tuning-free High-Resolution Image Editing via Pretrained Diffusion Model](https://huggingface.co/papers/2604.10268)

**ArXiv ID**: [2604.10268](https://arxiv.org/abs/2604.10268)

**Authors**: Kunho Kim, Sumin Seo, Yongjun Cho, Hyungjin Chung

**Published**: 2026-04-11 | **Submitted**: 2026-04-24 by Kunho Kim

**Upvotes**: 3

**Links**: [GitHub](https://github.com/EditCrafter/EditCrafter) | [Project Page](https://editcrafter.github.io/)
...
## 13. [Trust but Verify: Introducing DAVinCI -- A Framework for Dual Attribution and Verification in Claim Inference for Language Models](https://huggingface.co/papers/2604.21193)

**ArXiv ID**: [2604.21193](https://arxiv.org/abs/2604.21193)

**Authors**: Vipula Rawte, Ryan Rossi, Franck Dernoncourt, Nedim Lipka

**Published**: 2026-04-23 | **Submitted**: 2026-04-24 by Franck Dernoncourt

**Upvotes**: 2

**Links**: [GitHub](https://github.com/vr25/davinci)
...
## 14. [Explainable Disentangled Representation Learning for Generalizable Authorship Attribution in the Era of Generative AI](https://huggingface.co/papers/2604.21300)

**ArXiv ID**: [2604.21300](https://arxiv.org/abs/2604.21300)
...
**Links**: [GitHub](https://github.com/hieum98/avae)
...
## 15. [Test-Time Adaptation for EEG Foundation Models: A Systematic Study under Real-World Distribution Shifts](https://huggingface.co/papers/2604.16926)

**ArXiv ID**: [2604.16926](https://arxiv.org/abs/2604.16926)

**Authors**: Gabriel Jason Lee, Jathurshan Pradeepkumar, Jimeng Sun

**Published**: 2026-04-18 | **Submitted**: 2026-04-24 by Jathurshan Pradeepkumar
...
## 16. [PersonalAI: A Systematic Comparison of Knowledge Graph Storage and Retrieval Approaches for Personalized LLM agents](https://huggingface.co/papers/2506.17001)

**ArXiv ID**: [2506.17001](https://arxiv.org/abs/2506.17001)
...
**Published**: 2026-04-12 | **Submitted**: 2026-04-24 by Dzigen
