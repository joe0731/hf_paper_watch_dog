...
> source: [Hugging Face Daily Papers](https://huggingface.co/papers/date/2026-08-24)
...
**ArXiv ID**: [2608.20061](https://arxiv.org/abs/2608.20061)

**Organization**: Kakao Corp.

**Authors**: Nayeon Kim, Hojin Lee, Yunju Bak, Jaesun Park, Boseop Kim

**Published**: 2026-08-20 | **Submitted**: 2026-08-24 by Nayeon Kim
...
## 2. [OmniAssistBench: Assistant-style Interaction Benchmark for Omni-LLMs](https://huggingface.co/papers/2608.21360)
...
**Published**: 2026-08-21 | **Submitted**: 2026-08-24 by Chaoyou Fu

**Upvotes**: 21

**Links**: [GitHub](https://github.com/XianyunSun/OmniAssistBench) | [Project Page](https://xianyunsun.github.io/OmniAssistBench/)
...
**ArXiv ID**: [2608.21156](https://arxiv.org/abs/2608.21156)
...
**Published**: 2026-08-21 | **Submitted**: 2026-08-24 by eric

**Upvotes**: 15

**Links**: [GitHub](https://github.com/DEEP-JLU/Awesome-Graph-Engineering)
...
## 4. [InfinityEdit: Infinite Video Editing with a Lightweight Edit-Ignition Adapter](https://huggingface.co/papers/2608.20910)
...
**Published**: 2026-08-21 | **Submitted**: 2026-08-24 by taesiri

**Upvotes**: 9

**Links**: [GitHub](https://github.com/YunzeTong/InfinityEdit) | [Project Page](https://yunzetong.github.io/InfinityEdit/)
...
## 5. [Every Coin Has Two Sides: On the Dual Nature of Generalization in On-Policy Distillation of Large Language Models](https://huggingface.co/papers/2608.16647)

**ArXiv ID**: [2608.16647](https://arxiv.org/abs/2608.16647)
...
**Published**: 2026-08-17 | **Submitted**: 2026-08-24 by DeyangKong
...
## 6. [EviRank: Structured Relevance Evidence for Multimodal Image Re-ranking](https://huggingface.co/papers/2608.20886)

**ArXiv ID**: [2608.20886](https://arxiv.org/abs/2608.20886)
...
**Published**: 2026-08-21 | **Submitted**: 2026-08-24 by Enjun Du
...
## 7. [Beyond Correctness: Benchmarking and Aligning Response Behaviors in Hybrid-Thinking MLLMs](https://huggingface.co/papers/2608.12781)
...
**Published**: 2026-08-17 | **Submitted**: 2026-08-24 by Songyang Zhang
...
## 8. [AgentMercury: Your Agent Can Synthesize Verifiable Environments for Business Scenarios at scale](https://huggingface.co/papers/2608.20634)

**ArXiv ID**: [2608.20634](https://arxiv.org/abs/2608.20634)

**Authors**: Minbyul Jeong, Chanwoong Yoon

**Published**: 2026-08-21 | **Submitted**: 2026-08-24 by Minbyul Jeong

**Upvotes**: 3

**Links**: [Project Page](https://minstar.github.io/AgentMercury/)
...
## 9. [Towards Faithful Simulation of Human Shopping Behavior](https://huggingface.co/papers/2608.20707)

**ArXiv ID**: [2608.20707](https://arxiv.org/abs/2608.20707)

**Authors**: Jiakai Tang, Yan Mi, Jing Yu, Yang Zhang, See-Kiong Ng, Qi Cao, Fei Sun, Xu Chen, Wen Chen, Jian Wu, Han Zhu, Bo Zheng

**Published**: 2026-08-21 | **Submitted**: 2026-08-24 by TangJiakai
...
## 10. [Daedalus-150M: A Convolution-Attention Hybrid Designed for CPU Inference](https://huggingface.co/papers/2608.20210)

**ArXiv ID**: [2608.20210](https://arxiv.org/abs/2608.20210)

**Authors**: Christos Koutsiaris

**Published**: 2026-08-20 | **Submitted**: 2026-08-24 by Ck

**Upvotes**: 2

**Links**: [GitHub](https://github.com/unseen1980/daedalus) | [Project Page](https://huggingface.co/Unseen1980/daedalus-150m-instruct)
...
## 11. [CLEAR: Continuous Latent Adapter Routing for Utility-Preserving LLM Safety Alignment](https://huggingface.co/papers/2608.21278)

**ArXiv ID**: [2608.21278](https://arxiv.org/abs/2608.21278)

**Organization**: University of Illinois at Urbana-Champaign

**Authors**: Chengxiao Wang, Enyi Jiang, Xiaojing Liao, Sanmi Koyejo

**Published**: 2026-08-21 | **Submitted**: 2026-08-24 by Enyi (Olivia) Jiang
...
## 12. [Llama-Mobile: Efficient 2.7-Bit Quantization of VLMs](https://huggingface.co/papers/2608.21134)
...
## 13. [Hadith computational science in the age of large language models: a critical narrative review](https://huggingface.co/papers/2608.20364)

**ArXiv ID**: [2608.20364](https://arxiv.org/abs/2608.20364)

**Authors**: Md. Ashraful Haque, Riasat Islam

**Published**: 2026-06-18 | **Submitted**: 2026-08-24 by Minbyul Jeong
