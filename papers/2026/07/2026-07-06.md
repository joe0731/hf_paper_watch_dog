...
> source: [Hugging Face Daily Papers](https://huggingface.co/papers/date/2026-07-06)
...
**ArXiv ID**: [2606.29526](https://arxiv.org/abs/2606.29526)
...
**Published**: 2026-06-28 | **Submitted**: 2026-07-06 by Jing Liang

**Upvotes**: 53

**Links**: [Project Page](https://anitaleungxx.github.io/MIPU/)
...
## 2. [VLA-Corrector: Lightweight Detect-and-Correct Inference for Adaptive Action Horizon](https://huggingface.co/papers/2607.01804)

**ArXiv ID**: [2607.01804](https://arxiv.org/abs/2607.01804)
...
**Published**: 2026-07-02 | **Submitted**: 2026-07-06 by Wenqi Zhang

**Upvotes**: 21

**Links**: [GitHub](https://github.com/ZJU-OmniAI/vla-corrector) | [Project Page](https://zju-omniai.github.io/vla-corrector/)
...
**Organization**: PhysicalAI System Group @ SAIL Lab, Southeast University

**Authors**: Ling Xu, Chuyu Han, Borui Li, Hao Wu, Shiqi Jiang, Ting Cao, Chuanyou Li, Sheng Zhong, Shuai Wang

**Published**: 2026-07-02 | **Submitted**: 2026-07-06 by Borui Li

**Upvotes**: 15

**Links**: [GitHub](https://github.com/SEU-PAISys/Embodied.cpp)
...
## 4. [OrbitQuant: Data-Agnostic Quantization for Image and Video Diffusion Transformers](https://huggingface.co/papers/2607.02461)

**ArXiv ID**: [2607.02461](https://arxiv.org/abs/2607.02461)

**Organization**: Cantina, Inc.

**Authors**: Donghyun Lee, Jitesh Chavan, Duy Nguyen, Sam Huang, Liming Jiang, Priyadarshini Panda, Timo Mertens, Saurabh Shukla

**Published**: 2026-07-02 | **Submitted**: 2026-07-06 by Saurabh Shukla

**Upvotes**: 11

**Links**: [Project Page](https://saurabhcantina.github.io/orbitquant/)
...
## 5. [DataComp-VLM: Improved Open Datasets for Vision-Language Models](https://huggingface.co/papers/2606.28551)
...
**Published**: 2026-06-26 | **Submitted**: 2026-07-06 by Selim Kuzucu

**Upvotes**: 7

**Links**: [GitHub](https://github.com/mlfoundations/dcvlm) | [Project Page](https://www.datacomp.ai/dcvlm/)
...
## 6. [Securing the AI Agent: A Unified Framework for Multi-Layer Agent Red Teaming](https://huggingface.co/papers/2606.31227)

**ArXiv ID**: [2606.31227](https://arxiv.org/abs/2606.31227)
...
**Published**: 2026-06-30 | **Submitted**: 2026-07-06 by Zonghao Ying
...
## 7. [Interpretation-Oriented Cloud Removal via Observation-Anchored Residual Flow with Geo-Contextual Alignment](https://huggingface.co/papers/2607.02471)

**ArXiv ID**: [2607.02471](https://arxiv.org/abs/2607.02471)
...
**Published**: 2026-07-02 | **Submitted**: 2026-07-06 by WZY

**Upvotes**: 3

**Links**: [GitHub](https://github.com/wzy6055/GACR)
...
## 8. [MultAttnAttrib: Training-Free Multimodal Attribution in Long Document Question Answering](https://huggingface.co/papers/2607.01420)

**ArXiv ID**: [2607.01420](https://arxiv.org/abs/2607.01420)
...
**Published**: 2026-07-01 | **Submitted**: 2026-07-06 by Franck Dernoncourt
...
## 9. [AGE: Adaptive-masking for Graph Embedding in Graph Retrieval-Augmented Generation](https://huggingface.co/papers/2607.00052)

**ArXiv ID**: [2607.00052](https://arxiv.org/abs/2607.00052)

**Organization**: OMRON SINIC X Corp.

**Authors**: Bao Long Nguyen Huu, Atsushi Hashimoto

**Published**: 2026-06-30 | **Submitted**: 2026-07-06 by Nguyen Huu Bao Long
