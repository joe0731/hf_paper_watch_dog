...
> source: [Hugging Face Daily Papers](https://huggingface.co/papers/date/2026-07-13)
...
**ArXiv ID**: [2607.08964](https://arxiv.org/abs/2607.08964)
...
**Published**: 2026-07-09 | **Submitted**: 2026-07-13 by LZX

**Upvotes**: 33

**Links**: [GitHub](https://github.com/zli12321/LHTB) | [Project Page](https://zli12321.github.io/LHTB/index.html)
...
## 2. [Video Generation Models are General-Purpose Vision Learners](https://huggingface.co/papers/2607.09024)
...
**Published**: 2026-07-10 | **Submitted**: 2026-07-13 by taesiri

**Upvotes**: 28

**Links**: [Project Page](https://genception.github.io/)
...
**ArXiv ID**: [2607.04751](https://arxiv.org/abs/2607.04751)

**Organization**: HKUSTGZ

**Authors**: Zhengpeng Xie, Li Lyna Zhang, Zeke Xie, Mao Yang

**Published**: 2026-07-06 | **Submitted**: 2026-07-13 by Zhengpeng Xie
...
**ArXiv ID**: [2607.07964](https://arxiv.org/abs/2607.07964)

**Organization**: University of Southern California

**Authors**: Donghyun Lee, Yuhang Li, Ruokai Yin, Priyadarshini Panda

**Published**: 2026-07-08 | **Submitted**: 2026-07-13 by Donghyun Lee

**Upvotes**: 8

**Links**: [GitHub](https://github.com/Intelligent-Computing-Lab-Panda/KronQ)
...
## 6. [PanoWorld: Real-World Panoramic Generation](https://huggingface.co/papers/2607.09661)
...
**Published**: 2026-07-10 | **Submitted**: 2026-07-13 by Insta360-Research

**Upvotes**: 6

**Links**: [GitHub](https://github.com/Insta360-Research-Team/PanoWorld) | [Project Page](https://lihaoy-ux.github.io/panoworld-page/)
...
## 7. [From RGB Generation to Dense Field Readout: Pixel-Space Dense Prediction with Text-to-Image Models](https://huggingface.co/papers/2607.06553)

**ArXiv ID**: [2607.06553](https://arxiv.org/abs/2607.06553)

**Authors**: Zanyi Wang, Xin Lin, Haodong Li, Dengyang Jiang, Yijiang Li

**Published**: 2026-07-09 | **Submitted**: 2026-07-13 by Dengyang Jiang

**Upvotes**: 6

**Links**: [GitHub](https://github.com/xmz111/ReChannel)
...
**ArXiv ID**: [2607.09415](https://arxiv.org/abs/2607.09415)
...
## 9. [Flow-ERD: Agent-type Aware Flow Matching with Entropy-Regularized Distillation for Diverse Traffic Simulation](https://huggingface.co/papers/2607.06957)

**ArXiv ID**: [2607.06957](https://arxiv.org/abs/2607.06957)

**Organization**: Navercorp

**Authors**: Seulbin Hwang, Kiyoung Om, Daejung Kim, Jinhan Lee

**Published**: 2026-07-08 | **Submitted**: 2026-07-13 by seulbin hwang

**Upvotes**: 2

**Links**: [Project Page](https://seulbinhwang.github.io/flow-erd-project-page/)
...
## 10. [Phone Segmentation and Recognition through Phonological Activation Mapping](https://huggingface.co/papers/2607.09020)

**ArXiv ID**: [2607.09020](https://arxiv.org/abs/2607.09020)
...
**Published**: 2026-07-10 | **Submitted**: 2026-07-13 by Shikhar Bharadwaj

**Upvotes**: 1

**Links**: [GitHub](https://github.com/stephenmac7/phone-metrics)
...
## 11. [Towards Mechanistically Understanding Why Memorized Knowledge Fails to Generalize in Large Language Model Finetuning](https://huggingface.co/papers/2607.08393)

**ArXiv ID**: [2607.08393](https://arxiv.org/abs/2607.08393)

**Organization**: HKUST

**Authors**: Lu Dai, Ziyang Rao, Yili Wang, Hanqing Wang, Hao Liu, Hui Xiong

**Published**: 2026-07-09 | **Submitted**: 2026-07-13 by Lu Dai
...
## 12. [A Sovereign, Open-Source Foundation Model for German and English](https://huggingface.co/papers/2607.09424)

**ArXiv ID**: [2607.09424](https://arxiv.org/abs/2607.09424)
...
## 13. [VaseMuseum: Digital Intelligent Museum for Ancient Greek Pottery](https://huggingface.co/papers/2607.06374)

**ArXiv ID**: [2607.06374](https://arxiv.org/abs/2607.06374)

**Organization**: Peking University

**Authors**: Jiazi Wang, Nonghai Zhang, Qiushi Xie, Zeyu Zhang, Yufeng Chen, Yang Zhao, Ling Shao, Hao Tang

**Published**: 2026-07-07 | **Submitted**: 2026-07-13 by Zeyu Zhang

**Upvotes**: 0

**Links**: [GitHub](https://github.com/AIGeeksGroup/VaseMuseum) | [Project Page](https://aigeeksgroup.github.io/VaseMuseum)
