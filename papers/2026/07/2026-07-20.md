...
> source: [Hugging Face Daily Papers](https://huggingface.co/papers/date/2026-07-20)
...
**Published**: 2026-07-16 | **Submitted**: 2026-07-20 by yewen

**Upvotes**: 37

**Links**: [GitHub](https://github.com/XiaomiRobotics/Xiaomi-Robotics-1) | [Project Page](https://robotics.xiaomi.com/xiaomi-robotics-1.html)
...
## 2. [xHC: Expanded Hyper-Connections](https://huggingface.co/papers/2607.14530)

**ArXiv ID**: [2607.14530](https://arxiv.org/abs/2607.14530)
...
**Published**: 2026-07-16 | **Submitted**: 2026-07-20 by Xiangdong Zhang

**Upvotes**: 37

**Links**: [GitHub](https://github.com/aHapBean/xHC)
...
## 3. [RAGU: A Multi-Step GraphRAG Engine with a Compact Domain-Adapted LLM](https://huggingface.co/papers/2607.11683)

**ArXiv ID**: [2607.11683](https://arxiv.org/abs/2607.11683)
...
**Published**: 2026-07-13 | **Submitted**: 2026-07-20 by Ivan Bondarenko

**Upvotes**: 34

**Links**: [GitHub](https://github.com/RaguTeam/RAGU)
...
## 4. [Loop the Loopies!](https://huggingface.co/papers/2607.16051)

**ArXiv ID**: [2607.16051](https://arxiv.org/abs/2607.16051)

**Authors**: Zitian Gao, Yilong Chen, Yihao Xiao, Xinyu Yang, Ran Tao, Joey Zhou, Bryan Dai

**Published**: 2026-07-17 | **Submitted**: 2026-07-20 by taesiri
...
## 5. [Cura 1T: Specialized Model for Agentic Healthcare](https://huggingface.co/papers/2607.15314)

**ArXiv ID**: [2607.15314](https://arxiv.org/abs/2607.15314)
...
**Published**: 2026-07-15 | **Submitted**: 2026-07-20 by taesiri

**Upvotes**: 32

**Links**: [GitHub](https://github.com/actava-ai/Cura) | [Project Page](https://actava.ai/cura)
...
## 6. [RESOURCE2SKILL: Distilling Executable Agent Skills from Human-Created Multimodal Resources](https://huggingface.co/papers/2606.29538)

**ArXiv ID**: [2606.29538](https://arxiv.org/abs/2606.29538)

**Organization**: Microsoft Research

**Authors**: Yijia Fan, Zonglin Di, Zimo Wen, Yifan Yang, Mingxi Cheng, Qi Dai, Bei Liu, Kai Qiu, Yue Dong, Ji Li, Chong Luo

**Published**: 2026-07-16 | **Submitted**: 2026-07-20 by Yif Yang

**Upvotes**: 30

**Links**: [GitHub](https://github.com/microsoft/Resource2Skill) | [Project Page](https://aka.ms/Resources2Skill)
...
**ArXiv ID**: [2607.15591](https://arxiv.org/abs/2607.15591)
...
**Published**: 2026-07-17 | **Submitted**: 2026-07-20 by TangJiakai
...
**ArXiv ID**: [2607.15161](https://arxiv.org/abs/2607.15161)

**Organization**: NAVER AI Lab

**Authors**: Byeongho Heo, Jaehui Hwang, Sangdoo Yun, Dongyoon Han

**Published**: 2026-07-16 | **Submitted**: 2026-07-20 by Byeongho Heo

**Upvotes**: 19

**Links**: [GitHub](https://github.com/naver-ai/opd2)
...
**ArXiv ID**: [2607.13196](https://arxiv.org/abs/2607.13196)

**Organization**: Queen's University

**Authors**: Suzhen Zhong, Shayan Noei, Bram Adams, Ying Zou

**Published**: 2026-07-14 | **Submitted**: 2026-07-20 by Suzhen Zhong
...
**Published**: 2026-07-17 | **Submitted**: 2026-07-20 by Evangeline Shen

**Upvotes**: 12

**Links**: [GitHub](https://github.com/pavelslab-nyu/pre2post-chess)
...
**ArXiv ID**: [2607.11699](https://arxiv.org/abs/2607.11699)
...
**Published**: 2026-07-13 | **Submitted**: 2026-07-20 by Kangdi Wang
...
## 12. [When Does Muon Help Agentic Reinforcement Learning?](https://huggingface.co/papers/2607.16169)
...
**Published**: 2026-07-17 | **Submitted**: 2026-07-20 by Kai Ruan
...
## 13. [Recursive Harness Self-Improvement](https://huggingface.co/papers/2607.15524)

**ArXiv ID**: [2607.15524](https://arxiv.org/abs/2607.15524)
...
**ArXiv ID**: [2607.14614](https://arxiv.org/abs/2607.14614)

**Authors**: Weiwen Xu, Jia Liu, Hou Pong Chan, Long Li, Deng Cai, Min Chen, Hao Zhang

**Published**: 2026-07-16 | **Submitted**: 2026-07-20 by Xu Weiwen
...
## 15. [DSWorld: A Data Science World Model for Efficient Autonomous Agents](https://huggingface.co/papers/2607.15901)

**ArXiv ID**: [2607.15901](https://arxiv.org/abs/2607.15901)

**Organization**: HKUSTGZ

**Authors**: Zherui Yang, Fan Liu, Hao Liu

**Published**: 2026-07-17 | **Submitted**: 2026-07-20 by Zherui Yang
...
## 16. [Audio-Visual Flamingo: Open Audio-Visual Intelligence for Long and Complex Videos](https://huggingface.co/papers/2607.16107)

**ArXiv ID**: [2607.16107](https://arxiv.org/abs/2607.16107)
...
**Links**: [Project Page](https://avflamingo.pages.dev/)
...
## 17. [S1-Omni: A Unified Multimodal Reasoning Model for Scientific Understanding, Prediction, and Generation](https://huggingface.co/papers/2607.15686)

**ArXiv ID**: [2607.15686](https://arxiv.org/abs/2607.15686)
...
**Published**: 2026-07-17 | **Submitted**: 2026-07-20 by Bing

**Upvotes**: 4

**Links**: [GitHub](https://github.com/ScienceOne-AI/S1-Omni) | [Project Page](https://scienceone-ai.github.io/S1-Omni/)
...
## 18. [VideoRAE: Taming Video Foundation Models for Generative Modeling via Representation Autoencoders](https://huggingface.co/papers/2607.14088)

**ArXiv ID**: [2607.14088](https://arxiv.org/abs/2607.14088)

**Authors**: Zhihao Xie, Junfeng Wu, Xinting Hu, Junchao Huang, Li Jiang

**Published**: 2026-07-15 | **Submitted**: 2026-07-20 by Junfeng Wu

**Upvotes**: 4

**Links**: [GitHub](https://github.com/zhxie0117/VideoRAE) | [Project Page](https://zhxie0117.github.io/VideoRAE/)
