...
> source: [Hugging Face Daily Papers](https://huggingface.co/papers/date/2026-07-23)
...
**ArXiv ID**: [2607.20145](https://arxiv.org/abs/2607.20145)
...
**Published**: 2026-07-22 | **Submitted**: 2026-07-23 by Dongfang Li

**Upvotes**: 31

**Links**: [GitHub](https://github.com/SLAI-AITP/SLAI-T-Rex)
...
**Published**: 2026-07-22 | **Submitted**: 2026-07-23 by JunhaoZhuang

**Upvotes**: 25

**Links**: [GitHub](https://github.com/zhuang2002/Self_Gradient_Forcing) | [Project Page](https://zhuang2002.github.io/SelfGradientForcing/)
...
**ArXiv ID**: [2607.19747](https://arxiv.org/abs/2607.19747)

**Organization**: Tencent

**Authors**: Kailin Jiang, Lei Liu, Jian Xi, Hui Xu, Junlin Liu, Baochen Fu, Shaoqing Ren, Bin Li, Vichwang, Yu Lu, Haibo Shi

**Published**: 2026-07-22 | **Submitted**: 2026-07-23 by Kailin Jiang

**Upvotes**: 19

**Links**: [GitHub](https://github.com/Rubric4Setwise/Rubric4Setwise) | [Project Page](https://rubric4setwise.github.io/)
...
## 4. [An Exam for Active Observers](https://huggingface.co/papers/2607.16165)

**ArXiv ID**: [2607.16165](https://arxiv.org/abs/2607.16165)

**Organization**: University of Southern California

**Authors**: Jiarui Zhang, Muzi Tao, Shangshang Wang, Ollie Liu, Xuezhe Ma, Willie Neiswanger

**Published**: 2026-07-17 | **Submitted**: 2026-07-23 by Muzi Tao

**Upvotes**: 12

**Links**: [GitHub](https://github.com/saccharomycetes/ActiveVision) | [Project Page](https://activevision.dev)
...
## 5. [Scaling Laws for Hypernetwork-Based Knowledge Injection in Large Language Models](https://huggingface.co/papers/2607.19604)

**ArXiv ID**: [2607.19604](https://arxiv.org/abs/2607.19604)

**Authors**: Nischay Dhankhar, Dos Baha, Abulhair Saparov

**Published**: 2026-07-21 | **Submitted**: 2026-07-23 by taesiri

**Upvotes**: 9

**Links**: [GitHub](https://github.com/hdnndh/Latent-Geometry-Beyond-Search-Amortizing-Planning-in-World-Models) | [Project Page](https://www.nace.ai/research/scaling-law-for-hypernetwork)
...
## 6. [Beyond Euclidean Clipping: Overcoming Exploration Collapse in LLM RL via Riemannian Isometric Policy Optimization](https://huggingface.co/papers/2607.10169)

**ArXiv ID**: [2607.10169](https://arxiv.org/abs/2607.10169)

**Organization**: GenSI: Generative Symbolic Intelligence

**Authors**: Zhicheng Cai, Xinyuan Guo, Hanlin Wu, Mingxuan Wang, Wei-Ying Ma, Ya-Qin Zhang, Hao Zhou

**Published**: 2026-07-11 | **Submitted**: 2026-07-23 by Xinyuan Guo

**Upvotes**: 7

**Links**: [GitHub](https://github.com/Aiolus-X/RIPO)
...
**Published**: 2026-07-15 | **Submitted**: 2026-07-23 by Dwip Dalal

**Upvotes**: 6

**Links**: [GitHub](https://github.com/dwipddalal/Anchor-Align) | [Project Page](https://anchoralignvla.github.io/)
...
## 8. [FVAttn: Adaptive Sparse Attention with Runtime Load Balancing for Video Generation](https://huggingface.co/papers/2607.16190)
...
**Published**: 2026-07-17 | **Submitted**: 2026-07-23 by Ye Huang
...
**Published**: 2026-07-22 | **Submitted**: 2026-07-23 by maveryn

**Upvotes**: 3

**Links**: [GitHub](https://github.com/maveryn/trace) | [Project Page](https://maveryn.github.io/trace/)
...
## 10. [SLPO: Scaling Latent Reasoning via a Surrogate Policy](https://huggingface.co/papers/2607.19691)

**ArXiv ID**: [2607.19691](https://arxiv.org/abs/2607.19691)

**Authors**: Runyang You, Zhiyuan Liu, Yongqi Li, Wenjie Li

**Published**: 2026-07-22 | **Submitted**: 2026-07-23 by taesiri

**Upvotes**: 2

**Links**: [GitHub](https://github.com/ModalityDance/SLPO)
...
## 11. [DocOps: A Verifiable Benchmark for Autonomous Agents in Complex Document Operations](https://huggingface.co/papers/2607.19865)

**ArXiv ID**: [2607.19865](https://arxiv.org/abs/2607.19865)

**Authors**: Jiazhen Jiang, Boxi Cao, Lingyong Yan, Yaojie Lu, Hongyu Lin, Shuaiqiang Wang, Dawei Yin, Xianpei Han, Le Sun

**Published**: 2026-07-22 | **Submitted**: 2026-07-23 by Jiazhen Jiang

**Upvotes**: 2

**Links**: [GitHub](https://github.com/icip-cas/DocOps) | [Project Page](https://docopsbench.github.io)
...
## 12. [Train the Model, Not the Reader: Decodability Supervision for Verifiable Activation Explanations](https://huggingface.co/papers/2607.20379)

**ArXiv ID**: [2607.20379](https://arxiv.org/abs/2607.20379)

**Authors**: Hiskias Dingeto

**Published**: 2026-07-22 | **Submitted**: 2026-07-23 by Hiskias Dingeto
...
**ArXiv ID**: [2607.19942](https://arxiv.org/abs/2607.19942)
...
**Links**: [GitHub](https://github.com/unique-chan/G-MAD)
...
## 14. [SeededGrasp: Language-Guided Grasping in Complex Scenes with Multiple Embodiments](https://huggingface.co/papers/2607.20207)

**ArXiv ID**: [2607.20207](https://arxiv.org/abs/2607.20207)
...
**Links**: [GitHub](https://github.com/uoft-isl/SeededGrasp) | [Project Page](https://uoft-isl.github.io/seeded-grasp/)
...
## 15. [ATSplat: Compact Feed-forward 3D Gaussian Splatting with Adaptive Token Expansion](https://huggingface.co/papers/2607.20417)
...
**Links**: [Project Page](https://join16.github.io/page-atsplat/)
