...
> source: [Hugging Face Daily Papers](https://huggingface.co/papers/date/2026-07-22)

Total papers: 21

---

## 1. [DataFlow-Harness: A Grounded Code-Agent Platform for Constructing Editable LLM Data Pipelines](https://huggingface.co/papers/2607.16617)

**ArXiv ID**: [2607.16617](https://arxiv.org/abs/2607.16617)

**Organization**: Peking University

**Authors**: Runming He, Zhen Hao Wong, Hao Liang, Zimo Meng, Chengyu Shen, Xiaochen Ma, Wentao Zhang

**Published**: 2026-07-18 | **Submitted**: 2026-07-22 by Hao Liang
...
## 2. [Generative World Renderer at the Speed of Play](https://huggingface.co/papers/2607.18703)
...
**Published**: 2026-07-21 | **Submitted**: 2026-07-22 by Zhixiang Wang

**Upvotes**: 51

**Links**: [GitHub](https://github.com/AlayaLab/AlayaRenderer-Flash) | [Project Page](https://alaya-renderer-flash.alayalab.ai/)
...
## 3. [Text Template Tokens Are Implicit Semantic Registers in Diffusion Transformers](https://huggingface.co/papers/2607.19139)
...
**Published**: 2026-07-21 | **Submitted**: 2026-07-22 by Maohua Li

**Upvotes**: 46

**Links**: [GitHub](https://github.com/Met4physics/DiT-Interpretability)
...
## 4. [AlayaWorld: Interactive Long-Horizon World Modeling -- Full Technical Report](https://huggingface.co/papers/2607.18367)

**ArXiv ID**: [2607.18367](https://arxiv.org/abs/2607.18367)
...
**Published**: 2026-07-20 | **Submitted**: 2026-07-22 by kaipeng

**Upvotes**: 39

**Links**: [GitHub](https://github.com/AlayaLab/AlayaWorld) | [Project Page](https://alaya-lab.github.io/AlayaWorld/)
...
## 5. [Mage-Flow: An Efficient Native-Resolution Foundation Model for Image Generation and Editing](https://huggingface.co/papers/2607.19064)
...
**Published**: 2026-07-21 | **Submitted**: 2026-07-22 by Xinjie
...
## 6. [Stale but Stable: Staleness-Adaptive Trust Regions for Stabilizing Asynchronous Reinforcement Learning](https://huggingface.co/papers/2607.18722)

**ArXiv ID**: [2607.18722](https://arxiv.org/abs/2607.18722)
...
**Published**: 2026-07-21 | **Submitted**: 2026-07-22 by LZX

**Upvotes**: 24

**Links**: [GitHub](https://github.com/jyyang26/SAT) | [Project Page](https://jyyang26.github.io/stable_async_analysis/)
...
## 7. [SciForma: Structure-Faithful Generation of Scientific Diagrams](https://huggingface.co/papers/2607.18091)

**ArXiv ID**: [2607.18091](https://arxiv.org/abs/2607.18091)

**Organization**: Peking University

**Authors**: Yuxuan Luo, Peng Zhang, Xinjie Zhang, Xun Guo, Zhouhui Lian, Yan Lu

**Published**: 2026-07-20 | **Submitted**: 2026-07-22 by Luo Yuxuan
...
## 8. [AgentDebugX: An Open-Source Toolkit for Failure Observability, Attribution, and Recovery in LLM Agents](https://huggingface.co/papers/2607.18754)

**ArXiv ID**: [2607.18754](https://arxiv.org/abs/2607.18754)
...
**Published**: 2026-07-21 | **Submitted**: 2026-07-22 by Kunlun_Zhu

**Upvotes**: 9

**Links**: [GitHub](https://github.com/AgentDebugX/AgentDebugX) | [Project Page](https://www.agentdebugx.com/)
...
## 9. [ABot-World-0: Infinite Interactive World Rollout on a Single Desktop GPU](https://huggingface.co/papers/2607.19191)
...
**Published**: 2026-07-21 | **Submitted**: 2026-07-22 by taesiri
...
## 10. [HPD-Parsing: Hierarchical Parallel Document Parsing](https://huggingface.co/papers/2607.18839)

**ArXiv ID**: [2607.18839](https://arxiv.org/abs/2607.18839)
...
**Published**: 2026-07-21 | **Submitted**: 2026-07-22 by cuicheng
...
## 11. [Two-Level Meta-Rubrics for Evaluating Open-Ended Generation: GAMUT, a Benchmark for Factual Completeness](https://huggingface.co/papers/2607.19322)

**ArXiv ID**: [2607.19322](https://arxiv.org/abs/2607.19322)
...
**Published**: 2026-07-21 | **Submitted**: 2026-07-22 by Xilun Chen

**Upvotes**: 3

**Links**: [GitHub](https://github.com/facebookresearch/GAMUT)
...
## 12. [ISO: An RLVR-Native Optimization Stack](https://huggingface.co/papers/2607.19331)

**ArXiv ID**: [2607.19331](https://arxiv.org/abs/2607.19331)
...
**Published**: 2026-07-21 | **Submitted**: 2026-07-22 by Wenyan Cong

**Upvotes**: 2

**Links**: [GitHub](https://github.com/zhuhanqing/ISO) | [Project Page](https://iso-rlvr.github.io/)
...
## 13. [EduPanel: A Three-Agent LLM Judge for Teaching Videos -- Reliability, Complementarity, and Human Trust Calibration](https://huggingface.co/papers/2607.18529)

**ArXiv ID**: [2607.18529](https://arxiv.org/abs/2607.18529)

**Organization**: 台灣大學

**Authors**: Jia-Kai Dong, Yi-Cheng Lin, Hung-yi Lee

**Published**: 2026-07-20 | **Submitted**: 2026-07-22 by 董家愷

**Upvotes**: 2

**Links**: [GitHub](https://github.com/snooow1029/edupanel)
...
## 14. [Masked Visual Actions for Unified World Modeling](https://huggingface.co/papers/2607.19343)
...
**Links**: [GitHub](https://github.com/HadiZayer/masked-visual-actions) | [Project Page](https://masked-visual-actions.github.io/)
...
## 15. [Appearance Pointers -- Multimodal Region Control of Diffusion Transformers](https://huggingface.co/papers/2607.19344)
...
**Links**: [Project Page](https://ivl.cs.brown.edu/research/appearance_pointers.html)
...
## 16. [H^2SD: Hybrid Hindsight Self-Distillation](https://huggingface.co/papers/2607.18955)

**ArXiv ID**: [2607.18955](https://arxiv.org/abs/2607.18955)
...
## 17. [Delineate Anything v2: A Global Foundation Model for Field Delineation](https://huggingface.co/papers/2607.19069)

**ArXiv ID**: [2607.19069](https://arxiv.org/abs/2607.19069)
...
**Published**: 2026-07-21 | **Submitted**: 2026-07-22 by Mykola Lavreniuk
...
## 18. [Where Should Optimizer State Live? Tiered State Allocation for Memory-Efficient Mixture-of-Experts Training](https://huggingface.co/papers/2607.19058)

**ArXiv ID**: [2607.19058](https://arxiv.org/abs/2607.19058)

**Authors**: Nuemaan Malik

**Published**: 2026-07-21 | **Submitted**: 2026-07-22 by nuemaan malik

**Upvotes**: 1

**Links**: [GitHub](https://github.com/nuemaan/skewadam)
...
## 19. [Trajectory-aware Cross-view Geo-localization with Sequential Observations](https://huggingface.co/papers/2607.15491)

**ArXiv ID**: [2607.15491](https://arxiv.org/abs/2607.15491)

**Organization**: Multimodal Vision Research Laboratory @ WashU

**Authors**: Tianyi Gao, Jiayu Lin, Danielle Beaulieu, Nathan Jacobs

**Published**: 2026-07-16 | **Submitted**: 2026-07-22 by Tianyi

**Upvotes**: 1

**Links**: [GitHub](https://github.com/mvrl/TrajLoc) | [Project Page](https://humblegamer.github.io/trajloc/)
...
**ArXiv ID**: [2607.19011](https://arxiv.org/abs/2607.19011)

**Authors**: Tuo Liang, Zhe Hu, Disheng Liu, Jing Li, Yu Yin

**Published**: 2026-07-21 | **Submitted**: 2026-07-22 by Derek Zhe Hu
...
## 21. [ConsiSpace: Learning Geometric Consistency Matters for Video Spatial Reasoning](https://huggingface.co/papers/2607.17599)

**ArXiv ID**: [2607.17599](https://arxiv.org/abs/2607.17599)

**Authors**: Ting Huang, Zhenyu Zhang, Wenyuan Huang, Jian Yang, Hao Tang

**Published**: 2026-07-20 | **Submitted**: 2026-07-22 by HuangTing

**Upvotes**: 0

**Links**: [Project Page](https://believeht029.github.io/ConsiSpace/)
