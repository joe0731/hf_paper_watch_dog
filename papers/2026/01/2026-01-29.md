# Daily Papers - 2026-01-29

> source: [Hugging Face Daily Papers](https://huggingface.co/papers/date/2026-01-29)

Total papers: 22

---

## 1. [Advancing Open-source World Models](https://huggingface.co/papers/2601.20540)

**ArXiv ID**: [2601.20540](https://arxiv.org/abs/2601.20540)
...
**Published**: 2026-01-28 | **Submitted**: 2026-01-29 by Qiuyu Wang

**Upvotes**: 131

**Links**: [GitHub](https://github.com/Robbyant/lingbot-world) | [Project Page](https://technology.robbyant.com/lingbot-world)
...
## 2. [Harder Is Better: Boosting Mathematical Reasoning via Difficulty-Aware GRPO and Multi-Aspect Question Reformulation](https://huggingface.co/papers/2601.20614)

**ArXiv ID**: [2601.20614](https://arxiv.org/abs/2601.20614)

**Organization**: AMAP-ML

**Authors**: Yanqi Dai, Yuxiang Ji, Xiao Zhang, Yong Wang, Xiangxiang Chu, Zhiwu Lu

**Published**: 2026-01-28 | **Submitted**: 2026-01-29 by Yanqi Dai

**Upvotes**: 120

**Links**: [GitHub](https://github.com/AMAP-ML/MathForge)
...
**ArXiv ID**: [2601.19325](https://arxiv.org/abs/2601.19325)
...
**Published**: 2026-01-27 | **Submitted**: 2026-01-29 by Zichen Wen

**Upvotes**: 80

**Links**: [GitHub](https://github.com/InnovatorLM/Innovator-VL) | [Project Page](https://innovatorlm.github.io/Innovator-VL)
...
**ArXiv ID**: [2601.20552](https://arxiv.org/abs/2601.20552)

**Organization**: DeepSeek

**Authors**: Haoran Wei, Yaofeng Sun, Yukun Li

**Published**: 2026-01-28 | **Submitted**: 2026-01-29 by taesiri

**Upvotes**: 65

**Links**: [GitHub](https://github.com/deepseek-ai/DeepSeek-OCR-2)
...
## 5. [Reinforcement Learning via Self-Distillation](https://huggingface.co/papers/2601.20802)

**ArXiv ID**: [2601.20802](https://arxiv.org/abs/2601.20802)
...
**Published**: 2026-01-28 | **Submitted**: 2026-01-29 by Jonas Hübotter

**Upvotes**: 41

**Links**: [GitHub](https://github.com/lasgroup/SDPO) | [Project Page](https://self-distillation.github.io/SDPO)
...
## 6. [Spark: Strategic Policy-Aware Exploration via Dynamic Branching for Long-Horizon Agentic Learning](https://huggingface.co/papers/2601.20209)

**ArXiv ID**: [2601.20209](https://arxiv.org/abs/2601.20209)

**Authors**: Jinyang Wu, Shuo Yang, Changpeng Yang, Yuhao Shen, Shuai Zhang, Zhengqi Wen, Jianhua Tao

**Published**: 2026-01-28 | **Submitted**: 2026-01-29 by Jinyang Wu
...
## 7. [Linear representations in language models can change dramatically over a conversation](https://huggingface.co/papers/2601.20834)

**ArXiv ID**: [2601.20834](https://arxiv.org/abs/2601.20834)
...
## 8. [AACR-Bench: Evaluating Automatic Code Review with Holistic Repository-Level Context](https://huggingface.co/papers/2601.19494)

**ArXiv ID**: [2601.19494](https://arxiv.org/abs/2601.19494)
...
**Published**: 2026-01-27 | **Submitted**: 2026-01-29 by Yongda Yu

**Upvotes**: 16

**Links**: [GitHub](https://github.com/alibaba/aacr-bench)
...
## 9. [SERA: Soft-Verified Efficient Repository Agents](https://huggingface.co/papers/2601.20789)

**ArXiv ID**: [2601.20789](https://arxiv.org/abs/2601.20789)
...
**Links**: [GitHub](https://github.com/allenai/SERA)
...
## 10. [OmegaUse: Building a General-Purpose GUI Agent for Autonomous Task Execution](https://huggingface.co/papers/2601.20380)

**ArXiv ID**: [2601.20380](https://arxiv.org/abs/2601.20380)
...
## 11. [How AI Impacts Skill Formation](https://huggingface.co/papers/2601.20245)

**ArXiv ID**: [2601.20245](https://arxiv.org/abs/2601.20245)

**Organization**: Anthropic

**Authors**: Judy Hanwen Shen, Alex Tamkin

**Published**: 2026-01-28 | **Submitted**: 2026-01-29 by Caleb Fahlgren

**Upvotes**: 9

**Links**: [Project Page](https://www.anthropic.com/research/AI-assistance-coding-skills)
...
## 12. [Group Distributionally Robust Optimization-Driven Reinforcement Learning for LLM Reasoning](https://huggingface.co/papers/2601.19280)

**ArXiv ID**: [2601.19280](https://arxiv.org/abs/2601.19280)

**Organization**: Tencent

**Authors**: Kishan Panaganti, Zhenwen Liang, Wenhao Yu, Haitao Mi, Dong Yu

**Published**: 2026-01-27 | **Submitted**: 2026-01-29 by Kishan Panaganti
...
## 13. [FP8-RL: A Practical and Stable Low-Precision Stack for LLM Reinforcement Learning](https://huggingface.co/papers/2601.18150)

**ArXiv ID**: [2601.18150](https://arxiv.org/abs/2601.18150)

**Organization**: NVIDIA

**Authors**: Zhaopeng Qiu, Shuang Yu, Jingqi Zhang, Shuai Zhang, Xue Huang, Jingyi Yang, Junjie Lai

**Published**: 2026-01-26 | **Submitted**: 2026-01-29 by Alex Chiu
...
## 14. [Training Reasoning Models on Saturated Problems via Failure-Prefix Conditioning](https://huggingface.co/papers/2601.20829)

**ArXiv ID**: [2601.20829](https://arxiv.org/abs/2601.20829)

**Organization**: New York University

**Authors**: Minwu Kim, Safal Shrestha, Keith Ross

**Published**: 2026-01-28 | **Submitted**: 2026-01-29 by Minwu Kim

**Upvotes**: 7

**Links**: [GitHub](https://github.com/minwukim/training-on-saturated-problems)
...
## 15. [VERGE: Formal Refinement and Guidance Engine for Verifiable LLM Reasoning](https://huggingface.co/papers/2601.20055)

**ArXiv ID**: [2601.20055](https://arxiv.org/abs/2601.20055)

**Organization**: Amazon Web Services (AWS)

**Authors**: Vikash Singh, Darion Cassel, Nathaniel Weir, Nick Feng, Sam Bayless

**Published**: 2026-01-27 | **Submitted**: 2026-01-29 by Vikash Singh
...
## 16. [UPLiFT: Efficient Pixel-Dense Feature Upsampling with Local Attenders](https://huggingface.co/papers/2601.17950)

**ArXiv ID**: [2601.17950](https://arxiv.org/abs/2601.17950)

**Organization**: UPLiFT - University of Maryland, College Park

**Authors**: Matthew Walmer, Saksham Suri, Anirud Aggarwal, Abhinav Shrivastava

**Published**: 2026-01-25 | **Submitted**: 2026-01-29 by Niels Rogge

**Upvotes**: 4

**Links**: [GitHub](https://github.com/mwalmer-umd/UPLiFT) | [Project Page](https://www.cs.umd.edu/~mwalmer/uplift/)
...
## 17. [Persona Prompting as a Lens on LLM Social Reasoning](https://huggingface.co/papers/2601.20757)

**ArXiv ID**: [2601.20757](https://arxiv.org/abs/2601.20757)

**Organization**: XplaiNLP Lab

**Authors**: Jing Yang, Moritz Hechtbauer, Elisabeth Khalilov, Evelyn Luise Brinkmann, Vera Schmitt, Nils Feldhus

**Published**: 2026-01-28 | **Submitted**: 2026-01-29 by Nils Feldhus

**Upvotes**: 3

**Links**: [GitHub](https://github.com/jingyng/PP-social-reasoning)
...
## 18. [SE-DiCoW: Self-Enrolled Diarization-Conditioned Whisper](https://huggingface.co/papers/2601.19194)

**ArXiv ID**: [2601.19194](https://arxiv.org/abs/2601.19194)
...
**Published**: 2026-01-27 | **Submitted**: 2026-01-29 by Alexander Polok
...
## 19. [RIR-Mega-Speech: A Reverberant Speech Corpus with Comprehensive Acoustic Metadata and Reproducible Evaluation](https://huggingface.co/papers/2601.19949)

**ArXiv ID**: [2601.19949](https://arxiv.org/abs/2601.19949)

**Authors**: Mandip Goswami

**Published**: 2026-01-25 | **Submitted**: 2026-01-29 by Mandip Goswami

**Upvotes**: 3

**Links**: [GitHub](https://github.com/mandip42/rir-mega-speech) | [Project Page](https://huggingface.co/datasets/mandipgoswami/rir-mega-speech)
...
## 20. [SketchDynamics: Exploring Free-Form Sketches for Dynamic Intent Expression in Animation Generation](https://huggingface.co/papers/2601.20622)

**ArXiv ID**: [2601.20622](https://arxiv.org/abs/2601.20622)
...
## 21. [GDCNet: Generative Discrepancy Comparison Network for Multimodal Sarcasm Detection](https://huggingface.co/papers/2601.20618)

**ArXiv ID**: [2601.20618](https://arxiv.org/abs/2601.20618)
...
**Published**: 2026-01-28 | **Submitted**: 2026-01-29 by Lian Junhong
...
## 22. [Shallow-π: Knowledge Distillation for Flow-based VLAs](https://huggingface.co/papers/2601.20262)

**ArXiv ID**: [2601.20262](https://arxiv.org/abs/2601.20262)

**Organization**: Samsung Research

**Authors**: Boseong Jeon, Yunho Choi, Taehan Kim

**Published**: 2026-01-28 | **Submitted**: 2026-01-29 by Boseong Jeon

**Upvotes**: 2

**Links**: [GitHub](https://github.com/icsl-Jeon/openpi) | [Project Page](https://icsl-jeon.github.io/shallow-pi/)
