# Daily Papers - 2026-01-26

> source: [Hugging Face Daily Papers](https://huggingface.co/papers/date/2026-01-26)
...
**ArXiv ID**: [2601.16725](https://arxiv.org/abs/2601.16725)
...
**Published**: 2026-01-23 | **Submitted**: 2026-01-26 by taesiri

**Upvotes**: 178

**Links**: [GitHub](https://github.com/meituan-longcat/LongCat-Flash-Thinking-2601) | [Project Page](https://github.com/meituan-longcat/LongCat-Flash-Thinking-2601)
...
**ArXiv ID**: [2601.16746](https://arxiv.org/abs/2601.16746)
...
**Links**: [GitHub](https://github.com/Ayanami1314/swe-pruner)
...
**ArXiv ID**: [2601.14133](https://arxiv.org/abs/2601.14133)
...
**Published**: 2026-01-20 | **Submitted**: 2026-01-26 by yubin

**Upvotes**: 61

**Links**: [GitHub](https://github.com/ZGC-EmbodyAI/TwinBrainVLA)
...
**ArXiv ID**: [2601.16973](https://arxiv.org/abs/2601.16973)

**Organization**: Sky Computing Lab
...
**Published**: 2026-01-23 | **Submitted**: 2026-01-26 by Zirui Wang

**Upvotes**: 40

**Links**: [GitHub](https://github.com/visgym/VIsGym) | [Project Page](https://visgym.github.io/)
...
**ArXiv ID**: [2601.16296](https://arxiv.org/abs/2601.16296)

**Organization**: Adobe

**Authors**: Dohun Lee, Chun-Hao Paul Huang, Xuelin Chen, Jong Chul Ye, Duygu Ceylan, Hyeonho Jeong

**Published**: 2026-01-22 | **Submitted**: 2026-01-26 by taesiri

**Upvotes**: 28

**Links**: [GitHub](https://github.com/DoHunLee1/Memory-V2V) | [Project Page](https://dohunlee1.github.io/MemoryV2V)
...
## 6. [Jet-RL: Enabling On-Policy FP8 Reinforcement Learning with Unified Training and Rollout Precision Flow](https://huggingface.co/papers/2601.14243)

**ArXiv ID**: [2601.14243](https://arxiv.org/abs/2601.14243)

**Organization**: NVIDIA

**Authors**: Haocheng Xi, Charlie Ruan, Peiyuan Liao, Yujun Lin, Han Cai, Yilong Zhao, Shuo Yang, Kurt Keutzer, Song Han, Ligeng Zhu

**Published**: 2026-01-20 | **Submitted**: 2026-01-26 by Haocheng Xi
...
## 7. [Inference-Time Scaling of Verification: Self-Evolving Deep Research Agents via Test-Time Rubric-Guided Verification](https://huggingface.co/papers/2601.15808)

**ArXiv ID**: [2601.15808](https://arxiv.org/abs/2601.15808)

**Organization**: Tencent

**Authors**: Yuxuan Wan, Tianqing Fang, Zaitang Li, Yintong Huo, Wenxuan Wang, Haitao Mi, Dong Yu, Michael R. Lyu

**Published**: 2026-01-22 | **Submitted**: 2026-01-26 by Tianqing Fang

**Upvotes**: 20

**Links**: [GitHub](https://github.com/yxwan123/DeepVerifier)
...
## 8. [Endless Terminals: Scaling RL Environments for Terminal Agents](https://huggingface.co/papers/2601.16443)

**ArXiv ID**: [2601.16443](https://arxiv.org/abs/2601.16443)
...
**Links**: [GitHub](https://github.com/kanishkg/endless-terminals)
...
## 9. [SALAD: Achieve High-Sparsity Attention via Efficient Linear Attention Tuning for Video Diffusion Transformer](https://huggingface.co/papers/2601.16515)

**ArXiv ID**: [2601.16515](https://arxiv.org/abs/2601.16515)
...
**Published**: 2026-01-23 | **Submitted**: 2026-01-26 by Tongcheng Fang
...
## 10. [Dancing in Chains: Strategic Persuasion in Academic Rebuttal via Theory of Mind](https://huggingface.co/papers/2601.15715)

**ArXiv ID**: [2601.15715](https://arxiv.org/abs/2601.15715)

**Organization**: HKUST

**Authors**: Zhitao He, Zongwei Lyu, Yi R Fung

**Published**: 2026-01-22 | **Submitted**: 2026-01-26 by Zhitao

**Upvotes**: 14

**Links**: [GitHub](https://github.com/Zhitao-He/RebuttalAgent) | [Project Page](https://github.com/Zhitao-He/RebuttalAgent)
...
## 11. [GameTalk: Training LLMs for Strategic Conversation](https://huggingface.co/papers/2601.16276)

**ArXiv ID**: [2601.16276](https://arxiv.org/abs/2601.16276)

**Organization**: University of Cambridge

**Authors**: Victor Conchello Vendrell, Max Ruiz Luyten, Mihaela van der Schaar

**Published**: 2026-01-22 | **Submitted**: 2026-01-26 by Max Ruiz Luyten
...
## 12. [DSGym: A Holistic Framework for Evaluating and Training Data Science Agents](https://huggingface.co/papers/2601.16344)

**ArXiv ID**: [2601.16344](https://arxiv.org/abs/2601.16344)
...
**Links**: [GitHub](https://github.com/fannie1208/DSGym)
...
## 13. [ChartVerse: Scaling Chart Reasoning via Reliable Programmatic Synthesis from Scratch](https://huggingface.co/papers/2601.13606)

**ArXiv ID**: [2601.13606](https://arxiv.org/abs/2601.13606)
...
**Published**: 2026-01-20 | **Submitted**: 2026-01-26 by Lijun Wu

**Upvotes**: 11

**Links**: [GitHub](https://github.com/starriver030515/ChartVerse) | [Project Page](https://chartverse.github.io/)
...
## 14. [MeepleLM: A Virtual Playtester Simulating Diverse Subjective Experiences](https://huggingface.co/papers/2601.07251)

**ArXiv ID**: [2601.07251](https://arxiv.org/abs/2601.07251)
...
**Published**: 2026-01-12 | **Submitted**: 2026-01-26 by kaipeng

**Upvotes**: 11

**Links**: [GitHub](https://github.com/leroy9472/MeepleLM)
...
## 15. [Knowledge is Not Enough: Injecting RL Skills for Continual Adaptation](https://huggingface.co/papers/2601.11258)

**ArXiv ID**: [2601.11258](https://arxiv.org/abs/2601.11258)

**Organization**: Peking University

**Authors**: Pingzhi Tang, Yiding Wang, Muhan Zhang

**Published**: 2026-01-16 | **Submitted**: 2026-01-26 by Stanley Tang
...
## 16. [Mecellem Models: Turkish Models Trained from Scratch and Continually Pre-trained for the Legal Domain](https://huggingface.co/papers/2601.16018)

**ArXiv ID**: [2601.16018](https://arxiv.org/abs/2601.16018)
...
**Published**: 2026-01-22 | **Submitted**: 2026-01-26 by Özgür UĞUR

**Upvotes**: 7

**Links**: [GitHub](https://github.com/newmindai/mecellem-models)
...
## 17. [VISTA-PATH: An interactive foundation model for pathology image segmentation and quantitative analysis in computational pathology](https://huggingface.co/papers/2601.16451)

**ArXiv ID**: [2601.16451](https://arxiv.org/abs/2601.16451)

**Organization**: Zhi Huang Lab

**Authors**: Peixian Liang, Songhao Li, Shunsuke Koga, Yutong Li, Zahra Alipour, Yucheng Tang, Daguang Xu, Zhi Huang

**Published**: 2026-01-23 | **Submitted**: 2026-01-26 by Zhi Huang

**Upvotes**: 3

**Links**: [GitHub](https://github.com/zhihuanglab/VISTA-PATH) | [Project Page](https://tissuelab.org)
...
## 18. [Guidelines to Prompt Large Language Models for Code Generation: An Empirical Characterization](https://huggingface.co/papers/2601.13118)
...
**Published**: 2026-01-19 | **Submitted**: 2026-01-26 by Alessandro
