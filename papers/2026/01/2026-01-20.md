# Daily Papers - 2026-01-20

> source: [Hugging Face Daily Papers](https://huggingface.co/papers/date/2026-01-20)
...
**ArXiv ID**: [2601.11077](https://arxiv.org/abs/2601.11077)
...
**Published**: 2026-01-16 | **Submitted**: 2026-01-20 by yangjie

**Upvotes**: 65

**Links**: [GitHub](https://github.com/OpenMOSS/ABC-Bench) | [Project Page](https://dawning-road.github.io/blog/abc-bench)
...
**ArXiv ID**: [2601.08808](https://arxiv.org/abs/2601.08808)

**Organization**: Microsoft Research

**Authors**: Yao Tang, Li Dong, Yaru Hao, Qingxiu Dong, Furu Wei, Jiatao Gu

**Published**: 2026-01-13 | **Submitted**: 2026-01-20 by Li Dong

**Upvotes**: 39

**Links**: [GitHub](https://github.com/GMLR-Penn/Multiplex-Thinking) | [Project Page](https://gmlr-penn.github.io/Multiplex-Thinking/)
...
## 3. [NAACL: Noise-AwAre Verbal Confidence Calibration for LLMs in RAG Systems](https://huggingface.co/papers/2601.11004)

**ArXiv ID**: [2601.11004](https://arxiv.org/abs/2601.11004)
...
**Published**: 2026-01-16 | **Submitted**: 2026-01-20 by Jeff

**Upvotes**: 30

**Links**: [GitHub](https://github.com/HKUST-KnowComp/NAACL)
...
## 4. [Medical SAM3: A Foundation Model for Universal Prompt-Driven Medical Image Segmentation](https://huggingface.co/papers/2601.10880)

**ArXiv ID**: [2601.10880](https://arxiv.org/abs/2601.10880)
...
**Published**: 2026-01-15 | **Submitted**: 2026-01-20 by ChongCongJiang

**Upvotes**: 15

**Links**: [GitHub](https://github.com/AIM-Research-Lab/Medical-SAM3) | [Project Page](https://chongcongjiang.github.io/MedicalSAM3/)
...
**ArXiv ID**: [2601.10387](https://arxiv.org/abs/2601.10387)

**Authors**: Christina Lu, Jack Gallagher, Jonathan Michala, Kyle Fish, Jack Lindsey

**Published**: 2026-01-15 | **Submitted**: 2026-01-20 by taesiri

**Upvotes**: 15

**Links**: [GitHub](https://github.com/safety-research/assistant-axis)
...
## 6. [PubMed-OCR: PMC Open Access OCR Annotations](https://huggingface.co/papers/2601.11425)

**ArXiv ID**: [2601.11425](https://arxiv.org/abs/2601.11425)

**Organization**: Roots.AI

**Authors**: Hunter Heidenreich, Yosheb Getachew, Olivia Dinica, Ben Elliott

**Published**: 2026-01-16 | **Submitted**: 2026-01-20 by Hunter Heidenreich
...
## 7. [CoDance: An Unbind-Rebind Paradigm for Robust Multi-Subject Animation](https://huggingface.co/papers/2601.11096)

**ArXiv ID**: [2601.11096](https://arxiv.org/abs/2601.11096)

**Authors**: Shuai Tan, Biao Gong, Ke Ma, Yutong Feng, Yan Wang, Yujun Shen, Hengshuang Zhao

**Published**: 2026-01-16 | **Submitted**: 2026-01-20 by Biao Gong

**Upvotes**: 8

**Links**: [Project Page](https://lucaria-academy.github.io/CoDance/)
...
## 8. [YaPO: Learnable Sparse Activation Steering Vectors for Domain Adaptation](https://huggingface.co/papers/2601.08441)

**ArXiv ID**: [2601.08441](https://arxiv.org/abs/2601.08441)
...
**Published**: 2026-01-13 | **Submitted**: 2026-01-20 by Abdelaziz Bounhar

**Upvotes**: 8

**Links**: [GitHub](https://github.com/MBZUAI-Paris/YaPO) | [Project Page](https://mbzuai-paris.github.io/YaPO/)
...
## 9. [Spurious Rewards Paradox: Mechanistically Understanding How RLVR Activates Memorization Shortcuts in LLMs](https://huggingface.co/papers/2601.11061)

**ArXiv ID**: [2601.11061](https://arxiv.org/abs/2601.11061)

**Authors**: Lecheng Yan, Ruizhe Li, Guanhua Chen, Qing Li, Jiahui Geng, Wenxi Li, Vincent Wang, Chris Lee

**Published**: 2026-01-16 | **Submitted**: 2026-01-20 by Ruizhe Li

**Upvotes**: 7

**Links**: [GitHub](https://github.com/idwts/How-RLVR-Activates-Memorization-Shortcuts)
...
## 10. [SIN-Bench: Tracing Native Evidence Chains in Long-Context Multimodal Scientific Interleaved Literature](https://huggingface.co/papers/2601.10108)

**ArXiv ID**: [2601.10108](https://arxiv.org/abs/2601.10108)
...
**Published**: 2026-01-15 | **Submitted**: 2026-01-20 by wangjunjie

**Upvotes**: 7

**Links**: [GitHub](https://github.com/IIGROUP/sin-bench)
...
## 11. [CLARE: Continual Learning for Vision-Language-Action Models via Autonomous Adapter Routing and Expansion](https://huggingface.co/papers/2601.09512)

**ArXiv ID**: [2601.09512](https://arxiv.org/abs/2601.09512)

**Organization**: Technical University of Munich

**Authors**: Ralf Römer, Yi Zhang, Angela P. Schoellig

**Published**: 2026-01-14 | **Submitted**: 2026-01-20 by Ralf Römer

**Upvotes**: 4

**Links**: [GitHub](https://github.com/utiasDSL/clare) | [Project Page](https://tum-lsy.github.io/clare/)
