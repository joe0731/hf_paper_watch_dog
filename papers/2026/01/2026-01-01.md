# Daily Papers - 2026-01-01

> source: [Hugging Face Daily Papers](https://huggingface.co/papers/date/2026-01-01)
...
**Published**: 2025-12-31 | **Submitted**: 2026-01-01 by Adina Yakefu
...
**ArXiv ID**: [2512.24618](https://arxiv.org/abs/2512.24618)

**Organization**: Tencent

**Authors**: Junru Lu, Jiarui Qin, Lingfeng Qiao, Yinghui Li, Xinyi Dai, Bo Ke, Jianfeng He, Ruizhi Qiao, Di Yin, Xing Sun, Yunsheng Wu, Yinsong Liu, Shuangyin Liu, Mingkong Tang, Haodong Lin, Jiayi Kuang, Fanxu Meng, Xiaojuan Tang, Yunjia Xi, Junjie Huang, Haotong Yang, Zhenyi Shen, Yangning Li, Qianwen Zhang, Yifei Yu, Junnan Dong, Qiufeng Wang, Jie Wang, Keyu Chen, Wei Wen, Taian Guo, Zhifeng Shen, Daohai Yu, Jiahao Li, Ke Li, Zongyi Li, Xiaoyu Tan

**Published**: 2025-12-31 | **Submitted**: 2026-01-01 by taesiri

**Upvotes**: 152

**Links**: [GitHub](https://github.com/TencentCloudADP/youtu-tip) | [Project Page](https://youtu-tip.com/#llm)
...
**ArXiv ID**: [2512.24873](https://arxiv.org/abs/2512.24873)
...
**Links**: [GitHub](https://github.com/alibaba/ROLL)
...
## 4. [A unified framework for detecting point and collective anomalies in operating system logs via collaborative transformers](https://huggingface.co/papers/2512.23380)

**ArXiv ID**: [2512.23380](https://arxiv.org/abs/2512.23380)

**Organization**: Alarmif

**Authors**: Mohammad Nasirzadeh, Jafar Tahmoresnezhad, Parviz Rashidi-Khazaee

**Published**: 2025-12-29 | **Submitted**: 2026-01-01 by Mohammad Nasirzadeh

**Upvotes**: 44

**Links**: [GitHub](https://github.com/NasirzadehMoh/CoLog) | [Project Page](https://www.alarmif.com)
...
## 5. [GaMO: Geometry-aware Multi-view Diffusion Outpainting for Sparse-View 3D Reconstruction](https://huggingface.co/papers/2512.25073)

**ArXiv ID**: [2512.25073](https://arxiv.org/abs/2512.25073)

**Authors**: Yi-Chuan Huang, Hao-Jen Chien, Chin-Yang Lin, Ying-Huan Chen, Yu-Lun Liu

**Published**: 2025-12-31 | **Submitted**: 2026-01-01 by Yu-Lun Liu

**Upvotes**: 41

**Links**: [GitHub](https://github.com/yichuanH/GaMO_official) | [Project Page](https://yichuanh.github.io/GaMO/)
...
## 6. [AI Meets Brain: Memory Systems from Cognitive Neuroscience to Autonomous Agents](https://huggingface.co/papers/2512.23343)

**ArXiv ID**: [2512.23343](https://arxiv.org/abs/2512.23343)
...
**Published**: 2025-12-29 | **Submitted**: 2026-01-01 by Zekun Wang

**Upvotes**: 29

**Links**: [GitHub](https://github.com/AgentMemory/Huaman-Agent-Memory)
...
## 7. [Pretraining Frame Preservation in Autoregressive Video Memory Compression](https://huggingface.co/papers/2512.23851)

**ArXiv ID**: [2512.23851](https://arxiv.org/abs/2512.23851)

**Authors**: Lvmin Zhang, Shengqu Cai, Muyang Li, Chong Zeng, Beijia Lu, Anyi Rao, Song Han, Gordon Wetzstein, Maneesh Agrawala

**Published**: 2025-12-29 | **Submitted**: 2026-01-01 by Lvmin Zhang
...
## 8. [GR-Dexter Technical Report](https://huggingface.co/papers/2512.24210)

**ArXiv ID**: [2512.24210](https://arxiv.org/abs/2512.24210)
...
**Published**: 2025-12-30 | **Submitted**: 2026-01-01 by Xiao Ma

**Upvotes**: 22

**Links**: [Project Page](https://byte-dexter.github.io/gr-dexter/)
...
## 9. [PhyGDPO: Physics-Aware Groupwise Direct Preference Optimization for Physically Consistent Text-to-Video Generation](https://huggingface.co/papers/2512.24551)

**ArXiv ID**: [2512.24551](https://arxiv.org/abs/2512.24551)
...
**Published**: 2025-12-31 | **Submitted**: 2026-01-01 by Yuanhao Cai

**Upvotes**: 21

**Links**: [GitHub](https://github.com/caiyuanhao1998/Open-PhyGDPO) | [Project Page](https://caiyuanhao1998.github.io/project/PhyGDPO/)
...
## 10. [Scaling Open-Ended Reasoning to Predict the Future](https://huggingface.co/papers/2512.25070)
...
**Published**: 2025-12-31 | **Submitted**: 2026-01-01 by Shashwat Goel

**Upvotes**: 20

**Links**: [GitHub](https://github.com/OpenForecaster/scaling-forecasting-training) | [Project Page](https://www.openforecaster.github.io)
...
## 11. [JavisGPT: A Unified Multi-modal LLM for Sounding-Video Comprehension and Generation](https://huggingface.co/papers/2512.22905)

**ArXiv ID**: [2512.22905](https://arxiv.org/abs/2512.22905)
...
**Published**: 2025-12-28 | **Submitted**: 2026-01-01 by KAI LIU

**Upvotes**: 20

**Links**: [GitHub](https://github.com/JavisVerse/JavisGPT) | [Project Page](https://javisverse.github.io/JavisGPT-page/)
...
## 12. [Fantastic Reasoning Behaviors and Where to Find Them: Unsupervised Discovery of the Reasoning Process](https://huggingface.co/papers/2512.23988)

**ArXiv ID**: [2512.23988](https://arxiv.org/abs/2512.23988)
...
**Published**: 2025-12-30 | **Submitted**: 2026-01-01 by taesiri
...
## 13. [SpaceTimePilot: Generative Rendering of Dynamic Scenes Across Space and Time](https://huggingface.co/papers/2512.25075)
...
**Links**: [GitHub](https://github.com/ZheningHuang/SpaceTimePilot) | [Project Page](https://zheninghuang.github.io/Space-Time-Pilot/)
...
## 14. [Forging Spatial Intelligence: A Roadmap of Multi-Modal Data Pre-Training for Autonomous Systems](https://huggingface.co/papers/2512.24385)

**ArXiv ID**: [2512.24385](https://arxiv.org/abs/2512.24385)

**Organization**: Zhejiang University

**Authors**: Song Wang, Lingdong Kong, Xiaolu Liu, Hao Shi, Wentong Li, Jianke Zhu, Steven C. H. Hoi

**Published**: 2025-12-30 | **Submitted**: 2026-01-01 by Song Wang

**Upvotes**: 8

**Links**: [GitHub](https://github.com/worldbench/awesome-spatial-intelligence)
...
## 15. [Guiding a Diffusion Transformer with the Internal Dynamics of Itself](https://huggingface.co/papers/2512.24176)

**ArXiv ID**: [2512.24176](https://arxiv.org/abs/2512.24176)

**Organization**: CVL-UESTC

**Authors**: Xingyu Zhou, Qifan Li, Xiaobin Hu, Hai Chen, Shuhang Gu

**Published**: 2025-12-30 | **Submitted**: 2026-01-01 by xingyu zhou

**Upvotes**: 8

**Links**: [GitHub](https://github.com/CVL-UESTC/Internal-Guidance) | [Project Page](https://zhouxingyu13.github.io/Internal-Guidance/)
...
## 16. [Factorized Learning for Temporally Grounded Video-Language Models](https://huggingface.co/papers/2512.24097)

**ArXiv ID**: [2512.24097](https://arxiv.org/abs/2512.24097)

**Organization**: National University of Singapore

**Authors**: Wenzheng Zeng, Difei Gao, Mike Zheng Shou, Hwee Tou Ng

**Published**: 2025-12-30 | **Submitted**: 2026-01-01 by Wenzheng Zeng

**Upvotes**: 7

**Links**: [GitHub](https://github.com/nusnlp/d2vlm) | [Project Page](https://github.com/nusnlp/d2vlm)
...
## 17. [Geometry-Aware Optimization for Respiratory Sound Classification: Enhancing Sensitivity with SAM-Optimized Audio Spectrogram Transformers](https://huggingface.co/papers/2512.22564)

**ArXiv ID**: [2512.22564](https://arxiv.org/abs/2512.22564)

**Authors**: Atakan Işık, Selin Vulga Işık, Ahmet Feridun Işık, Mahşuk Taylan

**Published**: 2025-12-27 | **Submitted**: 2026-01-01 by Işık

**Upvotes**: 7

**Links**: [GitHub](https://github.com/Atakanisik/ICBHI-AST-SAM)
...
## 18. [Figure It Out: Improving the Frontier of Reasoning with Active Visual Thinking](https://huggingface.co/papers/2512.24297)

**ArXiv ID**: [2512.24297](https://arxiv.org/abs/2512.24297)
...
**Links**: [GitHub](https://github.com/chenmeiqii/FIGR)
...
## 19. [BEDA: Belief Estimation as Probabilistic Constraints for Performing Strategic Dialogue Acts](https://huggingface.co/papers/2512.24885)

**ArXiv ID**: [2512.24885](https://arxiv.org/abs/2512.24885)
...
**Published**: 2025-12-31 | **Submitted**: 2026-01-01 by Li
...
## 20. [Valori: A Deterministic Memory Substrate for AI Systems](https://huggingface.co/papers/2512.22280)

**ArXiv ID**: [2512.22280](https://arxiv.org/abs/2512.22280)

**Authors**: Varshith Gudur

**Published**: 2025-12-25 | **Submitted**: 2026-01-01 by Varshith

**Upvotes**: 5

**Links**: [GitHub](https://github.com/varshith-Git/Valori-Kernel) | [Project Page](https://valori.systems/)
