...
> source: [Hugging Face Daily Papers](https://huggingface.co/papers/date/2026-06-26)
...
**ArXiv ID**: [2606.27377](https://arxiv.org/abs/2606.27377)
...
**Published**: 2026-06-25 | **Submitted**: 2026-06-26 by taesiri

**Upvotes**: 45

**Links**: [Project Page](https://danceopd.github.io/)
...
**ArXiv ID**: [2606.27313](https://arxiv.org/abs/2606.27313)
...
**Published**: 2026-06-25 | **Submitted**: 2026-06-26 by liuzuyan

**Upvotes**: 34

**Links**: [GitHub](https://github.com/yuxumin/ViQ)
...
**ArXiv ID**: [2606.26907](https://arxiv.org/abs/2606.26907)
...
**ArXiv ID**: [2606.26790](https://arxiv.org/abs/2606.26790)
...
**Published**: 2026-06-25 | **Submitted**: 2026-06-26 by Jinyang Wu

**Upvotes**: 26

**Links**: [GitHub](https://github.com/jinyangwu/OPID)
...
**ArXiv ID**: [2606.26300](https://arxiv.org/abs/2606.26300)
...
**Published**: 2026-06-24 | **Submitted**: 2026-06-26 by zjj
...
## 6. [JetSpec: Breaking the Scaling Ceiling of Speculative Decoding with Parallel Tree Drafting](https://huggingface.co/papers/2606.18394)

**ArXiv ID**: [2606.18394](https://arxiv.org/abs/2606.18394)
...
**Published**: 2026-06-25 | **Submitted**: 2026-06-26 by Lanxiang Hu

**Upvotes**: 17

**Links**: [GitHub](https://github.com/hao-ai-lab/JetSpec) | [Project Page](https://jetspec-project.github.io/jetspec-web/)
...
## 7. [Why Multi-Step Tool-Use Reinforcement Learning Collapses and How Supervisory Signals Fix It](https://huggingface.co/papers/2606.26027)

**ArXiv ID**: [2606.26027](https://arxiv.org/abs/2606.26027)
...
**Published**: 2026-06-24 | **Submitted**: 2026-06-26 by Zhuoran Jin

**Upvotes**: 10

**Links**: [GitHub](https://github.com/hypasd-art/Tool-RL-Box)
...
**ArXiv ID**: [2606.24551](https://arxiv.org/abs/2606.24551)

**Authors**: Xiao Zhou, Siyue Zhang, Yilun Zhao, Jinbiao Wei, Tingyu Song, Arman Cohan, Chen Zhao

**Published**: 2026-06-22 | **Submitted**: 2026-06-26 by Xiao Zhou

**Upvotes**: 6

**Links**: [GitHub](https://github.com/rebeccaz4/gui-vs-cli)
...
## 9. [Confidence-Aware Tool Orchestration for Robust Video Understanding](https://huggingface.co/papers/2606.26904)

**ArXiv ID**: [2606.26904](https://arxiv.org/abs/2606.26904)

**Organization**: Nanyang Technological University Singapore

**Authors**: Yangfan He, Yujin Choi, Jaehong Yoon

**Published**: 2026-06-25 | **Submitted**: 2026-06-26 by Jaehong Yoon

**Upvotes**: 5

**Links**: [GitHub](https://github.com/ROVA-V2/Robust-TO) | [Project Page](https://rova-v2.github.io/)
...
## 10. [In-Context World Modeling for Robotic Control](https://huggingface.co/papers/2606.26025)
...
**Published**: 2026-06-25 | **Submitted**: 2026-06-26 by Siyin Wang (SII)
...
## 11. [CoffeeBench: Benchmarking Long-Horizon LLM Agents in Heterogeneous Multi-Agent Economies](https://huggingface.co/papers/2606.16613)

**ArXiv ID**: [2606.16613](https://arxiv.org/abs/2606.16613)

**Authors**: Issa Sugiura, Daichi Hattori, Kazuo Araragi, Keita Ogawa, Shota Onose, Taro Makino, Teppei Usuki, Takashi Ishida

**Published**: 2026-06-15 | **Submitted**: 2026-06-26 by Issa Sugiura

**Upvotes**: 3

**Links**: [GitHub](https://github.com/SakanaAI/CoffeeBench) | [Project Page](https://pub.sakana.ai/coffeebench/index.html)
...
## 12. [Fast LeWorldModel](https://huggingface.co/papers/2606.26217)

**ArXiv ID**: [2606.26217](https://arxiv.org/abs/2606.26217)

**Authors**: Yuntian Gao, Xiangyu Xu

**Published**: 2026-06-24 | **Submitted**: 2026-06-26 by taesiri

**Upvotes**: 2

**Links**: [GitHub](https://github.com/Yuntian-Gao/Fast-LeWorldModel)
...
## 13. [Discretizing Reward Models](https://huggingface.co/papers/2606.21795)

**ArXiv ID**: [2606.21795](https://arxiv.org/abs/2606.21795)
...
**Published**: 2026-06-19 | **Submitted**: 2026-06-26 by Vijay Viswanathan
...
## 14. [PhysiFormer: Learning to Simulate Mechanics in World Space](https://huggingface.co/papers/2606.27364)

**ArXiv ID**: [2606.27364](https://arxiv.org/abs/2606.27364)
...
**Links**: [Project Page](https://yimingc9.github.io/physiformer)
...
**ArXiv ID**: [2606.21959](https://arxiv.org/abs/2606.21959)

**Authors**: Minbyul Jeong

**Published**: 2026-06-20 | **Submitted**: 2026-06-26 by Minbyul Jeong

**Upvotes**: 1

**Links**: [GitHub](https://github.com/minstar/healthcare-research) | [Project Page](https://minstar.github.io/OpenBioRQ/)
...
**Published**: 2026-06-25 | **Submitted**: 2026-06-26 by Nicklas Hansen

**Upvotes**: 0

**Links**: [GitHub](https://github.com/nicklashansen/mmbench2) | [Project Page](https://www.nicklashansen.com/mmbench2)
...
## 17. [COrigami: An AI Pipeline for Co-Designing Flat-Foldable Visually Recognisable Origami](https://huggingface.co/papers/2606.26299)

**ArXiv ID**: [2606.26299](https://arxiv.org/abs/2606.26299)
...
## 18. [How Post-Training Shapes Biological Reasoning Models](https://huggingface.co/papers/2606.16517)

**ArXiv ID**: [2606.16517](https://arxiv.org/abs/2606.16517)

**Authors**: Lukas Fesser, Hanlin Zhang, Michelle M. Li, Eric Wang, Bryan Perozzi, Shekoofeh Azizi, Sham M. Kakade, Marinka Zitnik

**Published**: 2026-06-15 | **Submitted**: 2026-06-26 by hlzhang109
