# Daily Papers - 2026-05-07

> source: [Hugging Face Daily Papers](https://huggingface.co/papers/date/2026-05-07)
...
**ArXiv ID**: [2605.03849](https://arxiv.org/abs/2605.03849)

**Organization**: FrameX-AI

**Authors**: Bin Wu, Mengqi Huang, Shaojin Wu, Weinan Jia, Yuxin Wang, Zhendong Mao, Yongdong Zhang

**Published**: 2026-05-05 | **Submitted**: 2026-05-07 by Mengqi Huang

**Upvotes**: 98

**Links**: [GitHub](https://github.com/FrameX-AI/Stream-R1) | [Project Page](https://stream-r1.github.io/)
...
**Published**: 2026-05-06 | **Submitted**: 2026-05-07 by Mengqi Huang

**Upvotes**: 86

**Links**: [GitHub](https://github.com/FrameX-AI/Stream-T1) | [Project Page](https://stream-t1.github.io/)
...
## 3. [RLDX-1 Technical Report](https://huggingface.co/papers/2605.03269)

**ArXiv ID**: [2605.03269](https://arxiv.org/abs/2605.03269)
...
**Published**: 2026-05-05 | **Submitted**: 2026-05-07 by Huiwon Jang

**Upvotes**: 69

**Links**: [GitHub](https://github.com/RLWRLD/RLDX-1) | [Project Page](http://rlwrld.ai/rldx-1)
...
## 4. [HERMES++: Toward a Unified Driving World Model for 3D Scene Understanding and Generation](https://huggingface.co/papers/2604.28196)

**ArXiv ID**: [2604.28196](https://arxiv.org/abs/2604.28196)

**Organization**: H-EmbodVis

**Authors**: Xin Zhou, Dingkang Liang, Xiwu Chen, Feiyang Tan, Dingyuan Zhang, Hengshuang Zhao, Xiang Bai

**Published**: 2026-04-30 | **Submitted**: 2026-05-07 by Xin Zhou

**Upvotes**: 63

**Links**: [GitHub](https://github.com/H-EmbodVis/HERMESV2) | [Project Page](https://h-embodvis.github.io/HERMESV2/)
...
## 5. [PhysForge: Generating Physics-Grounded 3D Assets for Interactive Virtual World](https://huggingface.co/papers/2605.05163)

**ArXiv ID**: [2605.05163](https://arxiv.org/abs/2605.05163)

**Authors**: Yunhan Yang, Chunshi Wang, Junliang Ye, Yang Li, Zanxin Chen, Zehuan Huang, Yao Mu, Zhuo Chen, Chunchao Guo, Xihui Liu

**Published**: 2026-05-06 | **Submitted**: 2026-05-07 by Yunhan Yang

**Upvotes**: 23

**Links**: [GitHub](https://github.com/HKU-MMLab/PhysForge) | [Project Page](https://hku-mmlab.github.io/PhysForge/)
...
## 6. [D-OPSD: On-Policy Self-Distillation for Continuously Tuning Step-Distilled Diffusion Models](https://huggingface.co/papers/2605.05204)
...
**Published**: 2026-05-06 | **Submitted**: 2026-05-07 by Dengyang Jiang

**Upvotes**: 18

**Links**: [GitHub](https://github.com/vvvvvjdy/D-OPSD) | [Project Page](https://vvvvvjdy.github.io/d-opsd/)
...
**Published**: 2026-05-06 | **Submitted**: 2026-05-07 by Kong

**Upvotes**: 15

**Links**: [GitHub](https://github.com/shawn0728/OpenSearch-VL) | [Project Page](https://huggingface.co/OpenSearch-VL)
...
## 8. [Rethinking Reasoning-Intensive Retrieval: Evaluating and Advancing Retrievers in Agentic Search Systems](https://huggingface.co/papers/2605.04018)
...
**Published**: 2026-05-05 | **Submitted**: 2026-05-07 by Yilun Zhao

**Upvotes**: 13

**Links**: [GitHub](https://github.com/yale-nlp/Bright-Pro)
...
**Published**: 2026-05-06 | **Submitted**: 2026-05-07 by taesiri
...
**ArXiv ID**: [2605.04128](https://arxiv.org/abs/2605.04128)
...
**Published**: 2026-05-05 | **Submitted**: 2026-05-07 by taesiri

**Upvotes**: 4

**Links**: [GitHub](https://github.com/jd-opensource/JoyAI-Image)
...
## 11. [Parameter-Efficient Multi-View Proficiency Estimation: From Discriminative Classification to Generative Feedback](https://huggingface.co/papers/2605.03848)

**ArXiv ID**: [2605.03848](https://arxiv.org/abs/2605.03848)

**Authors**: Edoardo Bianchi, Antonio Liotta

**Published**: 2026-05-05 | **Submitted**: 2026-05-07 by Edoardo Bianchi
...
## 12. [APEX: Large-scale Multi-task Aesthetic-Informed Popularity Prediction for AI-Generated Music](https://huggingface.co/papers/2605.03395)

**ArXiv ID**: [2605.03395](https://arxiv.org/abs/2605.03395)

**Organization**: AMAAI Lab

**Authors**: Jaavid Aktar Husain, Dorien Herremans

**Published**: 2026-05-05 | **Submitted**: 2026-05-07 by Dorien Herremans

**Upvotes**: 2

**Links**: [GitHub](https://github.com/AMAAI-Lab/apex)
...
## 13. [ResRL: Boosting LLM Reasoning via Negative Sample Projection Residual Reinforcement Learning](https://huggingface.co/papers/2605.00380)

**ArXiv ID**: [2605.00380](https://arxiv.org/abs/2605.00380)
...
**Published**: 2026-05-01 | **Submitted**: 2026-05-07 by zihan

**Upvotes**: 2

**Links**: [GitHub](https://github.com/1229095296/ResRL)
...
## 14. [MedSkillAudit: A Domain-Specific Audit Framework for Medical Research Agent Skills](https://huggingface.co/papers/2604.20441)

**ArXiv ID**: [2604.20441](https://arxiv.org/abs/2604.20441)
...
**Published**: 2026-04-22 | **Submitted**: 2026-05-07 by Huimei Wang

**Upvotes**: 2

**Links**: [GitHub](https://github.com/aipoch/medical-research-skills)
...
## 15. [When to Think, When to Speak: Learning Disclosure Policies for LLM Reasoning](https://huggingface.co/papers/2605.03314)

**ArXiv ID**: [2605.03314](https://arxiv.org/abs/2605.03314)

**Authors**: Jiaqi Wei, Xuehang Guo, Pengfei Yu, Xiang Zhang, Wanli Ouyang, Siqi Sun, Qingyun Wang, Chenyu You

**Published**: 2026-05-06 | **Submitted**: 2026-05-07 by Jiaqi Wei
...
## 16. [Diffusion Model as a Generalist Segmentation Learner](https://huggingface.co/papers/2604.24575)

**ArXiv ID**: [2604.24575](https://arxiv.org/abs/2604.24575)
...
**Published**: 2026-04-27 | **Submitted**: 2026-05-07 by Weijie Wang
