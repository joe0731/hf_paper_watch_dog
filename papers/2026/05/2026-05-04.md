# Daily Papers - 2026-05-04

> source: [Hugging Face Daily Papers](https://huggingface.co/papers/date/2026-05-04)
...
**ArXiv ID**: [2605.00658](https://arxiv.org/abs/2605.00658)
...
**Published**: 2026-05-01 | **Submitted**: 2026-05-04 by taesiri

**Upvotes**: 61

**Links**: [GitHub](https://github.com/houyuanchen111/UniVidX) | [Project Page](https://houyuanchen111.github.io/UniVidX.github.io/)
...
## 2. [Learning while Deploying: Fleet-Scale Reinforcement Learning for Generalist Robot Policies](https://huggingface.co/papers/2605.00416)

**ArXiv ID**: [2605.00416](https://arxiv.org/abs/2605.00416)
...
**Published**: 2026-05-01 | **Submitted**: 2026-05-04 by Jianlan Luo
...
## 3. [From Skill Text to Skill Structure: The Scheduling-Structural-Logical Representation for Agent Skills](https://huggingface.co/papers/2604.24026)

**ArXiv ID**: [2604.24026](https://arxiv.org/abs/2604.24026)

**Organization**: Peking University

**Authors**: Qiliang Liang, Hansi Wang, Zhong Liang, Yang Liu

**Published**: 2026-04-27 | **Submitted**: 2026-05-04 by Liang Qiliang
...
## 4. [Map2World: Segment Map Conditioned Text to 3D World Generation](https://huggingface.co/papers/2605.00781)

**ArXiv ID**: [2605.00781](https://arxiv.org/abs/2605.00781)
...
**Links**: [Project Page](https://robot0321.github.io/Map2World/index.html)
...
## 5. [End-to-End Autoregressive Image Generation with 1D Semantic Tokenizer](https://huggingface.co/papers/2605.00503)

**ArXiv ID**: [2605.00503](https://arxiv.org/abs/2605.00503)
...
**ArXiv ID**: [2605.00809](https://arxiv.org/abs/2605.00809)
...
**Links**: [GitHub](https://github.com/YanFangCS/GenLIP) | [Project Page](https://yanfangcs.github.io/vitspeak/)
...
## 7. [Web2BigTable: A Bi-Level Multi-Agent LLM System for Internet-Scale Information Search and Extraction](https://huggingface.co/papers/2604.27221)

**ArXiv ID**: [2604.27221](https://arxiv.org/abs/2604.27221)

**Authors**: Yuxuan Huang, Yihang Chen, Zhiyuan He, Yuxiang Chen, Ka Yiu Lee, Huichi Zhou, Weilin Luo, Meng Fang, Jun Wang

**Published**: 2026-04-29 | **Submitted**: 2026-05-04 by HuichiZhou

**Upvotes**: 2

**Links**: [GitHub](https://github.com/web2bigtable/web2bigtable)
...
## 8. [Online Self-Calibration Against Hallucination in Vision-Language Models](https://huggingface.co/papers/2605.00323)

**ArXiv ID**: [2605.00323](https://arxiv.org/abs/2605.00323)

**Authors**: Minghui Chen, Chenxu Yang, Hengjie Zhu, Dayan Wu, Zheng Lin, Qingyi Si

**Published**: 2026-05-01 | **Submitted**: 2026-05-04 by steven young
...
## 9. [Learning to Act and Cooperate for Distributed Black-Box Consensus Optimization](https://huggingface.co/papers/2605.00691)

**ArXiv ID**: [2605.00691](https://arxiv.org/abs/2605.00691)

**Authors**: Zi-Bo Qin, Feng-Feng Wei, Tai-You Chen, Wei-Neng Chen

**Published**: 2026-05-01 | **Submitted**: 2026-05-04 by Rajkumar rawal
...
## 10. [LASE: Language-Adversarial Speaker Encoding for Indic Cross-Script Identity Preservation](https://huggingface.co/papers/2605.00777)

**ArXiv ID**: [2605.00777](https://arxiv.org/abs/2605.00777)

**Organization**: Praxel

**Authors**: Venkata Pushpak Teja Menta

**Published**: 2026-05-01 | **Submitted**: 2026-05-04 by Venkata Pushpak Teja Menta

**Upvotes**: 1

**Links**: [GitHub](https://github.com/praxelhq/lase) | [Project Page](https://github.com/praxelhq/lase)
...
## 11. [AnalogRetriever: Learning Cross-Modal Representations for Analog Circuit Retrieval](https://huggingface.co/papers/2604.23195)

**ArXiv ID**: [2604.23195](https://arxiv.org/abs/2604.23195)

**Authors**: Yihan Wang, Lei Li, Yao Lai, Jing Wang, Yan Lu

**Published**: 2026-04-25 | **Submitted**: 2026-05-04 by Lei Li
...
## 12. [Themis: Training Robust Multilingual Code Reward Models for Flexible Multi-Criteria Scoring](https://huggingface.co/papers/2605.00754)

**ArXiv ID**: [2605.00754](https://arxiv.org/abs/2605.00754)

**Organization**: Themis

**Authors**: Indraneil Paul, Glavaš Glavas, Iryna Gurevych

**Published**: 2026-05-01 | **Submitted**: 2026-05-04 by Indraneil Paul

**Upvotes**: 0

**Links**: [GitHub](https://github.com/iNeil77/Themis)
...
## 13. [Talker-T2AV: Joint Talking Audio-Video Generation with Autoregressive Diffusion Modeling](https://huggingface.co/papers/2604.23586)

**ArXiv ID**: [2604.23586](https://arxiv.org/abs/2604.23586)
...
**Published**: 2026-04-26 | **Submitted**: 2026-05-04 by Hongzhan Lin

**Upvotes**: 0

**Links**: [Project Page](https://talker-t2av.github.io)
