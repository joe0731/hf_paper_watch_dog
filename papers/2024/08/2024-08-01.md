...
> source: [Hugging Face Daily Papers](https://huggingface.co/papers/date/2024-08-01)

Total papers: 13

---

## 1. [The Llama 3 Herd of Models](https://huggingface.co/papers/2407.21783)
...
**Published**: 2024-07-31 | **Submitted**: 2024-08-01 by AK
...
## 2. [Tora: Trajectory-oriented Diffusion Transformer for Video Generation](https://huggingface.co/papers/2407.21705)

**ArXiv ID**: [2407.21705](https://arxiv.org/abs/2407.21705)
...
**Links**: [GitHub](https://github.com/alibaba/Tora) | [Project Page](https://ali-videoai.github.io/tora_video/)
...
## 3. [MoMa: Efficient Early-Fusion Pre-training with Mixture of Modality-Aware
  Experts](https://huggingface.co/papers/2407.21770)

**ArXiv ID**: [2407.21770](https://arxiv.org/abs/2407.21770)
...
**Published**: 2024-07-31 | **Submitted**: 2024-08-01 by Victoria Lin
...
## 4. [Towards Achieving Human Parity on End-to-end Simultaneous Speech
  Translation via LLM Agent](https://huggingface.co/papers/2407.21646)

**ArXiv ID**: [2407.21646](https://arxiv.org/abs/2407.21646)

**Authors**: Shanbo Cheng, Zhichao Huang, Tom Ko, Hang Li, Ningxin Peng, Lu Xu, Qini Zhang

**Published**: 2024-07-31 | **Submitted**: 2024-08-01 by xuuuluuu

**Upvotes**: 18

**Links**: [GitHub](https://github.com/byteresearchcla/realsi)
...
## 5. [ShieldGemma: Generative AI Content Moderation Based on Gemma](https://huggingface.co/papers/2407.21772)

**ArXiv ID**: [2407.21772](https://arxiv.org/abs/2407.21772)
...
## 6. [Data Contamination Report from the 2024 CONDA Shared Task](https://huggingface.co/papers/2407.21530)

**ArXiv ID**: [2407.21530](https://arxiv.org/abs/2407.21530)
...
**Published**: 2024-07-31 | **Submitted**: 2024-08-01 by Run-Ze Fan
...
## 7. [Open-Vocabulary Audio-Visual Semantic Segmentation](https://huggingface.co/papers/2407.21721)

**ArXiv ID**: [2407.21721](https://arxiv.org/abs/2407.21721)

**Authors**: Liao Qu, Dantong Niu, Yanyu Qi, Wenzhen Yue, Ji Shi, Bowei Xing, Xianghua Ying

**Published**: 2024-07-31 | **Submitted**: 2024-08-01 by Liao Qu

**Upvotes**: 9

**Links**: [GitHub](https://github.com/ruohaoguo/ovavss)
...
## 8. [Berkeley Humanoid: A Research Platform for Learning-based Control](https://huggingface.co/papers/2407.21781)

**ArXiv ID**: [2407.21781](https://arxiv.org/abs/2407.21781)

**Authors**: Qiayuan Liao, Bike Zhang, Xiaoyu Huang, Zhongyu Li, Koushil Sreenath
...
## 9. [Expressive Whole-Body 3D Gaussian Avatar](https://huggingface.co/papers/2407.21686)

**ArXiv ID**: [2407.21686](https://arxiv.org/abs/2407.21686)
...
**Links**: [GitHub](https://github.com/mks0601/ExAvatar_RELEASE)
...
## 10. [TAROT: Task-Oriented Authorship Obfuscation Using Policy Optimization
  Methods](https://huggingface.co/papers/2407.21630)

**ArXiv ID**: [2407.21630](https://arxiv.org/abs/2407.21630)

**Authors**: Gabriel Loiseau, Damien Sileo, Damien Riquet, Maxime Meyer, Marc Tommasi

**Published**: 2024-07-31 | **Submitted**: 2024-08-01 by Damien Sileo

**Upvotes**: 8

**Links**: [GitHub](https://github.com/hornetsecurity/tarot)
...
## 11. [Improving 2D Feature Representations by 3D-Aware Fine-Tuning](https://huggingface.co/papers/2407.20229)

**ArXiv ID**: [2407.20229](https://arxiv.org/abs/2407.20229)

**Authors**: Yuanwen Yue, Anurag Das, Francis Engelmann, Siyu Tang, Jan Eric Lenssen

**Published**: 2024-07-29 | **Submitted**: 2024-08-01 by Yuanwen Yue

**Upvotes**: 7

**Links**: [GitHub](https://github.com/ywyue/FiT3D) | [Project Page](https://ywyue.github.io/FiT3D/)
...
## 12. [Fine-gained Zero-shot Video Sampling](https://huggingface.co/papers/2407.21475)

**ArXiv ID**: [2407.21475](https://arxiv.org/abs/2407.21475)
...
## 13. [NeRF-MAE: Masked AutoEncoders for Self-Supervised 3D Representation
  Learning for Neural Radiance Fields](https://huggingface.co/papers/2404.01300)

**ArXiv ID**: [2404.01300](https://arxiv.org/abs/2404.01300)

**Authors**: Muhammad Zubair Irshad, Sergey Zakharov, Vitor Guizilini, Adrien Gaidon, Zsolt Kira, Rares Ambrus

**Published**: 2024-04-01 | **Submitted**: 2024-08-01 by AK

**Upvotes**: 4

**Links**: [GitHub](https://github.com/zubair-irshad/NeRF-MAE)
