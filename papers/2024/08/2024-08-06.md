...
> source: [Hugging Face Daily Papers](https://huggingface.co/papers/date/2024-08-06)

Total papers: 14

---

## 1. [MiniCPM-V: A GPT-4V Level MLLM on Your Phone](https://huggingface.co/papers/2408.01800)

**ArXiv ID**: [2408.01800](https://arxiv.org/abs/2408.01800)
...
**Published**: 2024-08-03 | **Submitted**: 2024-08-06 by AK
...
## 2. [Language Model Can Listen While Speaking](https://huggingface.co/papers/2408.02622)

**ArXiv ID**: [2408.02622](https://arxiv.org/abs/2408.02622)

**Authors**: Ziyang Ma, Yakun Song, Chenpeng Du, Jian Cong, Zhuo Chen, Yuping Wang, Yuxuan Wang, Xie Chen

**Published**: 2024-08-05 | **Submitted**: 2024-08-06 by AK
...
## 3. [RAG Foundry: A Framework for Enhancing LLMs for Retrieval Augmented
  Generation](https://huggingface.co/papers/2408.02545)

**ArXiv ID**: [2408.02545](https://arxiv.org/abs/2408.02545)

**Authors**: Daniel Fleischer, Moshe Berchansky, Moshe Wasserblat, Peter Izsak

**Published**: 2024-08-05 | **Submitted**: 2024-08-06 by Daniel van Strien

**Upvotes**: 40

**Links**: [GitHub](https://github.com/intellabs/ragfoundry)
...
## 4. [Lumina-mGPT: Illuminate Flexible Photorealistic Text-to-Image Generation
  with Multimodal Generative Pretraining](https://huggingface.co/papers/2408.02657)

**ArXiv ID**: [2408.02657](https://arxiv.org/abs/2408.02657)
...
**Links**: [GitHub](https://github.com/alpha-vllm/lumina-mgpt)
...
## 5. [MeshAnything V2: Artist-Created Mesh Generation With Adjacent Mesh
  Tokenization](https://huggingface.co/papers/2408.02555)

**ArXiv ID**: [2408.02555](https://arxiv.org/abs/2408.02555)

**Authors**: Yiwen Chen, Yikai Wang, Yihao Luo, Zhengyi Wang, Zilong Chen, Jun Zhu, Chi Zhang, Guosheng Lin

**Published**: 2024-08-05 | **Submitted**: 2024-08-06 by Chen Yiwen

**Upvotes**: 31

**Links**: [GitHub](https://github.com/buaacyw/meshanythingv2)
...
## 6. [Self-Taught Evaluators](https://huggingface.co/papers/2408.02666)

**ArXiv ID**: [2408.02666](https://arxiv.org/abs/2408.02666)
...
## 7. [Unleashing the Power of Data Tsunami: A Comprehensive Survey on Data
  Assessment and Selection for Instruction Tuning of Language Models](https://huggingface.co/papers/2408.02085)

**ArXiv ID**: [2408.02085](https://arxiv.org/abs/2408.02085)

**Authors**: Yulei Qin, Yuncheng Yang, Pengcheng Guo, Gang Li, Hang Shao, Yuchen Shi, Zihan Xu, Yun Gu, Ke Li, Xing Sun

**Published**: 2024-08-04 | **Submitted**: 2024-08-06 by Yulei Qin

**Upvotes**: 19

**Links**: [GitHub](https://github.com/yuleiqin/fantastic-data-engineering)
...
## 8. [VidGen-1M: A Large-Scale Dataset for Text-to-video Generation](https://huggingface.co/papers/2408.02629)

**ArXiv ID**: [2408.02629](https://arxiv.org/abs/2408.02629)
...
## 9. [BioMamba: A Pre-trained Biomedical Language Representation Model
  Leveraging Mamba](https://huggingface.co/papers/2408.02600)

**ArXiv ID**: [2408.02600](https://arxiv.org/abs/2408.02600)
...
**Links**: [GitHub](https://github.com/LeoYML/BioMamba)
...
## 10. [ProCreate, Dont Reproduce! Propulsive Energy Diffusion for Creative
  Generation](https://huggingface.co/papers/2408.02226)

**ArXiv ID**: [2408.02226](https://arxiv.org/abs/2408.02226)
...
**Links**: [GitHub](https://github.com/agentic-learning-ai-lab/procreate-diffusion-public)
...
## 11. [GPUDrive: Data-driven, multi-agent driving simulation at 1 million FPS](https://huggingface.co/papers/2408.01584)

**ArXiv ID**: [2408.01584](https://arxiv.org/abs/2408.01584)

**Authors**: Saman Kazemkhani, Aarav Pandya, Daphne Cornelisse, Brennan Shacklett, Eugene Vinitsky

**Published**: 2024-08-02 | **Submitted**: 2024-08-06 by AK

**Upvotes**: 10

**Links**: [GitHub](https://github.com/emerge-lab/gpudrive)
...
## 12. [ExoViP: Step-by-step Verification and Exploration with Exoskeleton
  Modules for Compositional Visual Reasoning](https://huggingface.co/papers/2408.02210)

**ArXiv ID**: [2408.02210](https://arxiv.org/abs/2408.02210)

**Authors**: Yuxuan Wang, Alan Yuille, Zhuowan Li, Zilong Zheng

**Published**: 2024-08-05 | **Submitted**: 2024-08-06 by Zilong Zheng
...
## 13. [The Impact of Hyperparameters on Large Language Model Inference
  Performance: An Evaluation of vLLM and HuggingFace Pipelines](https://huggingface.co/papers/2408.01050)

**ArXiv ID**: [2408.01050](https://arxiv.org/abs/2408.01050)

**Authors**: Matias Martinez

**Published**: 2024-08-02 | **Submitted**: 2024-08-06 by Matias Martinez
...
## 14. [Operationalizing Contextual Integrity in Privacy-Conscious Assistants](https://huggingface.co/papers/2408.02373)

**ArXiv ID**: [2408.02373](https://arxiv.org/abs/2408.02373)
...
**Published**: 2024-08-05 | **Submitted**: 2024-08-06 by i
