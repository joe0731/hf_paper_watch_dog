...
> source: [Hugging Face Daily Papers](https://huggingface.co/papers/date/2024-08-02)

Total papers: 17

---

## 1. [SAM 2: Segment Anything in Images and Videos](https://huggingface.co/papers/2408.00714)

**ArXiv ID**: [2408.00714](https://arxiv.org/abs/2408.00714)
...
**Published**: 2024-08-01 | **Submitted**: 2024-08-02 by AK
...
## 2. [Gemma 2: Improving Open Language Models at a Practical Size](https://huggingface.co/papers/2408.00118)

**ArXiv ID**: [2408.00118](https://arxiv.org/abs/2408.00118)
...
**Published**: 2024-07-31 | **Submitted**: 2024-08-02 by Omar Sanseviero
...
## 3. [SF3D: Stable Fast 3D Mesh Reconstruction with UV-unwrapping and
  Illumination Disentanglement](https://huggingface.co/papers/2408.00653)

**ArXiv ID**: [2408.00653](https://arxiv.org/abs/2408.00653)
...
## 4. [Improving Text Embeddings for Smaller Language Models Using Contrastive
  Fine-tuning](https://huggingface.co/papers/2408.00690)

**ArXiv ID**: [2408.00690](https://arxiv.org/abs/2408.00690)
...
**Links**: [GitHub](https://github.com/trapoom555/language-model-sts-cft)
...
## 5. [OmniParser for Pure Vision Based GUI Agent](https://huggingface.co/papers/2408.00203)

**ArXiv ID**: [2408.00203](https://arxiv.org/abs/2408.00203)
...
**Links**: [GitHub](https://github.com/microsoft/omniparser)
...
## 6. [Coarse Correspondence Elicit 3D Spacetime Understanding in Multimodal
  Language Model](https://huggingface.co/papers/2408.00754)

**ArXiv ID**: [2408.00754](https://arxiv.org/abs/2408.00754)
...
## 7. [Finch: Prompt-guided Key-Value Cache Compression](https://huggingface.co/papers/2408.00167)

**ArXiv ID**: [2408.00167](https://arxiv.org/abs/2408.00167)

**Organization**: SAP

**Authors**: Giulio Corallo, Paolo Papotti

**Published**: 2024-07-31 | **Submitted**: 2024-08-02 by Giulio Corallo
...
## 8. [TurboEdit: Text-Based Image Editing Using Few-Step Diffusion Models](https://huggingface.co/papers/2408.00735)

**ArXiv ID**: [2408.00735](https://arxiv.org/abs/2408.00735)
...
**Links**: [GitHub](https://github.com/GiilDe/turbo-edit)
...
## 9. [MM-Vet v2: A Challenging Benchmark to Evaluate Large Multimodal Models
  for Integrated Capabilities](https://huggingface.co/papers/2408.00765)

**ArXiv ID**: [2408.00765](https://arxiv.org/abs/2408.00765)
...
**Published**: 2024-08-01 | **Submitted**: 2024-08-02 by Weihao Yu
...
## 10. [Reenact Anything: Semantic Video Motion Transfer Using Motion-Textual
  Inversion](https://huggingface.co/papers/2408.00458)

**ArXiv ID**: [2408.00458](https://arxiv.org/abs/2408.00458)

**Authors**: Manuel Kansy, Jacek Naruniec, Christopher Schroers, Markus Gross, Romann M. Weber

**Published**: 2024-08-01 | **Submitted**: 2024-08-02 by Manuel Kansy
...
## 11. [Tails Tell Tales: Chapter-Wide Manga Transcriptions with Character Names](https://huggingface.co/papers/2408.00298)

**ArXiv ID**: [2408.00298](https://arxiv.org/abs/2408.00298)
...
**Links**: [GitHub](https://github.com/ragavsachdeva/magi)
...
## 12. [UniTalker: Scaling up Audio-Driven 3D Facial Animation through A Unified
  Model](https://huggingface.co/papers/2408.00762)

**ArXiv ID**: [2408.00762](https://arxiv.org/abs/2408.00762)
...
**Links**: [GitHub](https://github.com/x-niper/unitalker)
...
## 13. [Smoothed Energy Guidance: Guiding Diffusion Models with Reduced Energy
  Curvature of Attention](https://huggingface.co/papers/2408.00760)

**ArXiv ID**: [2408.00760](https://arxiv.org/abs/2408.00760)

**Authors**: Susung Hong

**Published**: 2024-08-01 | **Submitted**: 2024-08-02 by Susung Hong

**Upvotes**: 7

**Links**: [GitHub](https://github.com/susunghong/seg-sdxl)
...
## 14. [Enhancing Semantic Similarity Understanding in Arabic NLP with Nested
  Embedding Learning](https://huggingface.co/papers/2407.21139)

**ArXiv ID**: [2407.21139](https://arxiv.org/abs/2407.21139)

**Authors**: Omer Nacar, Anis Koubaa

**Published**: 2024-07-30 | **Submitted**: 2024-08-02 by Omartificial Intelligence Space
...
## 15. [Non Verbis, Sed Rebus: Large Language Models are Weak Solvers of Italian
  Rebuses](https://huggingface.co/papers/2408.00584)

**ArXiv ID**: [2408.00584](https://arxiv.org/abs/2408.00584)

**Authors**: Gabriele Sarti, Tommaso Caselli, Malvina Nissim, Arianna Bisazza

**Published**: 2024-08-01 | **Submitted**: 2024-08-02 by Gabriele Sarti

**Upvotes**: 6

**Links**: [GitHub](https://github.com/gsarti/verbalized-rebus) | [Project Page](https://gsarti.com/publication/verbalized-rebus/)
...
## 16. [Generalized Out-of-Distribution Detection and Beyond in Vision Language
  Model Era: A Survey](https://huggingface.co/papers/2407.21794)

**ArXiv ID**: [2407.21794](https://arxiv.org/abs/2407.21794)
...
**Published**: 2024-07-31 | **Submitted**: 2024-08-02 by Atsuyuki Miyai

**Upvotes**: 6

**Links**: [GitHub](https://github.com/AtsuMiyai/Awesome-OOD-VLM)
...
## 17. [Sentence-wise Speech Summarization: Task, Datasets, and End-to-End
  Modeling with LM Knowledge Distillation](https://huggingface.co/papers/2408.00205)

**ArXiv ID**: [2408.00205](https://arxiv.org/abs/2408.00205)
