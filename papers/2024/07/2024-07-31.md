...
> source: [Hugging Face Daily Papers](https://huggingface.co/papers/date/2024-07-31)

Total papers: 10

---

## 1. [Meltemi: The first open Large Language Model for Greek](https://huggingface.co/papers/2407.20743)

**ArXiv ID**: [2407.20743](https://arxiv.org/abs/2407.20743)
...
**Published**: 2024-07-30 | **Submitted**: 2024-07-31 by JB D.
...
## 2. [ThinK: Thinner Key Cache by Query-Driven Pruning](https://huggingface.co/papers/2407.21018)

**ArXiv ID**: [2407.21018](https://arxiv.org/abs/2407.21018)

**Authors**: Yuhui Xu, Zhanming Jie, Hanze Dong, Lei Wang, Xudong Lu, Aojun Zhou, Amrita Saha, Caiming Xiong, Doyen Sahoo

**Published**: 2024-07-30 | **Submitted**: 2024-07-31 by AJ.Zhou

**Upvotes**: 32

**Links**: [GitHub](https://github.com/SalesforceAIResearch/ThinK)
...
## 3. [A Large Encoder-Decoder Family of Foundation Models For Chemical
  Language](https://huggingface.co/papers/2407.20267)

**ArXiv ID**: [2407.20267](https://arxiv.org/abs/2407.20267)

**Authors**: Eduardo Soares, Victor Shirasuna, Emilio Vital Brazil, Renato Cerqueira, Dmitry Zubarev, Kristin Schmidt

**Published**: 2024-07-24 | **Submitted**: 2024-07-31 by Eduardo Soares

**Upvotes**: 32

**Links**: [GitHub](https://github.com/IBM/materials) | [Project Page](https://github.com/IBM/materials)
...
## 4. [Adapting Safe-for-Work Classifier for Malaysian Language Text: Enhancing
  Alignment in LLM-Ops Framework](https://huggingface.co/papers/2407.20729)

**ArXiv ID**: [2407.20729](https://arxiv.org/abs/2407.20729)
...
## 5. [Matting by Generation](https://huggingface.co/papers/2407.21017)

**ArXiv ID**: [2407.21017](https://arxiv.org/abs/2407.21017)

**Authors**: Zhixiang Wang, Baiang Li, Jian Wang, Yu-Lun Liu, Jinwei Gu, Yung-Yu Chuang, Shin'ichi Satoh

**Published**: 2024-07-30 | **Submitted**: 2024-07-31 by AK
...
## 6. [Diffusion Augmented Agents: A Framework for Efficient Exploration and
  Transfer Learning](https://huggingface.co/papers/2407.20798)

**ArXiv ID**: [2407.20798](https://arxiv.org/abs/2407.20798)
...
**Links**: [GitHub](https://github.com/kylestach/lifelong-nav-rl)
...
## 7. [Knesset-DictaBERT: A Hebrew Language Model for Parliamentary Proceedings](https://huggingface.co/papers/2407.20581)

**ArXiv ID**: [2407.20581](https://arxiv.org/abs/2407.20581)
...
## 8. [Futga: Towards Fine-grained Music Understanding through
  Temporally-enhanced Generative Augmentation](https://huggingface.co/papers/2407.20445)

**ArXiv ID**: [2407.20445](https://arxiv.org/abs/2407.20445)

**Authors**: Junda Wu, Zachary Novack, Amit Namburi, Jiaheng Dai, Hao-Wen Dong, Zhouhang Xie, Carol Chen, Julian McAuley

**Published**: 2024-07-29 | **Submitted**: 2024-07-31 by AK
...
## 9. [JaColBERTv2.5: Optimising Multi-Vector Retrievers to Create
  State-of-the-Art Japanese Retrievers with Constrained Resources](https://huggingface.co/papers/2407.20750)

**ArXiv ID**: [2407.20750](https://arxiv.org/abs/2407.20750)
...
## 10. [Harvesting Textual and Structured Data from the HAL Publication
  Repository](https://huggingface.co/papers/2407.20595)

**ArXiv ID**: [2407.20595](https://arxiv.org/abs/2407.20595)
...
**Links**: [GitHub](https://github.com/Madjakul/HALvesting)
