...
> source: [Hugging Face Daily Papers](https://huggingface.co/papers/date/2024-07-19)

Total papers: 15

---

## 1. [Scaling Laws with Vocabulary: Larger Models Deserve Larger Vocabularies](https://huggingface.co/papers/2407.13623)

**ArXiv ID**: [2407.13623](https://arxiv.org/abs/2407.13623)

**Authors**: Chaofan Tao, Qian Liu, Longxu Dou, Niklas Muennighoff, Zhongwei Wan, Ping Luo, Min Lin, Ngai Wong

**Published**: 2024-07-18 | **Submitted**: 2024-07-19 by Qian Liu

**Upvotes**: 56

**Links**: [GitHub](https://github.com/sail-sg/scaling-with-vocab)
...
## 2. [Scaling Retrieval-Based Language Models with a Trillion-Token Datastore](https://huggingface.co/papers/2407.12854)

**ArXiv ID**: [2407.12854](https://arxiv.org/abs/2407.12854)

**Authors**: Rulin Shao, Jacqueline He, Akari Asai, Weijia Shi, Tim Dettmers, Sewon Min, Luke Zettlemoyer, Pang Wei Koh

**Published**: 2024-07-09 | **Submitted**: 2024-07-19 by AK

**Upvotes**: 31

**Links**: [GitHub](https://github.com/rulinshao/retrieval-scaling)
...
## 3. [Scaling Granite Code Models to 128K Context](https://huggingface.co/papers/2407.13739)

**ArXiv ID**: [2407.13739](https://arxiv.org/abs/2407.13739)

**Authors**: Matt Stallone, Vaibhav Saxena, Leonid Karlinsky, Bridget McGinn, Tim Bula, Mayank Mishra, Adriana Meza Soria, Gaoyuan Zhang, Aditya Prasad, Yikang Shen, Saptha Surendran, Shanmukha Guttula, Hima Patel, Parameswaran Selvam, Xuan-Hong Dang, Yan Koyfman, Atin Sood, Rogerio Feris, Nirmit Desai, David D. Cox, Ruchir Puri, Rameswar Panda

**Published**: 2024-07-18 | **Submitted**: 2024-07-19 by JB D.
...
## 4. [Shape of Motion: 4D Reconstruction from a Single Video](https://huggingface.co/papers/2407.13764)

**ArXiv ID**: [2407.13764](https://arxiv.org/abs/2407.13764)

**Authors**: Qianqian Wang, Vickie Ye, Hang Gao, Jake Austin, Zhengqi Li, Angjoo Kanazawa

**Published**: 2024-07-18 | **Submitted**: 2024-07-19 by AK

**Upvotes**: 20

**Links**: [GitHub](https://github.com/vye16/shape-of-motion) | [Project Page](https://shape-of-motion.github.io/)
...
## 5. [Streetscapes: Large-scale Consistent Street View Generation Using
  Autoregressive Video Diffusion](https://huggingface.co/papers/2407.13759)

**ArXiv ID**: [2407.13759](https://arxiv.org/abs/2407.13759)
...
## 6. [Understanding Reference Policies in Direct Preference Optimization](https://huggingface.co/papers/2407.13709)

**ArXiv ID**: [2407.13709](https://arxiv.org/abs/2407.13709)
...
## 7. [Benchmarking Trustworthiness of Multimodal Large Language Models: A
  Comprehensive Study](https://huggingface.co/papers/2406.07057)

**ArXiv ID**: [2406.07057](https://arxiv.org/abs/2406.07057)
...
**Published**: 2024-06-11 | **Submitted**: 2024-07-19 by AK
...
## 8. [BRIGHT: A Realistic and Challenging Benchmark for Reasoning-Intensive
  Retrieval](https://huggingface.co/papers/2407.12883)

**ArXiv ID**: [2407.12883](https://arxiv.org/abs/2407.12883)
...
**Published**: 2024-07-16 | **Submitted**: 2024-07-19 by Hongjin SU
...
## 9. [CodeV: Empowering LLMs for Verilog Generation through Multi-Level
  Summarization](https://huggingface.co/papers/2407.10424)

**ArXiv ID**: [2407.10424](https://arxiv.org/abs/2407.10424)
...
**Published**: 2024-07-15 | **Submitted**: 2024-07-19 by zhaoyang
...
## 10. [CLAY: A Controllable Large-scale Generative Model for Creating
  High-quality 3D Assets](https://huggingface.co/papers/2406.13897)

**ArXiv ID**: [2406.13897](https://arxiv.org/abs/2406.13897)

**Authors**: Longwen Zhang, Ziyu Wang, Qixuan Zhang, Qiwei Qiu, Anqi Pang, Haoran Jiang, Wei Yang, Lan Xu, Jingyi Yu

**Published**: 2024-05-30 | **Submitted**: 2024-07-19 by AK
...
## 11. [Attention Overflow: Language Model Input Blur during Long-Context
  Missing Items Recommendation](https://huggingface.co/papers/2407.13481)

**ArXiv ID**: [2407.13481](https://arxiv.org/abs/2407.13481)

**Authors**: Damien Sileo

**Published**: 2024-07-18 | **Submitted**: 2024-07-19 by Damien Sileo
...
## 12. [Retrieval-Enhanced Machine Learning: Synthesis and Opportunities](https://huggingface.co/papers/2407.12982)

**ArXiv ID**: [2407.12982](https://arxiv.org/abs/2407.12982)

**Authors**: To Eun Kim, Alireza Salemi, Andrew Drozdov, Fernando Diaz, Hamed Zamani

**Published**: 2024-07-17 | **Submitted**: 2024-07-19 by Andrew Drozdov
...
## 13. [Benchmark Agreement Testing Done Right: A Guide for LLM Benchmark
  Evaluation](https://huggingface.co/papers/2407.13696)

**ArXiv ID**: [2407.13696](https://arxiv.org/abs/2407.13696)
...
**Links**: [GitHub](https://github.com/ibm/benchbench)
...
## 14. [A Comparative Study on Automatic Coding of Medical Letters with
  Explainability](https://huggingface.co/papers/2407.13638)

**ArXiv ID**: [2407.13638](https://arxiv.org/abs/2407.13638)
...
**Links**: [GitHub](https://github.com/Glenj01/Medical-Coding)
...
## 15. [PM-LLM-Benchmark: Evaluating Large Language Models on Process Mining
  Tasks](https://huggingface.co/papers/2407.13244)

**ArXiv ID**: [2407.13244](https://arxiv.org/abs/2407.13244)
...
**Links**: [GitHub](https://github.com/fit-alessandro-berti/pm-llm-benchmark)
