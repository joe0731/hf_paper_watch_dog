...
> source: [Hugging Face Daily Papers](https://huggingface.co/papers/date/2024-07-30)

Total papers: 21

---

## 1. [SaulLM-54B & SaulLM-141B: Scaling Up Domain Adaptation for the Legal
  Domain](https://huggingface.co/papers/2407.19584)

**ArXiv ID**: [2407.19584](https://arxiv.org/abs/2407.19584)
...
**Published**: 2024-07-28 | **Submitted**: 2024-07-30 by Colombo
...
## 2. [Integrating Large Language Models into a Tri-Modal Architecture for
  Automated Depression Classification](https://huggingface.co/papers/2407.19340)

**ArXiv ID**: [2407.19340](https://arxiv.org/abs/2407.19340)

**Authors**: 

**Published**: 2024-07-27 | **Submitted**: 2024-07-30 by Santosh Patapati
...
## 3. [SeaLLMs 3: Open Foundation and Chat Multilingual Large Language Models
  for Southeast Asian Languages](https://huggingface.co/papers/2407.19672)

**ArXiv ID**: [2407.19672](https://arxiv.org/abs/2407.19672)
...
**Published**: 2024-07-29 | **Submitted**: 2024-07-30 by JB D.
...
## 4. [FreeLong: Training-Free Long Video Generation with SpectralBlend
  Temporal Attention](https://huggingface.co/papers/2407.19918)

**ArXiv ID**: [2407.19918](https://arxiv.org/abs/2407.19918)

**Authors**: Yu Lu, Yuanzhi Liang, Linchao Zhu, Yi Yang

**Published**: 2024-07-29 | **Submitted**: 2024-07-30 by AK
...
## 5. [Theia: Distilling Diverse Vision Foundation Models for Robot Learning](https://huggingface.co/papers/2407.20179)

**ArXiv ID**: [2407.20179](https://arxiv.org/abs/2407.20179)
...
**Published**: 2024-07-29 | **Submitted**: 2024-07-30 by Jinghuan Shang

**Upvotes**: 47

**Links**: [GitHub](https://github.com/bdaiinstitute/theia)
...
## 6. [MindSearch: Mimicking Human Minds Elicits Deep AI Searcher](https://huggingface.co/papers/2407.20183)

**ArXiv ID**: [2407.20183](https://arxiv.org/abs/2407.20183)
...
**Links**: [GitHub](https://github.com/InternLM/MindSearch)
...
## 7. [MMAU: A Holistic Benchmark of Agent Capabilities Across Diverse Domains](https://huggingface.co/papers/2407.18961)

**ArXiv ID**: [2407.18961](https://arxiv.org/abs/2407.18961)
...
**Published**: 2024-07-18 | **Submitted**: 2024-07-30 by AK
...
## 8. [Mixture of Nested Experts: Adaptive Processing of Visual Tokens](https://huggingface.co/papers/2407.19985)

**ArXiv ID**: [2407.19985](https://arxiv.org/abs/2407.19985)
...
**Links**: [GitHub](https://github.com/usryokousha/mone-pytorch)
...
## 9. [Diffusion Feedback Helps CLIP See Better](https://huggingface.co/papers/2407.20171)

**ArXiv ID**: [2407.20171](https://arxiv.org/abs/2407.20171)
...
**Links**: [GitHub](https://github.com/baaivision/diva)
...
## 10. [Self-Training with Direct Preference Optimization Improves
  Chain-of-Thought Reasoning](https://huggingface.co/papers/2407.18248)

**ArXiv ID**: [2407.18248](https://arxiv.org/abs/2407.18248)

**Authors**: Tianduo Wang, Shichen Li, Wei Lu

**Published**: 2024-07-25 | **Submitted**: 2024-07-30 by Tianduo Wang

**Upvotes**: 33

**Links**: [GitHub](https://github.com/tianduowang/dpo-st)
...
## 11. [Cycle3D: High-quality and Consistent Image-to-3D Generation via
  Generation-Reconstruction Cycle](https://huggingface.co/papers/2407.19548)

**ArXiv ID**: [2407.19548](https://arxiv.org/abs/2407.19548)

**Authors**: Zhenyu Tang, Xinhua Cheng, Wangbo Yu, Chaoran Feng, Yatian Pang, Bin Lin, Li Yuan

**Published**: 2024-07-28 | **Submitted**: 2024-07-30 by AK
...
## 12. [Visual Riddles: a Commonsense and World Knowledge Challenge for Large
  Vision and Language Models](https://huggingface.co/papers/2407.19474)

**ArXiv ID**: [2407.19474](https://arxiv.org/abs/2407.19474)
...
## 13. [3D Question Answering for City Scene Understanding](https://huggingface.co/papers/2407.17398)

**ArXiv ID**: [2407.17398](https://arxiv.org/abs/2407.17398)

**Authors**: Penglei Sun, Yaoxian Song, Xiang Liu, Xiaofei Yang, Qiang Wang, Tiefeng Li, Yang Yang, Xiaowen Chu

**Published**: 2024-07-24 | **Submitted**: 2024-07-30 by Xiang Liu
...
## 14. [ATHAR: A High-Quality and Diverse Dataset for Classical Arabic to
  English Translation](https://huggingface.co/papers/2407.19835)

**ArXiv ID**: [2407.19835](https://arxiv.org/abs/2407.19835)
...
## 15. [Meta-Rewarding Language Models: Self-Improving Alignment with
  LLM-as-a-Meta-Judge](https://huggingface.co/papers/2407.19594)

**ArXiv ID**: [2407.19594](https://arxiv.org/abs/2407.19594)

**Authors**: Tianhao Wu, Weizhe Yuan, Olga Golovneva, Jing Xu, Yuandong Tian, Jiantao Jiao, Jason Weston, Sainbayar Sukhbaatar

**Published**: 2024-07-28 | **Submitted**: 2024-07-30 by Sainbayar Sukhbaatar
...
## 16. [ImagiNet: A Multi-Content Dataset for Generalizable Synthetic Image
  Detection via Contrastive Learning](https://huggingface.co/papers/2407.20020)

**ArXiv ID**: [2407.20020](https://arxiv.org/abs/2407.20020)

**Authors**: Delyan Boychev, Radostin Cholakov

**Published**: 2024-07-29 | **Submitted**: 2024-07-30 by Radostin Cholakov

**Upvotes**: 20

**Links**: [GitHub](https://github.com/delyan-boychev/imaginet)
...
## 17. [Sentiment Analysis of Lithuanian Online Reviews Using Large Language
  Models](https://huggingface.co/papers/2407.19914)

**ArXiv ID**: [2407.19914](https://arxiv.org/abs/2407.19914)
...
## 18. [Bridging the Gap: Studio-like Avatar Creation from a Monocular Phone
  Capture](https://huggingface.co/papers/2407.19593)

**ArXiv ID**: [2407.19593](https://arxiv.org/abs/2407.19593)
...
## 19. [WalkTheDog: Cross-Morphology Motion Alignment via Phase Manifolds](https://huggingface.co/papers/2407.18946)

**ArXiv ID**: [2407.18946](https://arxiv.org/abs/2407.18946)

**Authors**: Peizhuo Li, Sebastian Starke, Yuting Ye, Olga Sorkine-Hornung

**Published**: 2024-07-11 | **Submitted**: 2024-07-30 by AK

**Upvotes**: 12

**Links**: [GitHub](https://github.com/PeizhuoLi/walk-the-dog)
...
## 20. [VolDoGer: LLM-assisted Datasets for Domain Generalization in
  Vision-Language Tasks](https://huggingface.co/papers/2407.19795)

**ArXiv ID**: [2407.19795](https://arxiv.org/abs/2407.19795)

**Authors**: Juhwan Choi, Junehyoung Kwon, JungMin Yun, Seunguk Yu, YoungBin Kim

**Published**: 2024-07-29 | **Submitted**: 2024-07-30 by Juhwan Choi
...
## 21. [TAPTRv2: Attention-based Position Update Improves Tracking Any Point](https://huggingface.co/papers/2407.16291)

**ArXiv ID**: [2407.16291](https://arxiv.org/abs/2407.16291)

**Authors**: Hongyang Li, Hao Zhang, Shilong Liu, Zhaoyang Zeng, Feng Li, Tianhe Ren, Bohan Li, Lei Zhang

**Published**: 2024-07-23 | **Submitted**: 2024-07-30 by HYeung Lee
